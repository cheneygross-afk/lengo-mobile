...
// The hidden Japanese track's second grammar module: A2, building directly
// on ja-a1.ts's 8 lessons (greetings, X は Y です, pronouns/demonstratives/
// question words, core particles は/が/を/に/で/と, numbers/counters,
// ます-form verbs, い/な adjectives, time/days/daily routine). Kept in its
// own file for the same reason as ja-a1.ts -- a clean, removable unit
// reusing the shared Lesson/Exercise/LessonSection shape (see the "JA-A2"
// branch on Lesson["level"] in ./types.ts). No "translate" exercises here
// either, for the same reason as ja-alphabets.ts and ja-a1.ts.
export const JA_A2_LESSONS: Lesson[] = [
{
  "slug": "te-form-formation-requests",
  "level": "JA-A2",
  "number": 1,
  "title": "The Te-Form: Requests and Sequences",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "ちょっと待ってください。", "en": "chotto matte kudasai. -- Please wait a moment." },
        { "es": "顔を洗って、着替えます。", "en": "kao o aratte, kigaemasu. -- I wash my face and get dressed." }
      ],
      "checkpoint": [
        {
    ...
    },
    {
      ...
      "examples": [
        { "es": "飲む → 飲んで", "en": "nomu → nonde -- to drink → (drinking, and...)" },
        { "es": "待つ → 待って", "en": "matsu → matte -- to wait → (waiting, and...)" },
        { "es": "行く → 行って", "en": "iku → itte -- to go → (going, and...) [irregular]" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "食べる → 食べて", "en": "taberu → tabete -- to eat → (eating, and...)" },
        { "es": "する → して", "en": "suru → shite -- to do → (doing, and...)" },
        { "es": "来る → 来て", "en": "kuru → kite -- to come → (coming, and...)" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
    ...
    },
    {
      ...
      "examples": [
        { "es": "ここに名前を書いてください。", "en": "koko ni namae o kaite kudasai. -- Please write your name here." },
        { "es": "窓を開けてください。", "en": "mado o akete kudasai. -- Please open the window." },
        { "es": "少し待ってください。", "en": "sukoshi matte kudasai. -- Please wait a little." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
    ...
    },
    {
      ...
      "examples": [
        { "es": "朝起きて、コーヒーを飲みます。", "en": "asa okite, koohii o nomimasu. -- I wake up in the morning and drink coffee." },
        { "es": "図書館へ行って、本を読みます。", "en": "toshokan e itte, hon o yomimasu. -- I go to the library and read a book." },
        { "es": "宿題をして、寝ます。", "en": "shukudai o shite, nemasu. -- I do my homework and (then) sleep." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "テレビを見て、寝ます。", "en": "terebi o mite, nemasu. -- I watch TV and go to sleep." },
        { "es": "先生の話を聞いてください。", "en": "sensei no hanashi o kiite kudasai. -- Please listen to the teacher's talk." },
        { "es": "ドアを閉めてください。", "en": "doa o shimete kudasai. -- Please close the door." }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
    ...
    },
    {
      ...
      "examples": [
        { "es": "飲んでください。", "en": "nonde kudasai. -- Please drink." },
        { "es": "早く起きて、勉強します。", "en": "hayaku okite, benkyou shimasu. -- I get up early and study." }
      ],
      "checkpoint": [
        {
          "type": "matching",
...
{
  "slug": "te-form-ongoing-permission-prohibition",
  "level": "JA-A2",
  "number": 2,
  "title": "The Te-Form, Part 2: Ongoing Actions, Permission, and Prohibition",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "今、テレビを見ています。", "en": "ima, terebi o mite imasu. -- I'm watching TV right now." },
        { "es": "写真を撮ってもいいですか。", "en": "shashin o tottemo ii desu ka. -- Is it okay if I take a photo?" },
        { "es": "ここでタバコを吸ってはいけません。", "en": "koko de tabako o suttewa ikemasen. -- You must not smoke here." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
    ...
    },
    {
      ...
      "examples": [
        { "es": "田中さんは今、電話で話しています。", "en": "Tanaka-san wa ima, denwa de hanashite imasu. -- Tanaka-san is talking on the phone right now." },
        { "es": "子供たちは公園で遊んでいます。", "en": "kodomotachi wa kouen de asonde imasu. -- The children are playing in the park." },
        { "es": "すみません、何をしていますか。－宿題をしています。", "en": "sumimasen, nani o shite imasu ka. -- shukudai o shite imasu. -- Excuse me, what are you doing? -- I'm doing homework." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "山田さんは大阪に住んでいます。", "en": "Yamada-san wa Oosaka ni sunde imasu. -- Yamada lives in Osaka." },
        { "es": "私は鈴木さんを知っています。", "en": "watashi wa Suzuki-san o shitte imasu. -- I know Suzuki." },
        { "es": "姉は結婚しています。弟は独身です。", "en": "ane wa kekkon shite imasu. otouto wa dokushin desu. -- My older sister is married. My younger brother is single." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "山田さんは大阪に住んでいます。", "right": "Yamada lives in Osaka." },
            { "left": "私は鈴木さんを知っています。", "right": "I know Suzuki." },
            { "left": "姉は結婚しています。", "right": "My older sister is married." },
            { "left": "弟は独身です。", "right": "My younger brother is single." }
          ],
    ...
    },
    {
      ...
      "examples": [
        { "es": "先生、窓を開けてもいいですか。", "en": "sensei, mado o aketemo ii desu ka. -- Teacher, may I open the window?" },
        { "es": "この電話を使ってもいいですか。", "en": "kono denwa o tsukattemo ii desu ka. -- May I use this phone?" },
        { "es": "はい、座ってもいいですよ。", "en": "hai, suwattemo ii desu yo. -- Yes, you may sit down." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "A：窓を開けてもいいですか。B：ええ、どうぞ。", "en": "A: mado o aketemo ii desu ka. B: ee, douzo. -- A: May I open the window? B: Sure, go ahead." },
        { "es": "A：ここでタバコを吸ってもいいですか。B：すみません、ここは禁煙です。", "en": "A: koko de tabako o suttemo ii desu ka. B: sumimasen, koko wa kin'en desu. -- A: May I smoke here? B: Sorry, this is a no-smoking area." },
        { "es": "いいですよ。使ってください。", "en": "ii desu yo. tsukatte kudasai. -- That's fine. Please go ahead and use it." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
    ...
    },
    {
      ...
      "examples": [
        { "es": "図書館で走ってはいけません。", "en": "toshokan de hashitte wa ikemasen. -- You must not run in the library." },
        { "es": "ここで写真を撮ってはいけません。", "en": "koko de shashin o tottewa ikemasen. -- You must not take photos here." },
        { "es": "授業中に寝てはいけません。", "en": "jugyouchuu ni netewa ikemasen. -- You must not sleep during class." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "すみません、ここに座ってもいいですか。", "en": "sumimasen, koko ni suwattemo ii desu ka. -- Excuse me, may I sit here?" },
        { "es": "ええ、どうぞ。でも、ここでタバコを吸ってはいけませんよ。", "en": "ee, douzo. demo, koko de tabako o suttewa ikemasen yo. -- Sure, go ahead. But you mustn't smoke here." },
        { "es": "分かりました。今、吸っていませんから、大丈夫です。", "en": "wakarimashita. ima, sutte imasen kara, daijoubu desu. -- Understood. I'm not smoking right now, so it's fine." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "～ています", "right": "an action in progress right now, or a stable state/result" },
            { "left": "～てもいいですか", "right": "asking for permission to do something" },
            { "left": "～てはいけません", "right": "stating that something is prohibited/forbidden" },
            { "left": "～てください", "right": "making a polite request (review from the previous lesson)" }
          ],
  ...
  "exercises": [
    ...
    },
    {
      ...
      "pairs": [
        { "left": "No smoking here", "right": "ここでタバコを吸ってはいけません。" },
        { "left": "No photography here", "right": "ここで写真を撮ってはいけません。" },
        { "left": "No parking here", "right": "ここで駐車してはいけません。" },
        { "left": "Must not run in the library", "right": "図書館で走ってはいけません。" }
      ],
...
{
  "slug": "past-tense-masu-plain",
  "level": "JA-A2",
  "number": 3,
  "title": "Past Tense: Polite and Plain",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "昨日、映画を見ました。", "en": "kinou, eiga o mimashita. -- Yesterday, I watched a movie." },
        { "es": "先週、京都に行きました。", "en": "senshuu, Kyouto ni ikimashita. -- Last week, I went to Kyoto." },
        { "es": "今朝、コーヒーを飲みました。", "en": "kesa, koohii o nomimashita. -- This morning, I drank coffee." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
        ...
        },
        {
          ...
          "options": ["先週、京都に行きます。", "先週、京都に行きました。", "先週、京都に行きませんでした。", "先週、京都は行きました。"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "昨日、勉強しませんでした。", "en": "kinou, benkyou shimasendeshita. -- I didn't study yesterday." },
        { "es": "今朝、コーヒーを飲みませんでした。", "en": "kesa, koohii o nomimasendeshita. -- I didn't drink coffee this morning." },
        { "es": "週末、友達に会いませんでした。", "en": "shuumatsu, tomodachi ni aimasendeshita. -- I didn't meet my friend over the weekend." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Arrange the words to say 'I didn't drink coffee this morning.'",
          "words": ["今朝", "コーヒー", "を", "飲みませんでした"],
        ...
        },
        {
          ...
          "options": ["見ませんでした", "見ました", "飲みませんでした", "飲みます"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "去年、学生でした。", "en": "kyonen, gakusei deshita. -- Last year, I was a student." },
        { "es": "先週末は静かでした。", "en": "senshuumatsu wa shizuka deshita. -- Last weekend was quiet." },
        { "es": "その先生は有名でした。", "en": "sono sensei wa yuumei deshita. -- That teacher was famous." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "学生です", "right": "学生でした" },
            { "left": "元気です", "right": "元気でした" },
            { "left": "静かです", "right": "静かでした" },
            { "left": "有名です", "right": "有名でした" }
          ],
        ...
        },
        {
          ...
          "options": ["I am a student.", "I was a student last year.", "I will be a student next year.", "Last year was fun."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "先週は暇じゃなかったです。", "en": "senshuu wa hima ja nakatta desu. -- Last week I wasn't free." },
        { "es": "会議は大変ではありませんでした。", "en": "kaigi wa taihen dewa arimasendeshita. -- The meeting wasn't tough." },
        { "es": "彼は先生じゃなかったです。", "en": "kare wa sensei ja nakatta desu. -- He wasn't a teacher." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
        ...
        },
        {
          ...
          "options": ["彼は先生じゃなかったです。", "彼は先生ではありませんでした。", "彼は先生でした。", "彼は先生じゃないです。"],
          "correctIndexes": [0, 1],
    ...
    },
    {
      ...
      "examples": [
        { "es": "昨日は暑かったです。", "en": "kinou wa atsukatta desu. -- Yesterday was hot." },
        { "es": "旅行は楽しかったです。", "en": "ryokou wa tanoshikatta desu. -- The trip was fun." },
        { "es": "テストは難しくなかったです。", "en": "tesuto wa muzukashikunakatta desu. -- The test wasn't difficult." },
        { "es": "映画はよかったです。", "en": "eiga wa yokatta desu. -- The movie was good." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Arrange the words to say 'The test wasn't difficult.'",
          "words": ["テスト", "は", "難しくなかった", "です"],
        ...
        },
        {
          ...
          "options": ["映画はいかったです。", "映画はよかったです。", "映画はいいでした。", "映画はいくなかったです。"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "昨日は休みだった。", "en": "kinou wa yasumi datta. -- Yesterday was a day off. (plain)" },
        { "es": "パーティーは静かじゃなかった。", "en": "paatii wa shizuka ja nakatta. -- The party wasn't quiet. (plain)" },
        { "es": "天気はよかった。", "en": "tenki wa yokatta. -- The weather was good. (plain -- い-adjectives are already plain)" }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "休みでした", "right": "休みだった" },
            { "left": "静かじゃなかったです", "right": "静かじゃなかった" },
            { "left": "よかったです", "right": "よかった" },
            { "left": "忙しかったです", "right": "忙しかった" }
          ],
        ...
        },
        {
          ...
          "options": ["昨日は休みだった。", "昨日は休みでした。", "パーティーは静かじゃなかった。", "パーティーは静かじゃなかったです。"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "週末はどうでしたか。", "en": "shuumatsu wa dou deshita ka. -- How was the weekend?" },
        { "es": "楽しかったです。友達と映画を見ました。", "en": "tanoshikatta desu. tomodachi to eiga o mimashita. -- It was fun. I watched a movie with a friend." },
        { "es": "先月は忙しかったです。今月は暇です。", "en": "sengetsu wa isogashikatta desu. kongetsu wa hima desu. -- Last month was busy. This month I'm free." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
  ...
  "exercises": [
    {
      ...
      "options": ["飲みます", "飲みました", "飲みません", "飲んでした"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["Last week was busy.", "This week is busy.", "Last week wasn't busy.", "Next week will be busy."],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["先生でした", "先生じゃなかったです", "先生ではありませんでした", "先生じゃないです"],
      "correctIndexes": [1, 2],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "食べます", "right": "食べました" },
        { "left": "元気です", "right": "元気でした" },
        { "left": "高くないです", "right": "高くなかったです" },
        { "left": "学生です", "right": "学生でした" }
      ],
    ...
    },
    {
      ...
      "options": ["休みだった。", "休みでした。", "休みますでした。", "休みじゃなかったでした。"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["大変じゃなかったです", "大変ではありませんでした", "大変くなかったです", "大変じゃない"],
      "correctIndexes": [0, 1],
    ...
    },
    {
      ...
      "options": ["週末はどうでしたか。", "週末はどうですか。", "週末はどうでした。", "週末はどうかったですか。"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "pairs": [
        { "left": "だった", "right": "でした" },
        { "left": "じゃなかった", "right": "じゃなかったです" },
        { "left": "かった", "right": "かったです" },
        { "left": "くなかった", "right": "くなかったです" }
      ],
...
{
  "slug": "potential-form-tai-form",
  "level": "JA-A2",
  "number": 4,
  "title": "The Potential Form and the たい Form",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "話せる。", "en": "hanaseru. -- (I/someone) can speak. (plain/dictionary form)" },
        { "es": "話せます。", "en": "hanasemasu. -- (I/someone) can speak. (polite)" },
        { "es": "話せません。", "en": "hanasemasen. -- (I/someone) cannot speak. (polite negative)" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "What does the potential form of a Japanese verb express?",
          "options": ["Something happened in the past", "Ability -- what someone can do", "A polite request", "That an action is happening right now"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "漢字が読めます。", "en": "kanji ga yomemasu. -- (I) can read kanji." },
        { "es": "今日は泳げません。", "en": "kyou wa oyogemasen. -- (I) can't swim today." },
        { "es": "この漢字が書けますか。", "en": "kono kanji ga kakemasu ka. -- Can (you) write this kanji?" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "野菜が食べられます。", "en": "yasai ga taberaremasu. -- (I) can eat vegetables." },
        { "es": "料理ができます。", "en": "ryouri ga dekimasu. -- (I) can cook. (lit. cooking is possible)" },
        { "es": "明日、来られますか。", "en": "ashita, koraremasu ka. -- Can (you) come tomorrow?" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "What is the correct potential form of する ('to do')?",
          "options": ["すれる", "せられる", "できる", "しられる"],
          "correctIndex": 2,
    ...
    },
    {
      ...
      "examples": [
        { "es": "日本語が話せます。", "en": "nihongo ga hanasemasu. -- I can speak Japanese." },
        { "es": "ピアノが弾けますか。", "en": "piano ga hikemasu ka. -- Can you play the piano?" },
        { "es": "すしを食べられますか。", "en": "sushi o taberaremasu ka. -- Can you eat sushi? (casual, を also heard)" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Which particle most naturally marks the object of a potential verb, like in '___ フランス語が話せます' (I can speak French)?",
          "options": ["を, always, no exceptions", "が, as the standard tendency, though を is heard casually", "は, because it always replaces を", "に, because potential verbs are stative"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "日本へ行きたいです。", "en": "nihon e ikitai desu. -- I want to go to Japan." },
        { "es": "何を食べたいですか。", "en": "nani o tabetai desu ka. -- What do you want to eat?" },
        { "es": "新しい車が買いたいです。", "en": "atarashii kuruma ga kaitai desu. -- I want to buy a new car." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "今日は勉強したくないです。", "en": "kyou wa benkyou shitakunai desu. -- (I) don't want to study today." },
        { "es": "去年、フランスへ行きたかったです。", "en": "kyonen, furansu e ikitakatta desu. -- Last year, (I) wanted to go to France." },
        { "es": "あのレストランで食べたくなかったです。", "en": "ano resutoran de tabetakunakatta desu. -- (I) didn't want to eat at that restaurant." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "水が飲みたいです。", "en": "mizu ga nomitai desu. -- I want to drink water." },
        { "es": "コーヒーが飲みたいですか。", "en": "koohii ga nomitai desu ka. -- Do you want to drink coffee?" },
        { "es": "沖縄が旅行したいです。", "en": "okinawa ga ryokou shitai desu. -- I want to travel to Okinawa." }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "Which of these sentences correctly use が with the たい form, following the standard tendency?",
          "options": ["水が飲みたいです。", "水は飲みたいです。", "すしが食べたいです。", "すしに食べたいです。"],
          "correctIndexes": [0, 2],
        ...
        },
        {
          ...
          "options": ["Plain たい works fine for anyone", "Plain たい is only for your own wants or a direct question -- a different form is needed for a third person", "You must use the potential form instead", "You must drop です to talk about someone else"],
          "correctIndex": 1,
  ...
  "exercises": [
    {
      ...
      "options": ["Drop む and add られる", "Change the final -u sound to its -e sound and add る", "Add たい to the ます-stem", "Replace the whole verb with できる"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["見られる (from 見る)", "読める (from 読む)", "できる (from する)", "食べる (unchanged, from 食べる)"],
    ...
    },
    {
      ...
      "options": ["Anyone, including strangers and third parties", "Only the speaker, or the listener when asked directly", "Only people who are not present", "Only groups of people, never one person"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["Came (past tense of 来る)", "Can come (potential form of 来る)", "Want to come", "Coming right now"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["ピアノが弾けます。", "ピアノを弾けます。(casual, less standard)", "コーヒーが飲みたいです。", "コーヒーは飲みたいです。"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "日本語が話せます。", "right": "I can speak Japanese." },
        { "left": "水が飲みたいです。", "right": "I want to drink water." },
        { "left": "漢字が書けません。", "right": "I cannot write kanji." },
        { "left": "行きたくないです。", "right": "I don't want to go." },
        { "left": "料理ができます。", "right": "I can cook." }
      ],
    ...
    },
    {
      ...
      "options": ["It's replaced by に", "を is used instead of the more standard が", "It's dropped entirely, always", "It becomes へ"],
      "correctIndex": 1,
...
{
  "slug": "giving-receiving-agemoraukureru",
  "level": "JA-A2",
  "number": 5,
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "誕生日に何をあげますか。", "en": "tanjoubi ni nani o agemasu ka. -- What are you going to give (them) for their birthday?" },
        { "es": "誕生日に何をもらいましたか。", "en": "tanjoubi ni nani o moraimashita ka. -- What did you receive for your birthday?" },
        { "es": "誕生日に何をくれましたか。", "en": "tanjoubi ni nani o kuremashita ka. -- What did they give you for your birthday?" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Which verb describes someone else giving something to you?",
          "options": ["あげる", "もらう", "くれる", "です"],
          "correctIndex": 2,
    ...
    },
    {
      ...
      "examples": [
        { "es": "私は友達に本をあげます。", "en": "watashi wa tomodachi ni hon o agemasu. -- I give my friend a book." },
        { "es": "姉は弟にプレゼントをあげました。", "en": "ane wa otouto ni purezento o agemashita. -- My older sister gave my younger brother a present." },
        { "es": "田中さんに花をあげましょうか。", "en": "Tanaka-san ni hana o agemashou ka. -- Shall I give Tanaka flowers?" }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Put the words in order to say \"I give my friend a book.\"",
          "words": ["私", "は", "友達", "に", "本", "を", "あげます"],
        ...
        },
        {
          ...
          "options": ["私は友達に花をあげます。", "友達が私に花をあげます。", "姉は弟にプレゼントをあげました。", "母が私に本をあげました。"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "私は友達に本をもらいました。", "en": "watashi wa tomodachi ni hon o moraimashita. -- I received a book from my friend." },
        { "es": "誕生日に母から時計をもらいました。", "en": "tanjoubi ni haha kara tokei o moraimashita. -- I received a watch from my mother for my birthday." },
        { "es": "弟は友達にゲームをもらいました。", "en": "otouto wa tomodachi ni geemu o moraimashita. -- My younger brother received a game from his friend." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Which particle(s) can mark the giver in a もらう sentence when the giver is a person?",
          "options": ["を only", "は or が only", "に or から", "で only"],
          "correctIndex": 2,
    ...
    },
    {
      ...
      "examples": [
        { "es": "友達が私に本をくれました。", "en": "tomodachi ga watashi ni hon o kuremashita. -- My friend gave me a book." },
        { "es": "田中さんがチョコレートをくれました。", "en": "Tanaka-san ga chokoreeto o kuremashita. -- Tanaka gave me chocolate." },
        { "es": "兄が妹に誕生日プレゼントをくれました。", "en": "ani ga imouto ni tanjoubi purezento o kuremashita. -- My older brother gave my younger sister a birthday present." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Put the words in order to say \"My friend gave me chocolate.\"",
          "words": ["友達", "が", "私", "に", "チョコレート", "を", "くれました"],
        ...
        },
        {
          ...
          "options": ["Because くれる is always a question", "Because the giver is usually new or emphasized information", "Because は cannot mark people", "Because くれる is in the past tense"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "私は田中さんにチョコをあげました。", "en": "watashi wa Tanaka-san ni choko o agemashita. -- I gave Tanaka chocolate." },
        { "es": "田中さんが私にチョコをくれました。", "en": "Tanaka-san ga watashi ni choko o kuremashita. -- Tanaka gave me chocolate." },
        { "es": "弟は友達に漫画をあげました。", "en": "otouto wa tomodachi ni manga o agemashita. -- My little brother gave his friend manga." }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "Select the sentence(s) that describe the SAME direction as 友達が私に本をくれました。",
          "options": ["田中さんが私にチョコをくれました。", "私は田中さんにチョコをあげました。", "私は友達に本をあげました。", "先生が私にペンをくれました。"],
          "correctIndexes": [0, 3],
    ...
    },
    {
      ...
      "examples": [
        { "es": "友達が母に花をくれました。", "en": "tomodachi ga haha ni hana o kuremashita. -- My friend gave my mother flowers." },
        { "es": "母は友達に手紙をあげました。", "en": "haha wa tomodachi ni tegami o agemashita. -- My mother gave her friend a letter." },
        { "es": "妹が私にクッキーをくれました。", "en": "imouto ga watashi ni kukkii o kuremashita. -- My little sister gave me cookies." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "友達が母に花をくれました。", "right": "A gift arrives at the speaker's in-group (mother)." },
            { "left": "母は友達に手紙をあげました。", "right": "A gift leaves the speaker's in-group (mother) to an outsider." },
            { "left": "妹が私にクッキーをくれました。", "right": "A gift arrives directly at the speaker." },
            { "left": "私は妹にクッキーをあげました。", "right": "A gift leaves the speaker to an in-group member." }
          ],
        ...
        },
        {
          ...
          "options": ["Because 弟 (the speaker's younger brother) is part of the speaker's in-group, so the book is moving toward the speaker's side", "Because くれる is always used with 弟", "Because the friend is older than the brother", "Because the sentence is a question"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "誕生日パーティーで、私は友達にケーキをあげました。", "en": "tanjoubi paatii de, watashi wa tomodachi ni keeki o agemashita. -- At the birthday party, I gave my friend cake." },
        { "es": "そして、友達は私にプレゼントをくれました。", "en": "soshite, tomodachi wa watashi ni purezento o kuremashita. -- And my friend gave me a present." },
        { "es": "先生に花をさしあげました。", "en": "sensei ni hana o sashiagemashita. -- I gave my teacher flowers. (humble)" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
  ...
  "exercises": [
    {
      ...
      "options": ["私は妹に本をあげます。", "私は妹に本をもらいます。", "妹が私に本をくれます。", "私は妹に本をくれます。"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["I gave Tanaka flowers.", "Tanaka gave me flowers.", "I received flowers from Tanaka's friend.", "Tanaka received flowers from me."],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["友達が私に花をくれました。", "私は友達に花をくれました。", "妹が私にクッキーをくれました。", "友達が妹に本をあげました。"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "options": ["私は友達に本をもらいました。", "私は友達に本をあげました。", "私は母から時計をもらいました。", "友達が私に時計をくれました。"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "私は友達に本をあげました。", "right": "I gave my friend a book." },
        { "left": "友達が私に本をくれました。", "right": "My friend gave me a book." },
        { "left": "私は友達に本をもらいました。", "right": "I received a book from my friend." },
        { "left": "母が友達に花をあげました。", "right": "My mother gave her friend flowers." }
      ],
    ...
    },
    {
      ...
      "options": ["友達が私に本をくれました。", "私は友達に本をあげました。", "友達は私に本をあげました。", "私は友達に本をもらいました。"],
      "correctIndex": 2,
    ...
    },
    {
      ...
      "options": ["The speaker", "The speaker's younger sister", "A friend", "Unknown from this sentence"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["友達が母に花をくれました。", "私は友達に花をあげました。", "田中さんが私にケーキをくれました。", "私は田中さんにケーキをあげました。"],
      "correctIndexes": [0, 2],
...
{
  "slug": "particles-kara-made-ya-comparison",
  "level": "JA-A2",
  "number": 6,
  "title": "Particles for Range, Listing, and Comparison: から/まで, や, へ vs に, より, のほうが",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "授業は九時から十二時までです。", "en": "jugyou wa kuji kara juuni-ji made desu. -- Class is from 9:00 to 12:00." },
        { "es": "月曜日から金曜日まで働きます。", "en": "getsuyoubi kara kinyoubi made hatarakimasu. -- I work from Monday to Friday." },
        { "es": "夏休みは七月から九月までです。", "en": "natsuyasumi wa shichigatsu kara kugatsu made desu. -- Summer vacation is from July to September." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
        ...
        },
        {
          ...
          "options": ["夏休みは七月に九月です。", "夏休みは七月から九月までです。", "夏休みは七月や九月です。", "夏休みは七月へ九月です。"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "駅から学校まで歩きます。", "en": "eki kara gakkou made arukimasu. -- I walk from the station to school." },
        { "es": "大阪から東京まで新幹線で行きます。", "en": "Oosaka kara Toukyou made shinkansen de ikimasu. -- I go from Osaka to Tokyo by shinkansen." },
        { "es": "ここから郵便局までどのくらいですか。", "en": "koko kara yuubinkyoku made dono kurai desu ka. -- How far is it from here to the post office?" }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Put the words in order to say 'I walk from the station to school.'",
          "words": ["駅", "から", "学校", "まで", "歩きます"],
        ...
        },
        {
          ...
          "options": ["How far is it from here to the post office?", "Where is the post office from here?", "When does the post office open?", "Is the post office near here?"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "机の上に本とペンがあります。", "en": "tsukue no ue ni hon to pen ga arimasu. -- There is a book and a pen on the desk. (exactly these two)" },
        { "es": "机の上に本やペンなどがあります。", "en": "tsukue no ue ni hon ya pen nado ga arimasu. -- There are things like a book, a pen, and so on, on the desk." },
        { "es": "好きな果物はりんごやバナナです。", "en": "suki na kudamono wa ringo ya banana desu. -- My favorite fruits are things like apples and bananas." }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "Which sentences use や correctly to imply a non-exhaustive list (examples among possibly more items)?",
          "options": ["机の上に本やペンがあります。", "机の上に本とペンがあります。", "かばんの中にパスポートやカメラなどがあります。", "友達と映画を見ました。"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "来週、大阪へ行きます。", "en": "raishuu, Oosaka e ikimasu. -- Next week I'm heading to Osaka." },
        { "es": "七時に家に帰ります。", "en": "shichi-ji ni ie ni kaerimasu. -- I'll return home at 7:00." },
        { "es": "友達に会います。それから、京都へ行きます。", "en": "tomodachi ni aimasu. sorekara, Kyouto e ikimasu. -- I'll meet my friend. After that, I'm going to Kyoto." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "In 「大阪へ行きます」, what does へ emphasize compared to に?",
          "options": ["The exact arrival point", "The direction or journey toward a place", "That the action happens repeatedly", "That the place is far away"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "新幹線はバスより速いです。", "en": "shinkansen wa basu yori hayai desu. -- The shinkansen is faster than the bus." },
        { "es": "今日は昨日より寒いです。", "en": "kyou wa kinou yori samui desu. -- Today is colder than yesterday." },
        { "es": "この部屋はあの部屋より静かです。", "en": "kono heya wa ano heya yori shizuka desu. -- This room is quieter than that room." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Arrange the words to say 'The shinkansen is faster than the bus.'",
          "words": ["新幹線", "は", "バス", "より", "速い", "です"],
        ...
        },
        {
          ...
          "options": ["今日は昨日より寒いです。", "昨日は今日より寒いです。", "今日と昨日は寒いです。", "今日は昨日ほど寒くないです。"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "コーヒーと紅茶とどちらが好きですか。コーヒーのほうが好きです。", "en": "koohii to koucha to dochira ga suki desu ka. koohii no hou ga suki desu. -- Which do you like more, coffee or tea? -- I like coffee more." },
        { "es": "電車のほうがバスより便利です。", "en": "densha no hou ga basu yori benri desu. -- The train is more convenient than the bus." },
        { "es": "夏より冬のほうが好きです。", "en": "natsu yori fuyu no hou ga suki desu. -- I like winter more than summer." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
        ...
        },
        {
          ...
          "options": ["コーヒーのほうが好きです。", "コーヒーより紅茶が好きです。", "コーヒーが好きです。紅茶よりおいしいです。", "紅茶のほうが好きです。"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "東京から京都まで新幹線で行きますが、バスのほうが安いです。", "en": "Toukyou kara Kyouto made shinkansen de ikimasu ga, basu no hou ga yasui desu. -- I'll go from Tokyo to Kyoto by shinkansen, but the bus is cheaper." },
        { "es": "かばんの中にパスポートやカメラを入れました。", "en": "kaban no naka ni pasupooto ya kamera wo iremashita. -- I put things like my passport and camera in my bag." },
        { "es": "九時から会議が始まりますから、早く会社へ行きます。", "en": "kuji kara kaigi ga hajimarimasu kara, hayaku kaisha e ikimasu. -- Since the meeting starts at 9:00, I'll go to the office early." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "から", "right": "starting point (time or place)" },
            { "left": "まで", "right": "ending point (time or place)" },
            { "left": "や", "right": "non-exhaustive listing ('and, among others')" },
            { "left": "より", "right": "standard of comparison ('than')" }
          ],
        ...
        },
        {
          ...
          "options": ["東京から京都まで新幹線で行きますが、バスのほうが安いです。", "東京は京都より新幹線です。", "東京へ京都からバスです。", "東京と京都は新幹線とバスです。"],
          "correctIndex": 0,
  ...
  "exercises": [
    ...
    },
    {
      ...
      "options": ["財布の中に千円札と五百円玉があります。", "財布の中に千円札や五百円玉があります。", "冷蔵庫に卵とバターがあります。それだけです。", "冷蔵庫に卵やバターなどがあります。"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "options": ["へ is only for trains, に is only for cars.", "へ slightly emphasizes the journey/direction, に slightly emphasizes the destination point; in casual speech they're largely interchangeable.", "へ is polite and に is rude.", "There is no difference at all in any context."],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["It marks the subject of the sentence.", "It marks あの部屋 as the standard being compared against.", "It means 'and' between two nouns.", "It makes the adjective negative."],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["The less preferred option", "The option being favored or judged as 'more so'", "A location", "A time range"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["月曜日から金曜日まで働きます。", "駅から学校です。", "大阪から東京まで新幹線で行きます。", "九時と五時までです。"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "instructions": "Match each Japanese sentence to its English meaning.",
      "pairs": [
        { "left": "電車のほうがバスより便利です。", "right": "The train is more convenient than the bus." },
        { "left": "机の上に本やペンなどがあります。", "right": "There are things like a book, a pen, and so on, on the desk." },
        { "left": "来週、大阪へ行きます。", "right": "Next week I'm heading to Osaka." },
        { "left": "図書館は九時から五時までです。", "right": "The library is open from 9:00 to 5:00." }
      ],
    ...
    },
    {
      ...
      "options": ["九時から会議が始まりますから、早く会社へ行きます。", "九時まで会議が始まりますが、早く会社に行きません。", "九時や会議が始まります、早く会社です。", "九時より会議が始まります、早く会社まで行きます。"],
      "correctIndex": 0,
...
{
  "slug": "noun-modification-relative-clauses",
  "level": "JA-A2",
  "number": 7,
  "title": "Modifying Nouns with Clauses (Relative Clauses)",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "食べる人", "en": "taberu hito -- the person who eats / will eat" },
        { "es": "昨日買った本", "en": "kinou katta hon -- the book (that I) bought yesterday" },
        { "es": "私が作った料理", "en": "watashi ga tsukutta ryouri -- the food that I made" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Which word does Japanese use to mean 'that' or 'which' in a phrase like 'the book that I bought'?",
          "options": ["という", "の", "There is no such word — the clause goes directly before the noun", "それ"],
          "correctIndex": 2,
    ...
    },
    {
      ...
      "examples": [
        { "es": "日本語を話す人", "en": "nihongo o hanasu hito -- the person who speaks Japanese" },
        { "es": "明日来る友達", "en": "ashita kuru tomodachi -- the friend who is coming tomorrow" },
        { "es": "毎日走る人", "en": "mainichi hashiru hito -- the person who runs every day" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
        ...
        },
        {
          ...
          "options": ["明日来る学生", "明日来ます学生", "明日来た学生", "明日来ない学生"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "昨日買った本はおもしろいです。", "en": "kinou katta hon wa omoshiroi desu. -- The book (that I) bought yesterday is interesting." },
        { "es": "先週見た映画", "en": "senshuu mita eiga -- the movie (that I) watched last week" },
        { "es": "友達が書いた手紙", "en": "tomodachi ga kaita tegami -- the letter that my friend wrote" }
      ],
      "checkpoint": [
        {
          "type": "word-order",
    ...
    },
    {
      ...
      "examples": [
        { "es": "肉を食べない人", "en": "niku o tabenai hito -- a person who doesn't eat meat" },
        { "es": "宿題をしなかった学生", "en": "shukudai o shinakatta gakusei -- the student who didn't do the homework" },
        { "es": "漢字を知らない人", "en": "kanji o shiranai hito -- a person who doesn't know kanji" }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "Which of these are correctly formed negative modifying clauses?",
          "options": ["肉を食べない人", "肉を食べません人", "宿題をしなかった学生", "宿題をしませんでした学生"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "静かな部屋がほしいです。", "en": "shizuka na heya ga hoshii desu. -- I want a quiet room." },
        { "es": "有名な先生", "en": "yuumei na sensei -- a famous teacher" },
        { "es": "高くない店", "en": "takakunai mise -- a store that isn't expensive" }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "静かな部屋", "right": "a quiet room" },
            { "left": "有名な先生", "right": "a famous teacher" },
            { "left": "高くない店", "right": "a store that isn't expensive" },
            { "left": "大きい犬", "right": "a big dog" }
          ],
    ...
    },
    {
      ...
      "examples": [
        { "es": "私が昨日買った本はおもしろいです。", "en": "watashi ga kinou katta hon wa omoshiroi desu. -- The book that I bought yesterday is interesting." },
        { "es": "田中さんが作った料理はとてもおいしかったです。", "en": "tanaka-san ga tsukutta ryouri wa totemo oishikatta desu. -- The food that Tanaka-san made was very delicious." },
        { "es": "妹が読んでいる本", "en": "imouto ga yondeiru hon -- the book that my younger sister is reading" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "私が今朝カフェで飲んだコーヒーはおいしかったです。", "en": "watashi ga kesa kafe de nonda koohii wa oishikatta desu. -- The coffee that I drank at the cafe this morning was delicious." },
        { "es": "田中さんが去年住んでいた部屋", "en": "tanaka-san ga kyonen sundeita heya -- the room that Tanaka-san was living in last year" },
        { "es": "昨日図書館で借りた本を読んでいます。", "en": "kinou toshokan de karita hon o yondeimasu. -- I am reading the book that I borrowed at the library yesterday." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Arrange the words to say 'the coffee that I drank at the cafe this morning.'",
          "words": ["私", "が", "今朝", "カフェ", "で", "飲んだ", "コーヒー"],
  ...
  "exercises": [
    {
      ...
      "options": ["納豆を食べる人という人", "納豆を食べる人", "納豆を食べます人", "人が納豆を食べる"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["食べない人", "食べません人", "昨日来た学生", "昨日来ます学生"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "食べない人", "right": "a person who doesn't eat" },
        { "left": "買った本", "right": "the book that was bought" },
        { "left": "来る学生", "right": "the student who is coming" },
        { "left": "作った料理", "right": "the food that was made" }
      ],
    ...
    },
    {
      ...
      "options": ["有名レストラン", "有名なレストラン", "有名だレストラン", "有名のレストラン"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["私が読んだ本", "私は読んだ本", "私が読みました本", "私が読む本"],
      "correctIndexes": [0, 3],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "静かだった部屋", "right": "a room that was quiet" },
        { "left": "高くない店", "right": "a store that isn't expensive" },
        { "left": "宿題をしなかった学生", "right": "the student who didn't do the homework" },
        { "left": "漢字を知らない人", "right": "a person who doesn't know kanji" }
      ],
...
{
  "slug": "casual-plain-speech-register",
  "level": "JA-A2",
  "number": 8,
  "title": "Casual Speech: The Plain Form System",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "買います → 買う", "en": "kaimasu → kau -- to buy (polite → dictionary form)" },
        { "es": "食べます → 食べる", "en": "tabemasu → taberu -- to eat" },
        { "es": "します → する / 来ます → 来る", "en": "shimasu → suru / kimasu → kuru -- irregular verbs" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Which is the dictionary (plain non-past) form of 飲みます?",
          "options": ["飲む", "飲んだ", "飲まない", "飲んでいる"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "飲む → 飲まない", "en": "nomu → nomanai -- not drink / won't drink" },
        { "es": "見る → 見ない", "en": "miru → minai -- not watch / won't watch" },
        { "es": "買う → 買わない", "en": "kau → kawanai -- not buy (note う → わ, not あ)" }
      ],
      "checkpoint": [
        {
          "type": "word-order",
    ...
    },
    {
      ...
      "examples": [
        { "es": "学生だった。", "en": "gakusei datta. -- [I] was a student." },
        { "es": "楽しかった。", "en": "tanoshikatta. -- It was fun." },
        { "es": "昨日、友達に会った。", "en": "kinou, tomodachi ni atta. -- [I] met a friend yesterday." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "Noun (先生 - teacher)", "right": "先生だった" },
            { "left": "な-adjective (暇 - free)", "right": "暇だった" },
            { "left": "い-adjective (寒い - cold)", "right": "寒かった" },
            { "left": "Verb (行く - to go)", "right": "行った" }
          ],
    ...
    },
    {
      ...
      "examples": [
        { "es": "昨日は暇じゃなかった。", "en": "kinou wa hima ja nakatta. -- Yesterday wasn't free." },
        { "es": "あまり寒くなかった。", "en": "amari samukunakatta. -- It wasn't very cold." },
        { "es": "昨日は雨が降らなかった。", "en": "kinou wa ame ga furanakatta. -- It didn't rain yesterday." }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "Which of these are correctly formed plain negative-past forms? Select all that apply.",
          "options": ["寒くなかった (was not cold)", "暇じゃなかった (was not free)", "行かなかった (did not go)", "食べなくない (incorrect)", "するなかった (incorrect)"],
          "correctIndexes": [0, 1, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "今日は休みだ。", "en": "kyou wa yasumi da. -- Today is a day off." },
        { "es": "今日、休み?", "en": "kyou, yasumi? -- Is today a day off? (だ dropped, rising intonation)" },
        { "es": "これ、誰の?", "en": "kore, dare no? -- Whose is this?" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "In casual speech, how would you naturally ask 'Is this yours?'",
          "options": ["これ、あなたの?", "これ、あなたのだか?", "これはあなたのですだ?", "これあなたのですか?"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "先生：お元気ですか。／友達：元気?", "en": "sensei: ogenki desu ka. / tomodachi: genki? -- teacher: how are you (polite) / friend: how's it going? (casual)" },
        { "es": "（上司に）明日、会議に行きます。", "en": "(joushi ni) ashita, kaigi ni ikimasu. -- (to a boss) I will go to the meeting tomorrow." },
        { "es": "（親友に）明日、行く?", "en": "(shinyuu ni) ashita, iku? -- (to a close friend) Are you going tomorrow?" }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "In which of these situations is casual/plain speech generally appropriate? Select all that apply.",
          "options": ["Talking with a close friend your own age", "Speaking to your company's president", "Chatting with your younger sibling", "Answering a question in a job interview", "Texting a classmate you're friends with"],
          "correctIndexes": [0, 2, 4],
        ...
        },
        {
          ...
          "options": ["They are being rude", "The relationship is close enough for casual speech to be appropriate", "They forgot proper Japanese", "They only speak casually because you are a foreigner"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "どこ行くの?", "en": "doko iku no? -- Where are you going? (explanatory, casual)" },
        { "es": "元気なの?", "en": "genki nano? -- Are you doing okay? (な-adjective + なの)" },
        { "es": "なんで来ないの?", "en": "nande konai no? -- Why aren't you coming?" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
  ...
  "exercises": [
    ...
    },
    {
      ...
      "pairs": [
        { "left": "食べます", "right": "食べる" },
        { "left": "食べません", "right": "食べない" },
        { "left": "食べました", "right": "食べた" },
        { "left": "食べませんでした", "right": "食べなかった" }
      ],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "Noun negative past (先生 - teacher)", "right": "先生じゃなかった" },
        { "left": "な-adjective negative past (暇 - free)", "right": "暇じゃなかった" },
        { "left": "い-adjective negative past (寒い - cold)", "right": "寒くなかった" },
        { "left": "Verb negative past (飲む - to drink)", "right": "飲まなかった" }
      ],
    ...
    },
    {
      ...
      "options": ["今日は雨だ。(statement, keeping だ)", "今日、雨? (question, だ dropped before implied か)", "今日は雨だか? (question using だか)", "これは本だ。(statement, keeping だ)"],
    ...
    },
    {
      ...
      "options": ["飲む (to drink)", "食べる (to eat)", "する (to do)", "来ます (to come, polite)", "話す (to speak)"],
    ...
    },
    {
      ...
      "options": ["初めまして。よろしくお願いします。", "初めて。よろしく。", "はじめまして。よろしくね。", "よろしく!"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["It's the form listed as the headword in Japanese dictionaries", "It's only used when reading dictionaries aloud", "It's a simplified form invented for beginners", "It's used exclusively in formal written Japanese"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["Ordering coffee from a barista you don't know", "Chatting with your little brother at home", "Texting your best friend from college", "Complaining to a close friend about work"],
      "correctIndex": 0,
...
{
  "slug": "a2-module-review",
  "level": "JA-A2",
  "number": 9,
  "title": "A2 Module Review: Putting It All Together",
  ...
  "sections": [
    ...
    },
    {
      ...
      "examples": [
        { "es": "今、テレビを見ています。", "en": "ima, terebi o mite imasu. -- I am watching TV right now." },
        { "es": "あの人を知っていますか。「いいえ、知りません。」", "en": "ano hito o shitte imasu ka. \"iie, shirimasen.\" -- Do you know that person? \"No, I don't know.\"" }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "Which sentences use ～ている to describe a resultant state, rather than an action in progress?",
          "options": ["電気がついています。", "今、宿題をしています。", "もう起きています。", "手紙を書いています。"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "ここで写真を撮ってもいいですか。", "en": "koko de shashin o totte mo ii desu ka. -- May I take a photo here?" },
        { "es": "この部屋でたばこを吸ってはいけません。", "en": "kono heya de tabako o sutte wa ikemasen. -- You must not smoke in this room." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "A sign says 「ここに座ってはいけません。」What does this mean?",
          "options": ["You must not sit here.", "May I sit here?", "Please sit here.", "You don't have to sit here."],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "昨日、友達と映画を見ました。", "en": "kinou, tomodachi to eiga o mimashita. -- Yesterday I watched a movie with a friend." },
        { "es": "テストは難しくなかったです。でも、天気はよかったです。", "en": "tesuto wa muzukashikunakatta desu. demo, tenki wa yokatta desu. -- The test wasn't difficult. But the weather was good." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
        ...
        },
        {
          ...
          "options": ["映画を見ました。", "映画を見ています。", "天気がよかったです。", "忙しいです。"],
          "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "examples": [
        { "es": "漢字が少し読めます。", "en": "kanji ga sukoshi yomemasu. -- I can read a little kanji." },
        { "es": "今度の休みに温泉に行きたいです。", "en": "kondo no yasumi ni onsen ni ikitai desu. -- I want to go to a hot spring on the next vacation." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "What is the correct potential form of 泳ぐ (to swim)?",
          "options": ["泳げる", "泳える", "泳ぎられる", "泳ぐられる"],
          "correctIndex": 0,
    ...
    },
    {
      ...
      "examples": [
        { "es": "私は田中さんに花をあげました。", "en": "watashi wa Tanaka-san ni hana o agemashita. -- I gave Tanaka flowers." },
        { "es": "山田さんが私にお土産をくれました。", "en": "Yamada-san ga watashi ni omiyage o kuremashita. -- Yamada gave me a souvenir." }
      ],
      "checkpoint": [
        {
          "type": "matching",
          ...
          "pairs": [
            { "left": "あげる", "right": "the subject gives to someone else (not the speaker)" },
            { "left": "もらう", "right": "the speaker (or in-group) receives something" },
            { "left": "くれる", "right": "someone gives something to the speaker" }
          ],
    ...
    },
    {
      ...
      "examples": [
        { "es": "月曜日から金曜日まで学校があります。", "en": "getsuyoubi kara kinyoubi made gakkou ga arimasu. -- There is school from Monday to Friday." },
        { "es": "電車より飛行機のほうが速いです。", "en": "densha yori hikouki no hou ga hayai desu. -- Planes are faster than trains." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Which sentence correctly uses や to give a partial, non-exhaustive list?",
          "options": ["机の上に本やノートなどがあります。", "机の上に本や本があります。", "私や田中さんです。", "本とノートやがあります。"],
          "correctIndex": 0,
        ...
        },
        {
          ...
          "words": ["漢字", "と", "ひらがな", "と", "どちら", "が", "読めます", "か"],
    ...
    },
    {
      ...
      "examples": [
        { "es": "これは去年撮った写真です。", "en": "kore wa kyonen totta shashin desu. -- This is a photo I took last year." },
        { "es": "A: 明日、何する？ B: たぶん家にいる。", "en": "A: ashita, nani suru? B: tabun ie ni iru. -- A: What are you doing tomorrow? B: Probably staying home." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
  ...
  "exercises": [
    ...
    },
    {
      ...
      "options": ["The teacher gave me a book.", "I gave the teacher a book.", "The teacher received a book from me.", "I received a book from the teacher."],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "pairs": [
        { "left": "～てもいいですか", "right": "asking for permission" },
        { "left": "～てはいけません", "right": "prohibition, 'must not'" },
        { "left": "～たい", "right": "expressing the speaker's own desire" },
        { "left": "～(ら)れる", "right": "expressing ability, 'can do'" }
      ],
    ...
    },
    {
      ...
      "options": ["昨日買った本", "昨日買う本", "昨日買いました本", "昨日買っている本"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["楽しくなかったです", "楽しいなかったです", "楽しかったないです", "楽しくないでした"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "options": ["コーヒーより紅茶のほうが好きです。", "コーヒーがより紅茶好きです。", "夏より冬のほうが好きです。", "冬はより夏好きです。"],
      "correctIndexes": [0, 2],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "から～まで", "right": "marks a starting point and an ending point" },
        { "left": "や", "right": "lists a few examples from a larger set" },
        { "left": "より", "right": "marks the thing being compared against ('than')" },
        { "left": "のほうが", "right": "singles out the one that is more ~" }
      ],
    ...
    },
    {
      ...
      "options": ["開いています", "開けています", "開きます", "開いました"],
      "correctIndex": 0,
