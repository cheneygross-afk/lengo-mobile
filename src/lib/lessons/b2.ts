...
export const B2_LESSONS: Lesson[] = [
  {
    ...
    "level": "B2",
    "number": 1,
    "title": "Subjuntivo en Cláusulas Adjetivas",
  ...
  },
  {
    ...
    "level": "B2",
    "number": 2,
    "title": "Subjuntivo en Cláusulas Adverbiales",
  ...
  {
    "slug": "imperfect-subjunctive-sequence",
    "level": "B2",
    "number": 3,
    "title": "Imperfecto de Subjuntivo y Secuencia de Tiempos",
  ...
  {
    "slug": "hypothetical-si-clauses",
    "level": "B2",
    "number": 4,
    "title": "Cláusulas Hipotéticas con Si",
  ...
  {
    "slug": "conditional-perfect-pluperfect-subjunctive",
    "level": "B2",
    "number": 5,
    "title": "Condicional Perfecto y Pluscuamperfecto de Subjuntivo",
  ...
  {
    "slug": "ser-estar-haber-nuanced",
    "level": "B2",
    "number": 8,
    "title": "Ser, Estar y Haber: Usos Matizados",
  ...
  {
    "slug": "emphasis-word-order",
    "level": "B2",
    "number": 12,
    "title": "Énfasis y Orden de Palabras",
  ...
  },
  {
    ...
    "level": "B2",
    "number": 13,
    "title": "Cuyo y El Cual: Pronombres Relativos Avanzados",
    ...
    "sections": [
      {
        ...
        "examples": [
          { "es": "El hombre cuya casa visitamos es mi abuelo.", "en": "the man whose house we visited" },
          { "es": "La empresa cuyos empleados protestaron cerró la semana pasada.", "en": "the company whose employees protested" },
          { "es": "El escritor cuyas novelas ganaron el premio nacional es colombiano.", "en": "the writer whose novels won the national award" },
          { "es": "La actriz cuyo esposo dirige la película llegó tarde.", "en": "the actress whose husband directs the film" }
        ],
        "checkpoint": [
          {
            "type": "fill-blank",
      ...
      },
      {
        ...
        "examples": [
          { "es": "Este es el contrato según el cual debemos pagar en treinta días.", "en": "the contract according to which we must pay within thirty days" },
          { "es": "La reunión durante la cual se tomó la decisión duró tres horas.", "en": "the meeting during which the decision was made" },
          { "es": "Los documentos sin los cuales no podemos continuar se perdieron.", "en": "the documents without which we cannot continue" },
          { "es": "Las empleadas para las cuales trabajo son muy amables.", "en": "the employees for whom I work" }
        ],
        "checkpoint": [
          {
            "type": "multiple-choice",
            "question": "Elige la opción correcta: \"Este es el proyecto ___ dependen cientos de familias.\"",
            "options": ["cuyo", "el cual", "del cual", "la cual"],
            "correctIndex": 2,
      ...
      },
      {
        ...
        "examples": [
          { "es": "La casa que compramos es enorme.", "en": "the house that we bought" },
          { "es": "El hijo de mi vecina, el cual estudia medicina, vino a cenar.", "en": "my neighbor's son, who studies medicine, came to dinner" },
          { "es": "El hijo de mi vecina, la cual estudia medicina, vino a cenar.", "en": "my neighbor, who studies medicine — her son came to dinner" }
        ],
        "checkpoint": [
          {
            "type": "multi-select",
            "question": "¿En cuáles de las siguientes oraciones es apropiado usar \"el cual\" (o su forma correspondiente) en vez de \"que\"?",
            "options": ["La chica que conocí ayer es italiana.", "El hermano de mi jefa, el cual vive en Chile, nos visitará.", "Este es el motivo por el cual renuncié.", "Compré el libro que me recomendaste."],
            "correctIndexes": [1, 2],
      ...
      },
      {
        ...
        "examples": [
          { "es": "Llovió todo el fin de semana, lo cual arruinó nuestros planes.", "en": "it rained all weekend, which ruined our plans" },
          { "es": "No me avisó del cambio de horario, lo cual me pareció una falta de respeto.", "en": "he didn't tell me about the schedule change, which I found disrespectful" }
        ],
        "checkpoint": [
          {
            "type": "fill-blank",
        ...
        "checkpoint": [
          {
            ...
            "options": ["A que el alcalde tiene mala gestión", "A que el proyecto empezará el año que viene", "A que muchos vecinos dudan de que el plan se cumpla", "A los mil apartamentos"],
            "correctIndex": 2,
    ...
    "exercises": [
      {
        ...
        "options": ["La mujer cuyo hijos son médicos vive aquí.", "La mujer cuyos hijos son médicos vive aquí.", "La mujer cuya hijos son médicos vive aquí.", "La mujer cuyas hijo son médicos vive aquí."],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": ["cuyo", "por las cuales", "por el cual", "las cuales"],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": ["No llegó a tiempo, ___ nos causó problemas.", "La decisión ___ tomamos fue difícil.", "El jefe canceló la reunión, ___ nos sorprendió a todos.", "Los documentos ___ necesitamos están en la otra oficina."],
        "correctIndexes": [0, 2],
      ...
      },
      {
        ...
        "altAnswers": ["El profesor, cuya investigación ha ganado varios premios internacionales, va a dar una conferencia mañana."],
      ...
      },
      {
        ...
        "words": ["Este", "es", "el", "motivo", "por", "el", "cual", "renuncié"],
      ...
      },
      {
        ...
        "pairs": [
          { "left": "cuyo / cuya / cuyos / cuyas", "right": "concuerda con el sustantivo poseído, no con el poseedor" },
          { "left": "el cual / la cual / los cuales / las cuales", "right": "concuerda con el antecedente; frecuente tras preposiciones o para evitar ambigüedad" },
          { "left": "lo cual", "right": "se refiere a toda una idea o cláusula anterior, no a un sustantivo" },
          { "left": "que", "right": "la opción más simple y natural en cláusulas cortas sin ambigüedad" }
        ],
...
{
  slug: "subjunctive-adjective-clauses-drill",
  level: "B2",
  number: 14,
  title: "El Subjuntivo en Cláusulas Adjetivas (Relativas): Práctica Extra",
  ...
  sections: [
    {
      ...
      examples: [
        { es: "Busco un apartamento que tenga dos baños.", en: "I'm looking for an apartment that has two bathrooms." },
        { es: "Necesitamos un empleado que hable alemán.", en: "We need an employee who speaks German." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Tengo un apartamento que tiene dos baños.", en: "I have an apartment that has two bathrooms." },
        { es: "Conozco a un empleado que habla alemán.", en: "I know an employee who speaks German." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Hay un restaurante que sirve comida vegana.", en: "There's a restaurant that serves vegan food." },
        { es: "Busco un restaurante que sirva comida vegana.", en: "I'm looking for a restaurant that serves vegan food." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
    ...
    },
    {
      ...
      examples: [
        ...
        { es: "No conozco a ningún médico que trabaje los domingos.", en: "I don't know any doctor who works on Sundays." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Necesito algo que me ayude a dormir.", en: "I need something that will help me sleep." },
        { es: "Quiero un coche que no consuma mucha gasolina.", en: "I want a car that doesn't use much gas." }
      ],
      checkpoint: [
        {
          type: "translate",
    ...
    },
    {
      ...
      examples: [
        { es: "¿Conoces a alguien que hable japonés?", en: "Do you know anyone who speaks Japanese?" },
        { es: "¿Hay algún hotel por aquí que acepte mascotas?", en: "Is there a hotel around here that accepts pets?" }
      ],
      checkpoint: [
        {
          type: "word-order",
          prompt: "Ordena las palabras para formar una pregunta correcta.",
          words: ["¿Conoces", "a", "alguien", "que", "sepa", "reparar", "computadoras", "?"],
    ...
    },
    {
      ...
      examples: [
        { es: "Busco a alguien que sea honesto.", en: "I'm looking for someone who is honest." },
        { es: "No hay nada que yo pueda hacer.", en: "There's nothing I can do." }
      ],
      checkpoint: [
        {
          type: "multi-select",
    ...
    },
    {
      ...
      examples: [
        { es: "Ella tiene un perro que ladra mucho.", en: "She has a dog that barks a lot." },
        { es: "Ella quiere un perro que no ladre mucho.", en: "She wants a dog that doesn't bark much." }
      ],
      checkpoint: [
        {
          type: "matching",
          ...
          pairs: [
            { left: "Busco una casa que tenga piscina.", right: "I'm looking for a house that has a pool." },
            { left: "Tengo una casa que tiene piscina.", right: "I have a house that has a pool." },
            { left: "No hay nadie que pueda ayudarte.", right: "There's no one who can help you." }
          ],
  ...
  exercises: [
    {
      ...
      options: ["habla", "hable", "hablará", "ha hablado"],
      correctIndex: 1,
    ...
    },
    {
      ...
      altAnswers: ["There's no book here that explains this topic."],
    ...
    },
    {
      ...
      altAnswers: ["Ella busca un compañero de cuarto que no fume.", "Ella está buscando una compañera de cuarto que no fume."],
      explanation: "Como todavía no se sabe si existe tal compañero/a de cuarto, se usa el subjuntivo: fume."
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["Necesitamos", "un", "asistente", "que", "hable", "inglés", "y", "español"],
    ...
    },
    {
      ...
      options: ["consuma", "consume", "consumiera", "haya consumido"],
      correctIndex: 1,
    ...
    },
    {
      ...
      pairs: [
        { left: "Busco un profesor que...", right: "sepa explicar bien la gramática." },
        { left: "Tengo un profesor que...", right: "sabe explicar bien la gramática." },
        { left: "No hay ningún profesor que...", right: "explique tan bien como el mío." }
      ],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["No", "conozco", "a", "nadie", "que", "haya", "vivido", "en", "Japón"],
    ...
    },
    {
      ...
      altAnswers: ["No hay nada aquí que pueda ayudarme."],
      explanation: "'Nada' es un antecedente negativo, así que siempre requiere subjuntivo: pueda."
    }
  ]
},
{
  slug: "subjunctive-adverbial-clauses-drill",
  level: "B2",
  number: 15,
  title: "El Subjuntivo en Cláusulas Adverbiales: Práctica Extra",
  ...
  sections: [
    {
      ...
      body: ["Cuando + subjuntivo señala una acción futura o hipotética; cuando + indicativo señala un hábito o un hecho pasado."],
      examples: [
        { es: "Te llamaré cuando llegue a casa.", en: "I'll call you when I get home." },
        { es: "Siempre te llamo cuando llego a casa.", en: "I always call you when I get home." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      body: ["En cuanto, tan pronto como, hasta que y después de que siguen la misma regla que cuando: subjuntivo para el futuro, indicativo para lo habitual o lo ya ocurrido."],
      examples: [
        { es: "En cuanto termine el examen, saldré a celebrar.", en: "As soon as I finish the exam, I'll go out to celebrate." },
        { es: "Esperé hasta que terminó la película.", en: "I waited until the movie ended." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "Elige la forma correcta: 'En cuanto ___ (llegar) el jefe, empezaremos la reunión.'",
          options: ["llega", "llegue", "llegaba", "ha llegado"],
          correctIndex: 1,
    ...
    {
      heading: "Antes de que: siempre subjuntivo",
      body: ["Antes de que siempre va con subjuntivo, sin importar si la acción es futura, habitual o pasada."],
      examples: [
        { es: "Antes de que empiece la reunión, prepara los documentos.", en: "Before the meeting starts, prepare the documents." },
        { es: "Llegamos antes de que empezara la reunión.", en: "We arrived before the meeting started." }
      ],
      checkpoint: [
        {
          type: "translate",
    ...
    },
    {
      ...
      body: ["Aunque lleva subjuntivo cuando la información es hipotética o desconocida, e indicativo cuando expresa un hecho real y conocido."],
      examples: [
        { es: "Aunque llueve, saldremos a caminar.", en: "Even though it's raining, we'll go for a walk." },
        { es: "Aunque llueva mañana, saldremos a caminar.", en: "Even if it rains tomorrow, we'll go for a walk." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "'Aunque ___ (llover), no cancelaremos el picnic mañana.' (No sabemos si va a llover o no)",
          options: ["llueve", "llueva", "llovía", "ha llovido"],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["A pesar de que sigue la misma regla que aunque: indicativo para hechos confirmados, subjuntivo para lo hipotético o incierto."],
      examples: [
        { es: "A pesar de que tiene poco dinero, viaja mucho.", en: "Even though he has little money, he travels a lot." },
        { es: "A pesar de que sea difícil, lo intentaremos.", en: "Even if it's difficult, we'll try it." }
      ],
      checkpoint: [
        {
          type: "word-order",
          prompt: "Ordena las palabras para formar una oración correcta.",
          words: ["A", "pesar", "de", "que", "tiene", "poco", "dinero,", "viaja", "mucho."],
    ...
    },
    {
      ...
      body: ["Para que expresa propósito con dos sujetos distintos y siempre requiere subjuntivo."],
      examples: [
        { es: "Te lo explico para que entiendas.", en: "I'm explaining it to you so that you understand." },
        { es: "Hablé más despacio para que me entendieran.", en: "I spoke more slowly so that they would understand me." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Cuál es la opción correcta?: 'Te presto el libro para que lo ___ (leer).'",
          options: ["lees", "leas", "leíste", "leerás"],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Sin que, a menos que, con tal de que y en caso de que siempre exigen subjuntivo porque introducen condiciones o excepciones."],
      examples: [
        { es: "Iré a la fiesta con tal de que tú vengas también.", en: "I'll go to the party as long as you come too." },
        { es: "Llévate un paraguas en caso de que llueva.", en: "Take an umbrella in case it rains." }
      ],
      checkpoint: [
        {
          type: "multi-select",
          question: "Selecciona TODAS las conjunciones que siempre requieren subjuntivo.",
          options: ["para que", "cuando", "sin que", "a menos que", "porque", "en caso de que"],
    ...
    },
    {
      ...
      body: ["Repasa todos los conectores juntos para reforzar la diferencia entre lo real o habitual y lo futuro o hipotético."],
      examples: [
        { es: "Siempre salgo a correr cuando hace buen tiempo.", en: "I always go running when the weather is nice." },
        { es: "Vamos a la playa a menos que haya tormenta.", en: "We're going to the beach unless there's a storm." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
        ...
        },
        {
          ...
          options: ["hace", "haga", "hizo", "hiciera"],
          correctIndex: 0,
  ...
  exercises: [
    {
      ...
      options: ["termino", "termine", "terminé", "terminaba"],
      correctIndex: 1,
    ...
    },
    {
      ...
      altAnswers: ["I won't be able to sleep until you arrive home."],
    ...
    },
    {
      ...
      pairs: [
        { left: "sin que", right: "Salió de la casa sin que nadie lo viera." },
        { left: "a menos que", right: "No iremos a menos que deje de llover." },
        { left: "con tal de que", right: "Te ayudo con tal de que me lo agradezcas." },
        { left: "en caso de que", right: "Lleva el paraguas en caso de que llueva." }
      ],
    ...
    },
    {
      ...
      options: ["gana", "gane", "ganara", "ganaría"],
      correctIndex: 0,
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["No", "saldremos", "a", "menos", "que", "termines", "la", "tarea"],
    ...
    },
    {
      ...
      options: ["se gradúa", "se graduara", "se graduó", "se graduaría"],
      correctIndex: 2,
    ...
    },
    {
      ...
      altAnswers: ["Provided that you accompany me, I'll go to the party."],
    ...
    },
    {
      ...
      pairs: [
        { left: "Cuando era pequeño,", right: "jugaba en este parque todos los días." },
        { left: "Cuando sea mayor,", right: "quiero ser médico." },
        { left: "Aunque hace frío ahora mismo,", right: "no llevo abrigo." },
        { left: "Aunque haga frío mañana,", right: "iremos a la montaña." }
      ],
...
{
  slug: "imperfect-subjunctive-sequence-tenses-drill",
  level: "B2",
  number: 16,
  title: "El Imperfecto de Subjuntivo y la Correlación de Tiempos: Práctica Extra",
  ...
  sections: [
    {
      ...
      examples: [
        { es: "hablaron → hablara", en: "they spoke → (that) I/he/she spoke" },
        { es: "Ojalá tú hablaras con ella.", en: "I wish you would talk to her." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "comieron → comiera", en: "they ate → (that) I/he/she ate" },
        { es: "vivieron → viviera", en: "they lived → (that) I/he/she lived" }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Cuál es la forma correcta de 'vivir' para 'nosotros' en imperfecto de subjuntivo?",
          options: ["viviéramos", "vivimos", "viviríamos", "vivamos"],
          correctIndex: 0,
    ...
    },
    {
      ...
      examples: [
        { es: "tuvieron → tuviera", en: "(that) I/he/she had" },
        { es: "supieron → supiera", en: "(that) I/he/she knew" }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "dijeron → dijera", en: "(that) I/he/she said" },
        { es: "hicieron → hiciera", en: "(that) I/he/she did/made" }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "fueron → fuera", en: "(that) I/he/she was / went" },
        { es: "quisieron → quisiera", en: "(that) I/he/she wanted" }
      ],
      checkpoint: [
        {
          type: "fill-blank",
        ...
        },
        {
          ...
          altAnswers: ["I was hoping you would do it well.", "I hoped you did it well."],
      ...
      checkpoint: [
        {
          ...
          options: ["vengas", "vinieras", "vienes", "vendrás"],
          correctIndex: 0,
    ...
    },
    {
      ...
      examples: [
        { es: "Esperaba que vinieras mañana.", en: "I hoped you would come tomorrow." },
        { es: "Era importante que llegáramos a tiempo.", en: "It was important that we arrive on time." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        ...
        { es: "Dudo que tenga razón. / Dudaba que tuviera razón.", en: "I doubt he's right. / I doubted he was right." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "Elige la opción correcta: 'Era importante que...'",
          options: ["...lleguemos a tiempo.", "...llegáramos a tiempo.", "...llegamos a tiempo.", "...llegaremos a tiempo."],
          correctIndex: 1,
  ...
  exercises: [
    ...
    },
    {
      ...
      options: ["tuvieran", "tienen", "tuvieron", "tendrían"],
      correctIndex: 0,
    ...
    },
    {
      ...
      altAnswers: ["Deseaba que tú estuvieras aquí.", "Deseaba que estuvieses aquí."],
    ...
    },
    {
      ...
      altAnswers: ["It was important for us to arrive early.", "It was important that we arrived early."],
      explanation: "'Era importante' en pasado exige el imperfecto de subjuntivo 'llegáramos' en la cláusula subordinada."
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["Esperaba", "que", "ellos", "supieran", "la", "respuesta."],
    ...
    },
    {
      ...
      pairs: [
        { left: "tener", right: "tuviera" },
        { left: "ser / ir", right: "fuera" },
        { left: "hacer", right: "hiciera" },
        { left: "decir", right: "dijera" },
        { left: "poder", right: "pudiera" },
        { left: "saber", right: "supiera" },
        { left: "querer", right: "quisiera" }
      ],
    ...
    },
    {
      ...
      options: ["fuera", "iera", "fuese", "iba", "fue"],
      correctIndexes: [0, 2],
    ...
    },
    {
      ...
      options: ["vengamos", "viniéramos", "venimos", "vendremos"],
      correctIndex: 0,
    ...
    },
    {
      ...
      altAnswers: ["Él esperaba que pudiéramos terminar a tiempo."],
    ...
    },
    {
      ...
      altAnswers: ["I didn't believe she said that.", "I didn't think she would say that."],
      explanation: "'No creía' (pasado) exige el imperfecto de subjuntivo 'dijera', de la raíz irregular 'dij-'."
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["El", "profesor", "sugirió", "que", "los", "estudiantes", "estudiaran", "más."],
    ...
    },
    {
      ...
      options: ["hablásemos", "habláramos", "hablaríamos", "hablábamos"],
      correctIndex: 0,
    ...
    },
    {
      ...
      altAnswers: ["I wanted you to be happy with your life.", "I wanted you to be happy."],
      explanation: "'Quería' (pasado) exige el imperfecto de subjuntivo 'fueras', de la raíz compartida entre 'ser' e 'ir'."
    }
  ],
},
{
  slug: "hypothetical-si-clauses-drill",
  level: "B2",
  number: 17,
  title: "Oraciones Condicionales Hipotéticas con Si: Práctica Extra",
  ...
  sections: [
    {
      ...
      examples: [
        ...
        { es: "Si fuera rico, compraría una casa.", en: "If I were rich, I would buy a house." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Si yo pudiera, te ayudaría.", en: "If I could, I would help you." },
        { es: "Si supieras la verdad, no dirías eso.", en: "If you knew the truth, you wouldn't say that." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Cuál es la forma correcta del imperfecto de subjuntivo de 'decir' para 'si tú...'?",
          options: ["dijeras", "decías", "dirías", "dijiste"],
          correctIndex: 0,
    ...
    },
    {
      ...
      examples: [
        { es: "Si tuviera el dinero, me lo compraría.", en: "If I had the money, I would buy it." },
        { es: "Si supiera cocinar, haría la cena esta noche.", en: "If I knew how to cook, I would make dinner tonight." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Si llueve, no saldremos. (Tipo 1 – real)", en: "If it rains, we won't go out." },
        { es: "Si lloviera, no saldríamos. (Tipo 2 – hipotético)", en: "If it rained, we wouldn't go out." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Qué oración expresa una condición hipotética y poco probable, en lugar de una condición real?",
          options: ["Si tengo dinero, te lo presto.", "Si tuviera dinero, te lo prestaría."],
          correctIndex: 1,
    ...
    },
    {
      ...
      examples: [
        { es: "Si estudiara más, aprobaría el examen. (Tipo 2)", en: "If I studied more, I would pass the exam." },
        { es: "Si hubiera estudiado más, habría aprobado el examen. (Tipo 3)", en: "If I had studied more, I would have passed the exam." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Yo que tú, hablaría con ella.", en: "If I were you, I would talk to her." },
        { es: "Yo en tu lugar, no aceptaría esa oferta.", en: "In your place, I wouldn't accept that offer." }
      ],
      checkpoint: [
        {
          type: "translate",
          ...
          altAnswers: ["In your place, I would look for another job.", "If I were in your shoes, I would look for another job."],
    ...
    },
    {
      ...
      examples: [
        { es: "Viajaría más si tuviera más tiempo.", en: "I would travel more if I had more time." },
        { es: "No compraría esa casa si fuera tan cara.", en: "I wouldn't buy that house if it were so expensive." }
      ],
      checkpoint: [
        {
          type: "word-order",
          prompt: "Ordena las palabras para formar una oración condicional correcta.",
          words: ["Viajaría", "más", "si", "tuviera", "más", "tiempo"],
    ...
    },
    {
      ...
      examples: [
        { es: "Si tuviéramos coche, no tomaríamos el autobús.", en: "If we had a car, we wouldn't take the bus." },
        { es: "Si fueran más responsables, les daría más libertad.", en: "If they were more responsible, I would give them more freedom." }
      ],
      checkpoint: [
        {
          type: "multi-select",
  ...
  exercises: [
    ...
    },
    {
      ...
      options: ["pondría", "ponía", "pusiera", "pone"],
      correctIndex: 0,
    ...
    },
    {
      ...
      altAnswers: ["Si yo supiera la respuesta, te la diría."],
    ...
    },
    {
      ...
      altAnswers: ["We would finish the project on time if we were more organized."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración condicional correcta.",
      words: ["Si", "fueras", "más", "paciente", "tendrías", "menos", "problemas"],
    ...
    },
    {
      ...
      options: ["Tipo 1 (real/posible)", "Tipo 2 (hipotético presente)", "Tipo 3 (hipotético pasado)"],
      correctIndex: 2,
    ...
    },
    {
      ...
      pairs: [
        { left: "Si llueve, llevaré paraguas.", right: "Tipo 1 (real/posible)" },
        { left: "Si lloviera, llevaría paraguas.", right: "Tipo 2 (hipotético presente)" },
        { left: "Si hubiera llovido, habría llevado paraguas.", right: "Tipo 3 (hipotético pasado)" },
        { left: "Yo que tú, llevaría paraguas.", right: "Consejo equivalente a 'si yo fuera tú'" }
      ],
    ...
    },
    {
      ...
      altAnswers: ["Yo en tu lugar, me disculparía.", "Si yo fuera tú, me disculparía."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración condicional correcta.",
      words: ["No", "comprarían", "esa", "casa", "si", "fuera", "tan", "cara"],
    ...
    },
    {
      ...
      options: ["tendrían", "tenían", "tuvieran", "tienen"],
      correctIndex: 0,
...
{
  slug: "conditional-perfect-pluperfect-subjunctive-drill",
  level: "B2",
  number: 18,
  title: "El Condicional Perfecto y el Pluscuamperfecto de Subjuntivo: Práctica Extra",
  ...
  sections: [
    {
      ...
      examples: [
        { es: "Si yo hubiera sabido la verdad...", en: "If I had known the truth..." },
        { es: "Si tú hubieses llegado antes...", en: "If you had arrived earlier..." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
        ...
        },
        {
          ...
          options: ["hubieran comido", "habían comido", "comieran", "comerían"],
          correctIndex: 0,
    ...
    },
    {
      ...
      examples: [
        { es: "Habría llamado, pero perdí tu número.", en: "I would have called, but I lost your number." },
        { es: "Ellos habrían venido si hubieran podido.", en: "They would have come if they had been able to." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Cuál de estas frases usa correctamente el condicional perfecto?",
          options: ["Yo habría ido a la fiesta.", "Yo hubiera ido a la fiesta.", "Yo iría a la fiesta.", "Yo he ido a la fiesta."],
          correctIndex: 0,
    ...
    },
    {
      ...
      examples: [
        ...
        { es: "Si hubieras llegado a tiempo, no te habrías perdido el inicio.", en: "If you had arrived on time, you wouldn't have missed the beginning." }
      ],
      checkpoint: [
        {
          type: "word-order",
    ...
    },
    {
      ...
      examples: [
        { es: "Si tuviera dinero, viajaría (tipo 2, presente).", en: "If I had money, I would travel (type 2, present)." },
        { es: "Si hubiera tenido dinero, habría viajado (tipo 3, pasado).", en: "If I had had money, I would have traveled (type 3, past)." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Qué tipo de condicional es esta oración: 'Si tuviera más dinero, compraría una casa'?",
          options: ["Tipo 1 (real)", "Tipo 2 (hipótesis presente)", "Tipo 3 (hipótesis pasada)", "No es condicional"],
          correctIndex: 1,
    ...
    },
    {
      ...
      examples: [
        { es: "Habríamos ganado el partido si hubiéramos entrenado más.", en: "We would have won the match if we had trained more." }
      ],
      checkpoint: [
        {
          type: "word-order",
          prompt: "Ordena las palabras para formar la oración con el orden invertido.",
          words: ["Habríamos", "ganado", "el", "partido", "si", "hubiéramos", "entrenado", "más."],
    ...
    },
    {
      ...
      examples: [
        { es: "¡Ojalá hubiera sabido la verdad antes!", en: "I wish I had known the truth sooner!" },
        { es: "Ojalá no hubieras dicho eso.", en: "I wish you hadn't said that." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
        ...
        },
        {
          ...
          altAnswers: ["Ojalá no hubieses dicho eso."],
    ...
    },
    {
      ...
      examples: [
        { es: "Si hubiéramos visto la señal, no habríamos roto la regla.", en: "If we had seen the sign, we wouldn't have broken the rule." }
      ],
      checkpoint: [
        {
          type: "multi-select",
          question: "Selecciona los participios irregulares.",
          options: ["hecho", "comido", "dicho", "hablado", "visto", "vivido"],
          correctIndexes: [0, 2, 4],
    ...
    },
    {
      ...
      examples: [
        { es: "Si ellos hubieran salido antes, no habrían perdido el vuelo.", en: "If they had left earlier, they wouldn't have missed the flight." }
      ],
      checkpoint: [
        {
          type: "matching",
          ...
          pairs: [
            { left: "Si hubiera tenido tiempo,", right: "habría terminado el proyecto." },
            { left: "Si hubieras llamado,", right: "te habría explicado todo." },
            { left: "Si ellos hubieran estudiado,", right: "habrían aprobado el examen." },
            { left: "Si nosotros hubiéramos sabido la verdad,", right: "no habríamos actuado así." },
            { left: "Si yo hubiera visto la señal,", right: "no habría chocado." }
          ],
        ...
        },
        {
          ...
          altAnswers: ["Si hubiesen salido antes, no habrían perdido el vuelo."],
  ...
  exercises: [
    {
      ...
      options: ["hubiera sabido", "habría sabido", "supiera", "sabría"],
      correctIndex: 0,
    ...
    },
    {
      ...
      altAnswers: ["Si me lo hubieses dicho, te habría ayudado."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración condicional de tipo 3.",
      words: ["Si", "hubiera", "tenido", "tiempo,", "habría", "terminado", "el", "proyecto."],
    ...
    },
    {
      ...
      options: ["hubiera habido", "había habido", "habría habido", "hay"],
      correctIndex: 0,
    ...
    },
    {
      ...
      pairs: [
        { left: "Si hubiera llamado antes,", right: "habría reservado la mesa." },
        { left: "Si hubieras leído las instrucciones,", right: "no habrías cometido ese error." },
        { left: "Si ellas hubieran salido temprano,", right: "habrían llegado a la reunión." },
        { left: "Si él hubiera ahorrado dinero,", right: "se habría comprado el coche." },
        { left: "Si tú hubieras practicado más,", right: "habrías ganado la competencia." }
      ],
    ...
    },
    {
      ...
      altAnswers: ["Ojalá hubiese estudiado más para el examen."],
    ...
    },
    {
      ...
      words: ["Habría", "venido", "a", "la", "fiesta", "si", "me", "hubieras", "invitado."],
    ...
    },
    {
      ...
      options: ["viajaría", "habría viajado", "hubiera viajado", "viajara"],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ["Si", "Ojalá", "Cuando", "Aunque"],
      correctIndex: 0,
...
{
  slug: "reported-speech-drill",
  level: "B2",
  number: 19,
  title: "El Estilo Indirecto: Práctica Extra",
  ...
  sections: [
    {
      ...
      body: ["Recuerda que el verbo en presente de indicativo retrocede a imperfecto cuando el verbo introductor está en pasado."],
      examples: [
        { es: "Ana dijo: 'Estoy cansada.' → Ana dijo que estaba cansada.", en: "Ana said: 'I'm tired.' → Ana said she was tired." },
    ...
    },
    {
      ...
      body: ["Recuerda que las acciones pasadas retroceden un paso más y se convierten en pluscuamperfecto."],
      examples: [
        { es: "Luis dijo: 'Comí en casa.' → Luis dijo que había comido en casa.", en: "Luis said: 'I ate at home.' → Luis said he had eaten at home." },
      ...
      checkpoint: [
        {
          ...
          options: ["Sofía dijo que ya salía de la oficina.", "Sofía dijo que ya había salido de la oficina.", "Sofía dijo que ya saldría de la oficina.", "Sofía dijo que ya sale de la oficina."],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Recuerda que el futuro simple retrocede a condicional simple en el estilo indirecto pasado."],
      examples: [
        { es: "Diego dijo: 'Llegaré mañana.' → Diego dijo que llegaría al día siguiente.", en: "Diego said: 'I will arrive tomorrow.' → Diego said he would arrive the next day." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      body: ["Recuerda que el subjuntivo también retrocede: el presente de subjuntivo pasa a imperfecto de subjuntivo."],
      examples: [
        { es: "Rosa dijo: 'Espero que vengas.' → Rosa dijo que esperaba que vinieras.", en: "Rosa said: 'I hope you come.' → Rosa said she hoped I would come." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "Elige la transformación correcta: El profesor dijo: 'Dudo que aprueben el examen.'",
          options: ["El profesor dijo que duda que aprueben el examen.", "El profesor dijo que dudaba que aprobaran el examen.", "El profesor dijo que dudó que aprueben el examen.", "El profesor dijo que dudaría que aprobaron el examen."],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Recuerda que las preguntas de sí/no se introducen con 'si' y pierden los signos de interrogación."],
      examples: [
        { es: "'¿Vienes a la fiesta?' → Me preguntó si iba a la fiesta.", en: "'Are you coming to the party?' → He asked me if I was coming to the party." }
      ],
      checkpoint: [
        {
          type: "translate",
          ...
          altAnswers: ["My mom asked me whether I had called the doctor."],
    ...
    },
    {
      ...
      body: ["Recuerda que las preguntas con palabra interrogativa conservan esa palabra pero sin signos de interrogación ni inversión enfática."],
      examples: [
      ...
      checkpoint: [
        {
          ...
          words: ["Me", "preguntó", "cuándo", "iba", "a", "volver"],
    ...
    },
    {
      ...
      body: ["Recuerda que los mandatos directos se transforman en 'que' + subjuntivo (presente o imperfecto según el contexto)."],
      examples: [
        { es: "'Cierra la puerta.' → Me dijo que cerrara la puerta.", en: "'Close the door.' → He told me to close the door." },
    ...
    },
    {
      ...
      body: ["Recuerda que los pronombres, posesivos y marcadores de tiempo y lugar también cambian según la perspectiva del narrador."],
      examples: [
        { es: "'Hoy es mi cumpleaños.' → Dijo que ese día era su cumpleaños.", en: "'Today is my birthday.' → She said that day was her birthday." },
      ...
      checkpoint: [
        {
          ...
          options: ["hoy → ese día", "mañana → al día siguiente", "aquí → allí", "ayer → mañana"],
  ...
  exercises: [
    {
      ...
      options: ["Laura dijo que estudia medicina.", "Laura dijo que estudiaba medicina.", "Laura dijo que había estudiado medicina.", "Laura dijo que estudiaría medicina."],
      correctIndex: 1,
    ...
    },
    {
      ...
      altAnswers: ["Él dijo que me llamaría al día siguiente."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar la oración en estilo indirecto.",
      words: ["Nos", "dijo", "que", "estaba", "muy", "contento"],
    ...
    },
    {
      ...
      options: ["Dijo que ha perdido las llaves.", "Dijo que perdió las llaves.", "Dijo que había perdido las llaves.", "Dijo que perdería las llaves."],
      correctIndex: 2,
    ...
    },
    {
      ...
      pairs: [
        { left: "'Iré a la reunión.'", right: "Dijo que iría a la reunión." },
        { left: "'¿Has comido?'", right: "Me preguntó si había comido." },
        { left: "'Llama a tu hermana.'", right: "Me dijo que llamara a mi hermana." },
        { left: "'Quiero que me ayudes.'", right: "Dijo que quería que le ayudara." }
      ],
    ...
    },
    {
      ...
      altAnswers: ["She asked me where I'd put the keys."],
    ...
    },
    {
      ...
      options: ["presente → imperfecto", "pretérito → pluscuamperfecto", "futuro → condicional", "imperfecto → presente"],
      correctIndexes: [0, 1, 2],
    ...
    },
    {
      ...
      options: ["Preguntó cuánto cuesta el billete.", "Preguntó cuánto costaba el billete.", "Preguntó si cuánto costaba el billete.", "Preguntó cuánto costaría el billete."],
      correctIndex: 1,
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar la oración en estilo indirecto.",
      words: ["El", "director", "nos", "dijo", "que", "termináramos", "el", "trabajo"],
    ...
    },
    {
      ...
      altAnswers: ["Me dijo que no me preocupase por eso."],
    ...
    },
    {
      ...
      options: ["Dijo que me vería al día siguiente allí.", "Dijo que me vería mañana aquí.", "Dijo que me veía al día siguiente aquí.", "Dijo que me vería ese día allí."],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ["mi → su", "yo → él/ella", "te → le", "nosotros → ellos/ellas (según contexto)"],
    ...
    },
    {
      ...
      altAnswers: ["The waiter told us to request the check at the cashier."],
...
{
  slug: "ser-estar-haber-nuanced-drill",
  level: "B2",
  number: 20,
  title: "Usos Matizados de Ser, Estar y Haber: Práctica Extra",
  ...
  sections: [
    {
      ...
      body: ["Recuerda que 'ser listo' significa ser inteligente y 'estar listo' significa estar preparado."],
      examples: [
        { es: "Mi hermano es muy listo; siempre saca buenas notas.", en: "My brother is very smart; he always gets good grades." },
        { es: "¿Estás listo para el examen?", en: "Are you ready for the exam?" }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "Selecciona la oración que significa que Ana es inteligente.",
          options: ["Ana está lista.", "Ana es lista.", "Ana hay lista.", "Ana está siendo lista."],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Con 'aburrido', 'ser' describe algo o alguien sin interés y 'estar' describe el estado de sentir aburrimiento."],
      examples: [
        { es: "Esta película es aburrida; nadie quiere verla.", en: "This movie is boring; nobody wants to watch it." },
        { es: "Los niños están aburridos porque llueve todo el día.", en: "The kids are bored because it's raining all day." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      body: ["Con adjetivos como 'rico', 'malo' y 'verde', 'ser' indica una cualidad permanente y 'estar' indica un estado temporal, un sabor o falta de madurez."],
      examples: [
        { es: "El chocolate está muy rico.", en: "The chocolate tastes really good." },
        { es: "Esa empresa es rica.", en: "That company is wealthy." },
        { es: "Mi abuela está mala desde ayer.", en: "My grandmother has been sick since yesterday." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Qué oración significa que la fruta todavía no ha madurado?",
          options: ["La fruta es verde.", "La fruta está verde.", "La fruta hay verde.", "La fruta es estar verde."],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Se usa 'estar' + gerundio para describir una acción que está ocurriendo en un momento determinado."],
      examples: [
        { es: "Los estudiantes están escribiendo un ensayo ahora mismo.", en: "The students are writing an essay right now." },
        { es: "Estábamos comiendo cuando llamaste.", en: "We were eating when you called." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      body: ["Se usa 'hay' para introducir algo no específico y 'estar' para ubicar algo que ya se conoce o se ha mencionado antes."],
      examples: [
      ...
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Cuál es la oración correcta?",
          options: ["Hay el libro en la mesa.", "Hay un libro en la mesa.", "Está un libro en la mesa.", "Es un libro en la mesa."],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Se usa 'ser' para indicar dónde tiene lugar un evento, no dónde está situado un objeto físico."],
      examples: [
        { es: "La fiesta es en mi casa.", en: "The party is at my house." },
        { es: "El concierto es en el estadio.", en: "The concert is at the stadium." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Cuál oración es correcta para indicar dónde ocurrirá la reunión?",
          options: ["La reunión está en la sala de conferencias.", "La reunión es en la sala de conferencias.", "La reunión hay en la sala de conferencias.", "La reunión son en la sala de conferencias."],
          correctIndex: 1,
    ...
    },
    {
      ...
      body: ["Se usa 'estar' para describir dónde se encuentra físicamente una persona, un animal o un objeto."],
      examples: [
        { es: "Mis llaves están en el cajón.", en: "My keys are in the drawer." },
        { es: "Mi hermana está en Madrid esta semana.", en: "My sister is in Madrid this week." }
      ],
      checkpoint: [
        {
          type: "translate",
          ...
          altAnswers: ["Mi celular está en el escritorio.", "Mi móvil está en el escritorio."],
    ...
    },
    {
      ...
      body: ["Contrasta ser, estar y haber según el contexto: identidad o eventos, estado o ubicación, o existencia general."],
      examples: [
        { es: "Hay una fiesta esta noche; la fiesta es en el club y está muy cerca de aquí.", en: "There's a party tonight; the party is at the club and it's very close to here." }
      ],
      checkpoint: [
        {
          type: "matching",
          instructions: "Empareja cada oración en español con su traducción correcta en inglés.",
          pairs: [
            { left: "Hay dos gatos en el jardín.", right: "There are two cats in the garden." },
            { left: "Los gatos están en el jardín.", right: "The cats are in the garden." },
            { left: "La boda es en la iglesia.", right: "The wedding is at the church." },
            { left: "Marta es lista y está lista para el viaje.", right: "Marta is smart and ready for the trip." }
          ],
  ...
  exercises: [
    {
      ...
      options: ["Ana está lista.", "Ana es lista.", "Ana hay lista.", "Ana es estar lista."],
      correctIndex: 1,
    ...
    },
    {
      ...
      altAnswers: ["La sopa está muy sabrosa."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["Los", "niños", "están", "jugando", "en", "el", "parque"],
    ...
    },
    {
      ...
      pairs: [
        { left: "Hay un libro en la mesa.", right: "There is a book on the table." },
        { left: "El libro está en la mesa.", right: "The book is on the table." },
        { left: "La fiesta es en mi casa.", right: "The party is at my house." },
        { left: "Mis llaves están en el cajón.", right: "My keys are in the drawer." }
      ],
    ...
    },
    {
      ...
      altAnswers: ["This year the party is at the beach."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["Hay", "muchas", "personas", "en", "el", "concierto"],
    ...
    },
    {
      ...
      options: ["Diego es verde en este trabajo.", "Diego está verde en este trabajo.", "Diego hay verde en este trabajo.", "Diego son verde en este trabajo."],
      correctIndex: 1,
    ...
    },
    {
      ...
      altAnswers: ["The apples are still unripe."],
    ...
    },
    {
      ...
      options: ["Mis amigos son estudiando en la biblioteca.", "Mis amigos hay estudiando en la biblioteca.", "Mis amigos están estudiando en la biblioteca.", "Mis amigos es estudiando en la biblioteca."],
      correctIndex: 2,
...
{
  slug: "verbs-of-change-drill",
  level: "B2",
  number: 21,
  title: "Los Verbos de Cambio: Práctica Extra",
  ...
  sections: [
    {
      ...
      examples: [
        { es: "Cuando vio la nota, se puso pálida.", en: "When she saw the grade, she turned pale." },
        { es: "Nos pusimos nerviosos antes del examen.", en: "We got nervous before the exam." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Después de la guerra, se volvió muy desconfiado.", en: "After the war, he became very distrustful." },
        { es: "El perro se volvió agresivo con el tiempo.", en: "The dog became aggressive over time." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
    ...
    },
    {
      ...
      examples: [
        { es: "Se hizo abogado después de seis años de estudio.", en: "He became a lawyer after six years of study." },
        { es: "Se hicieron budistas tras vivir en Asia.", en: "They became Buddhists after living in Asia." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Llegó a ser presidente de la empresa.", en: "He became president of the company." },
        { es: "Con mucho esfuerzo, llegó a ser una gran pianista.", en: "With a lot of effort, she became a great pianist." }
      ],
      checkpoint: [
        {
          type: "translate",
          ...
          altAnswers: ["Con el paso de los años, llegó a ser una científica muy respetada."],
    ...
    },
    {
      ...
      examples: [
        { es: "Se quedó ciego tras el accidente.", en: "He was left blind after the accident." },
        { es: "Nos quedamos sorprendidos con la noticia.", en: "We were left surprised by the news." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
          question: "¿Qué verbo completa mejor la oración: 'Después del choque, Pedro ___ paralizado'?",
          options: ["se puso", "se volvió", "se hizo", "se quedó"],
          correctIndex: 3,
    ...
    },
    {
      ...
      examples: [
        { es: "Se puso rojo de vergüenza (un momento).", en: "He turned red with embarrassment (a moment)." },
        { es: "Se volvió muy tímido después de la mudanza (un cambio más duradero).", en: "He became very shy after the move (a lasting change)." }
      ],
      checkpoint: [
        {
          type: "multi-select",
    ...
    },
    {
      ...
      examples: [
        { es: "Se hizo médico a los treinta años.", en: "He became a doctor at thirty." },
        { es: "Llegó a ser el mejor médico del hospital.", en: "He became the best doctor in the hospital." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Se puso triste, luego se volvió amargado, y finalmente se quedó solo.", en: "He got sad, then became bitter, and finally ended up alone." }
      ],
      checkpoint: [
        {
          type: "matching",
          ...
          pairs: [
            { left: "Se ___ médico tras años de esfuerzo.", right: "hacerse" },
            { left: "Se ___ pálido al ver el fantasma.", right: "ponerse" },
            { left: "Se ___ loco de tanto trabajar sin descanso.", right: "volverse" },
            { left: "Se ___ presidente después de una larga carrera política.", right: "llegar a ser" },
            { left: "Se ___ dormido durante la reunión.", right: "quedarse" }
          ],
  ...
  exercises: [
    {
      ...
      options: ["ponerse", "volverse", "llegar a ser", "quedarse"],
      correctIndex: 2,
    ...
    },
    {
      ...
      altAnswers: ["He ended up asleep during the movie."],
    ...
    },
    {
      ...
      pairs: [
        { left: "Se puso furioso con la respuesta.", right: "He got furious with the answer." },
        { left: "Se volvió muy desconfiado con los años.", right: "He became very distrustful over the years." },
        { left: "Se hizo rico vendiendo casas.", right: "He became rich selling houses." },
        { left: "Llegó a ser una figura muy respetada.", right: "He became a highly respected figure." },
        { left: "Se quedó ciego tras el accidente.", right: "He was left blind after the accident." }
      ],
    ...
    },
    {
      ...
      options: ["ponerse", "hacerse", "llegar a ser", "quedarse", "volverse"],
      correctIndexes: [1, 2],
    ...
    },
    {
      ...
      options: ["se puso", "se hizo", "llegó a ser", "se quedó"],
      correctIndex: 3,
    ...
    },
    {
      ...
      pairs: [
        { left: "ponerse", right: "cambio emocional o físico temporal" },
        { left: "volverse", right: "cambio brusco e involuntario, más duradero" },
        { left: "hacerse", right: "cambio logrado con esfuerzo, a menudo profesión o religión" },
        { left: "llegar a ser", right: "cambio gradual y positivo a largo plazo" },
        { left: "quedarse", right: "estado resultante de un evento" }
      ],
    ...
    },
    {
      ...
      altAnswers: ["Se volvió loco tras perder su trabajo."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración correcta.",
      words: ["con", "los", "años", "llegó", "a", "ser", "una", "científica", "reconocida"],
...
{
  slug: "advanced-connectors-emphasis-drill",
  level: "B2",
  number: 22,
  title: "Conectores Avanzados y Estructuras de Énfasis: Práctica Extra",
  ...
  sections: [
    {
      ...
      examples: [
        { es: "El proyecto era arriesgado; sin embargo, decidieron continuar.", en: "The project was risky; however, they decided to continue." },
        { es: "No obstante las dificultades, el equipo logró terminar a tiempo.", en: "Despite the difficulties, the team managed to finish on time." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
    ...
    },
    {
      ...
      examples: [
        { es: "Aunque llovía mucho, salimos a caminar.", en: "Although it was raining a lot, we went out for a walk." },
        { es: "A él le encanta madrugar; en cambio, a mí me cuesta levantarme temprano.", en: "He loves getting up early; I, on the other hand, find it hard to get up early." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
    ...
    },
    {
      ...
      examples: [
        { es: "Puesto que no había entradas, decidimos ver la película en casa.", en: "Since there were no tickets, we decided to watch the movie at home." },
        { es: "No hace falta que lo expliques, ya que todos lo sabemos.", en: "You don't need to explain it, since we all know it already." }
      ],
      checkpoint: [
        {
          type: "multiple-choice",
    ...
    },
    {
      ...
      examples: [
        { es: "No estudió nada; por lo tanto, suspendió el examen.", en: "He didn't study at all; therefore, he failed the exam." },
        { es: "Llegamos tarde, así que perdimos el tren.", en: "We arrived late, so we missed the train." }
      ],
      checkpoint: [
        {
          type: "fill-blank",
        ...
        },
        {
          ...
          options: ["por lo tanto", "de modo que", "así que", "por consiguiente"],
          correctIndex: 2,
    ...
    },
    {
      ...
      examples: [
        { es: "El hotel es barato; además, está muy bien situado.", en: "The hotel is cheap; besides, it's very well located." },
        { es: "Nadie lo esperaba; es más, ni siquiera él mismo lo creía posible.", en: "No one expected it; in fact, not even he thought it was possible." }
      ],
      checkpoint: [
        {
          type: "matching",
          ...
          pairs: [
            { left: "además", right: "añade información complementaria" },
            { left: "es más", right: "refuerza la idea anterior con algo más fuerte" },
            { left: "incluso", right: "destaca un caso extremo dentro de una lista" }
          ],
    ...
    },
    {
      ...
      examples: [
        { es: "Lo que más me gusta de este barrio es que todo queda cerca.", en: "What I like most about this neighborhood is that everything is nearby." },
        { es: "Lo que pasó fue que perdimos el vuelo por el tráfico.", en: "What happened was that we missed the flight because of traffic." }
      ],
      checkpoint: [
        {
          type: "word-order",
          prompt: "Ordena las palabras para formar una oración enfática correcta.",
          words: ["lo", "que", "más", "me", "molesta", "es", "que", "llegue", "tarde"],
    ...
    },
    {
      ...
      examples: [
        { es: "Fue entonces cuando comprendí que había cometido un error.", en: "It was then that I realized I had made a mistake." },
        { es: "Es por eso que decidí cambiar de trabajo.", en: "That's why I decided to change jobs." }
      ],
      checkpoint: [
        {
          type: "translate",
          ...
          altAnswers: ["Fue ahí donde nos conocimos por primera vez."],
    ...
    },
    {
      ...
      examples: [
        { es: "En un informe se prefiere 'no obstante' y 'por lo tanto'; entre amigos, 'pero' y 'así que'.", en: "In a report, 'no obstante' and 'por lo tanto' are preferred; among friends, 'pero' and 'así que'." }
      ],
      checkpoint: [
        {
          type: "multi-select",
          question: "¿Cuáles de estos conectores son apropiados para un texto académico formal?",
          options: ["no obstante", "así que", "por consiguiente", "pero", "puesto que"],
          correctIndexes: [0, 2, 4],
  ...
  exercises: [
    {
      ...
      options: ["así que", "no obstante", "además", "puesto que"],
      correctIndex: 1,
    ...
    },
    {
      ...
      altAnswers: ["Puesto que llovía, nos quedamos en casa."],
    ...
    },
    {
      ...
      words: ["lo", "que", "más", "me", "sorprendió", "fue", "que", "no", "dijo", "nada"],
    ...
    },
    {
      ...
      pairs: [
        { left: "sin embargo", right: "contraste" },
        { left: "puesto que", right: "causa" },
        { left: "por lo tanto", right: "consecuencia" },
        { left: "incluso", right: "adición" }
      ],
    ...
    },
    {
      ...
      options: ["ya que", "así que", "puesto que", "en cambio", "de modo que"],
      correctIndexes: [0, 2],
    ...
    },
    {
      ...
      altAnswers: ["That was when I realized I had made a mistake."],
    ...
    },
    {
      type: "word-order",
      prompt: "Ordena las palabras para formar una oración enfática.",
      words: ["fue", "entonces", "cuando", "decidimos", "mudarnos", "de", "ciudad"],
    ...
    },
    {
      ...
      altAnswers: ["Lo que más me gusta de este empleo es que puedo trabajar desde casa."],
    ...
    },
    {
      ...
      options: ["Lo que más me gusta es que...", "Fue entonces cuando...", "sin embargo", "Es por eso que...", "además"],
    ...
    },
    {
      ...
      altAnswers: ["As we did not reach an agreement, the meeting was postponed to next week."],
      explanation: "'Puesto que' equivale a 'since' o 'as' cuando introducen una causa ya conocida o evidente para el oyente."
    }
  ],
},
  {
    "slug": "b2-vocabulary-practice-part-1",
    "level": "B2",
    "number": 23,
    "title": "B2 Vocabulary Practice (Part 1 of 2)",
  ...
  {
    "slug": "b2-vocabulary-practice-part-2",
    "level": "B2",
    "number": 24,
    "title": "B2 Vocabulary Practice (Part 2 of 2)",
    "summary": "Pon a prueba las 500 palabras del vocabulario de B2, organizadas por lección.",
    "duration": "38 min",
    "sections": [
      {
    ...
    exercises: [
      {
        ...
        options: ["She was a customer", "She had worked there for ten years helping in the kitchen", "She was a food critic", "She inherited it after her father's death"],
        correctIndex: 1,
        explanation:
          "\"Marta llevaba diez años ayudando en la cocina de Casa Oliveira\" — Marta had spent ten years helping in the kitchen.",
      },
      {
        type: "multiple-choice",
        question: "What inspired Marta's new restaurant concept?",
        options: ["A cooking show she watched", "A dish she tried in Lisbon mixing Moroccan spices with Atlantic fish", "A recipe from her grandmother", "A trip to Morocco"],
        correctIndex: 1,
        explanation:
          "\"probó, en un pequeño local de Lisboa, un plato que mezclaba especias marroquíes con pescado del Atlántico\".",
      },
      {
        type: "multiple-choice",
        question: "How did Marta's father initially react to her plan?",
        options: ["He enthusiastically supported her", "He offered to invest money", "He felt she was rejecting the family's legacy", "He immediately disowned her"],
        correctIndex: 2,
        explanation:
          "\"Si cambias las recetas de la familia... estás diciendo que lo que hemos construido no vale nada.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened when Marta's father visited on opening night?",
        options: ["He refused to eat anything", "He tasted a dish and admitted it reminded him of something he had forgotten", "He left angrily", "He gave a public speech praising her"],
        correctIndex: 1,
        explanation:
          "\"Esto sabe a algo que yo conocía... pero que había olvidado que conocía.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A city council member", "An architect known for glass-and-steel buildings", "A theater actor", "A history teacher"],
        correctIndex: 1,
        explanation:
          "\"Diego había diseñado edificios de cristal y acero durante quince años.\"",
      },
      {
        type: "multiple-choice",
        question: "What personal connection did Diego have to the Teatro Esperanza?",
        options: ["He had performed there as a child", "He had gone there with his grandmother to see puppet shows", "He designed it himself", "His parents got married there"],
        correctIndex: 1,
        explanation:
          "\"Diego había ido allí de niño, de la mano de su abuela, a ver funciones de títeres.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Diego discover about the theater's original architect?",
        options: ["She was famous and celebrated in her time", "She had to sign her plans with her husband's name because authorities rejected plans by women", "She never actually built the theater", "She was Diego's ancestor"],
        correctIndex: 1,
        explanation:
          "\"tuvo que firmar sus proyectos con el nombre de su marido porque las autoridades no aceptaban planos firmados por una mujer.\"",
      },
      {
        type: "multiple-choice",
        question: "What was the outcome of the council's vote?",
        options: ["The theater was demolished as planned", "The restoration proposal was approved by a narrow margin", "Diego was fired before the vote", "The vote was cancelled"],
        correctIndex: 1,
        explanation:
          "\"el concejo aprobó, por un estrecho margen, la propuesta de restauración.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A novelist", "A literary translator", "A librarian", "A journalist"],
        correctIndex: 1,
        explanation:
          "\"Elena se ganaba la vida traduciendo novelas del inglés al español.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Elena find in the attic?",
        options: ["Letters from Bravo's readers", "An unpublished, nearly finished novel in Bravo's handwriting", "A diary belonging to Bravo's wife", "Photographs from Bravo's youth"],
        correctIndex: 1,
        explanation:
          "\"Se trataba de una novela inédita, casi terminada... reconoció de inmediato la letra pequeña y apretada de Bravo.\"",
      },
      {
        type: "multiple-choice",
        question: "Why had Bravo asked that the manuscript never be published?",
        options: ["He thought it was poorly written", "He felt he had already said too much and the world wasn't ready for his true thoughts", "He wanted to rewrite it first", "He was embarrassed about grammatical errors"],
        correctIndex: 1,
        explanation:
          "\"Decía que ya había dicho demasiado en esas páginas... y que el mundo no estaba preparado para leer lo que de verdad pensaba.\"",
      },
      {
        type: "multiple-choice",
        question: "What compromise did Elena propose?",
        options: ["To publish the novel immediately as a bestseller", "To destroy the manuscript entirely", "To keep it in the archive for academic researchers only, without commercial publication", "To sell it to the highest bidder"],
        correctIndex: 2,
        explanation:
          "\"la fundación conservaría el manuscrito en su archivo, accesible únicamente para investigadores académicos, sin publicarlo comercialmente.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Two years", "Twelve years", "Twenty years", "Six months"],
        correctIndex: 1,
        explanation:
          "\"era, desde hacía doce años, la única médica de Piedrablanca.\"",
      },
      {
        type: "multiple-choice",
        question: "What personal dilemma complicated Rosa's handling of the outbreak?",
        options: ["She had a job offer from a private hospital in the capital", "She was pregnant", "She wanted to become mayor", "She had lost her medical license"],
        correctIndex: 0,
        explanation:
          "\"esa misma semana Rosa había recibido una oferta de trabajo de un hospital privado en la capital.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened to Rosa's father during the outbreak?",
        options: ["He was evacuated to the city", "He developed a fever but recovered by the third day", "He died from the illness", "He refused treatment"],
        correctIndex: 1,
        explanation:
          "\"la fiebre de Ernesto cedió al tercer día.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Rosa decide at the end of the story?",
        options: ["To accept the city job", "To reject the city job's offer and stay in the village", "To retire from medicine", "To move her father to the city"],
        correctIndex: 1,
        explanation:
          "\"llamó al hospital de la capital para rechazar la oferta.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A wedding", "Their mother's death and the need to empty her house", "A birthday party", "Their father's retirement"],
        correctIndex: 1,
        explanation:
          "\"Cuando murió su madre, Clara, Andrés y Beatriz se encontraron... reunidos... para vaciar antes de ponerla en venta.\"",
      },
      {
        type: "multiple-choice",
        question: "What did the siblings first argue about?",
        options: ["Who would get the house", "What to do with their mother's old piano", "Who paid for the funeral", "Selling the car"],
        correctIndex: 1,
        explanation:
          "\"La primera discusión estalló por ese mismo piano.\"",
      },
      {
        type: "multiple-choice",
        question: "What did the siblings find in a locked metal box?",
        options: ["Money and jewelry", "Old love letters from a man named Tomás written before their mother met their father", "Their mother's diary about them", "Legal documents about the house"],
        correctIndex: 1,
        explanation:
          "\"descubrieron un paquete de cartas escritas por un hombre llamado Tomás, fechadas décadas antes de que su madre conociera a su padre.\"",
      },
      {
        type: "multiple-choice",
        question: "Who ended up keeping the piano?",
        options: ["Beatriz", "Andrés", "Clara", "They sold it"],
        correctIndex: 2,
        explanation:
          "\"Clara, como había propuesto desde el principio, con el piano desafinado.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["An anonymous tip sent to the newspaper", "Overhearing a neighbor complain about rising water bills at the supermarket", "A press conference by the mayor", "A leaked document mailed to her home"],
        correctIndex: 1,
        explanation:
          "\"Una vecina se quejaba... de que la factura del agua había subido de nuevo.\"",
      },
      {
        type: "multiple-choice",
        question: "What conflict of interest did Valeria discover?",
        options: ["The mayor's brother was a minority shareholder in a company subcontracted by Aguavista", "The mayor owned Aguavista outright", "Valeria's editor was bribed", "The water company was foreign-owned"],
        correctIndex: 0,
        explanation:
          "\"el hermano del alcalde figuraba como accionista minoritario de una empresa subcontratada por Aguavista.\"",
      },
      {
        type: "multiple-choice",
        question: "Why was Valeria's director initially hesitant to publish the story?",
        options: ["He didn't believe the evidence", "The newspaper depended heavily on institutional advertising from the town hall", "He was friends with the mayor", "He thought it wasn't newsworthy"],
        correctIndex: 1,
        explanation:
          "\"el periódico dependía en gran parte de la publicidad institucional del ayuntamiento.\"",
      },
      {
        type: "multiple-choice",
        question: "What was the ultimate result of the article's publication?",
        options: ["Nothing happened", "The regional prosecutor's office opened an official investigation into the contract", "Valeria was fired", "The mayor resigned immediately"],
        correctIndex: 1,
        explanation:
          "\"la fiscalía regional abrió una investigación oficial sobre el contrato con Aguavista.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A teaching job and a recording contract", "A fixed position in the National Symphony Orchestra and a chance to record a solo album with an independent label", "Two orchestra positions in different cities", "A film score job and a wedding band job"],
        correctIndex: 1,
        explanation:
          "\"la Orquesta Sinfónica Nacional le ofrecía un puesto fijo... un pequeño sello discográfico independiente le proponía grabar un álbum propio.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Iván's old composition professor tell him?",
        options: ["To always choose stability", "To ask himself which choice he'd regret more in thirty years", "To quit music altogether", "To take both offers simultaneously"],
        correctIndex: 1,
        explanation:
          "\"pregúntate qué recordarás con más pesar dentro de treinta años: el riesgo que tomaste o el que dejaste pasar.\"",
      },
      {
        type: "multiple-choice",
        question: "How did the orchestra's director respond to Iván's request for a six-month delay?",
        options: ["He refused and withdrew the offer", "He granted it, admitting he had done something similar when young", "He fired Iván on the spot", "He reported Iván to the union"],
        correctIndex: 1,
        explanation:
          "\"el director de la orquesta... le confesó que él mismo, de joven, había hecho algo parecido.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Iván ultimately decide?",
        options: ["He accepted the orchestra position", "He declined the orchestra offer to continue his solo career", "He gave up music entirely", "He joined a different orchestra"],
        correctIndex: 1,
        explanation:
          "\"decidió declinar finalmente la oferta de la orquesta.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Fifteen", "Twenty", "Thirty-eight", "Fifty"],
        correctIndex: 2,
        explanation:
          "\"Amparo llevaba treinta y ocho años enseñando literatura.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Amparo discover in Rubén's notebook?",
        options: ["A failing test", "A short poem revealing hidden sadness about feeling invisible at home", "A note insulting her", "A drawing of the school"],
        correctIndex: 1,
        explanation:
          "\"encontró entre las páginas de Rubén un poema breve... hablaban... de la sensación de sentirse invisible en la propia casa.\"",
      },
      {
        type: "multiple-choice",
        question: "How did the new director initially react to Amparo's creative writing project?",
        options: ["He enthusiastically endorsed it immediately", "He was skeptical because it didn't fit his digital curriculum", "He banned it outright", "He asked to co-teach it"],
        correctIndex: 1,
        explanation:
          "\"El director, al enterarse, se mostró escéptico al principio, pues aquel proyecto no encajaba con el currículo digital.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened on Amparo's last day of class?",
        options: ["Nothing special happened", "Students read aloud pieces they had written during the course, including Rubén's", "She was fired", "The director cancelled her retirement"],
        correctIndex: 1,
        explanation:
          "\"cada uno leyó en voz alta un breve fragmento escrito durante el curso.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Grapes", "Wheat", "Rice", "Corn"],
        correctIndex: 1,
        explanation:
          "\"sembrar trigo en otoño, cosecharlo en verano.\"",
      },
      {
        type: "multiple-choice",
        question: "What alternative did the agronomist suggest?",
        options: ["Abandoning farming entirely", "Replacing part of the wheat with almond trees and drip irrigation powered by solar panels", "Moving to a different region", "Growing only wheat but at night"],
        correctIndex: 1,
        explanation:
          "\"sustituir parte del cultivo de trigo por almendros... instalar un sistema de riego por goteo alimentado con paneles solares.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened during the first year of the almond experiment?",
        options: ["Both crops failed", "The wheat failed in a severe drought while the young almond trees survived thanks to drip irrigation", "The almonds failed and the wheat thrived", "A flood destroyed everything"],
        correctIndex: 1,
        explanation:
          "\"El trigo sembrado en la parte tradicional de la finca se perdió casi por completo, mientras que los almendros jóvenes... resistieron.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Fermín eventually conclude?",
        options: ["That farming should be abandoned", "That perhaps loving the land didn't mean refusing to let it change", "That his son was wrong to experiment", "That they should sell the farm"],
        correctIndex: 1,
        explanation:
          "\"Quizás me equivoqué al pensar que amar esta tierra significaba negarme a que cambiara.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["100", "234", "365", "50"],
        correctIndex: 1,
        explanation:
          "\"Lucía había pasado doscientos treinta y cuatro días a bordo de la estación espacial.\"",
      },
      {
        type: "multiple-choice",
        question: "What physical difficulty did Lucía experience after landing?",
        options: ["She couldn't see properly", "She had trouble walking straight and holding a glass of water without spilling it", "She lost her sense of smell", "She couldn't speak"],
        correctIndex: 1,
        explanation:
          "\"Le costaba caminar en línea recta, y la simple tarea de sostener un vaso de agua sin derramarlo requería una concentración.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Valentina say that hurt Lucía?",
        options: ["\"I don't love you anymore\"", "\"Papá me lo explica mejor\" (Dad explains it better)", "\"Go back to space\"", "\"You're not my mother\""],
        correctIndex: 1,
        explanation:
          "\"Papá me lo explica mejor.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Lucía do when offered a new, longer space mission?",
        options: ["She accepted immediately", "She asked for time to think it over, weighing her family's rebuilt balance", "She refused outright without thinking", "She asked Martín to decide for her"],
        correctIndex: 1,
        explanation:
          "\"ella pidió tiempo para pensarlo... no estaba dispuesta a arriesgar sin medirlo cuidadosamente.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A broken leg", "A shoulder injury requiring surgery and 8-10 months recovery", "A concussion", "A wrist sprain"],
        correctIndex: 1,
        explanation:
          "\"una lesión que requeriría cirugía y... entre ocho y diez meses de recuperación completa.\"",
      },
      {
        type: "multiple-choice",
        question: "What did coach Óscar tell Nadia to keep her from quitting?",
        options: ["\"Injuries heal, but regret for not trying never heals\"", "\"You were never good enough anyway\"", "\"Take as long as you need, there's no rush\"", "\"Find a new sport\""],
        correctIndex: 0,
        explanation:
          "\"Las lesiones se curan... pero el arrepentimiento de no haberlo intentado no se cura nunca.\"",
      },
      {
        type: "multiple-choice",
        question: "What psychological obstacle did Nadia face during recovery?",
        options: ["Fear of water", "An instinctive fear of repeating the exact movement that caused her injury", "Fear of her coach", "Loss of interest in rowing"],
        correctIndex: 1,
        explanation:
          "\"su técnica... se veía entorpecida por el miedo instintivo a repetir el movimiento que había causado la lesión.\"",
      },
      {
        type: "multiple-choice",
        question: "What was the result of the qualifying regatta?",
        options: ["She won first place easily", "She finished second, enough to secure her spot on the national team", "She failed to qualify", "She withdrew from the race"],
        correctIndex: 1,
        explanation:
          "\"Terminó la regata en segunda posición, un resultado suficiente para asegurar su plaza en el equipo nacional.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She bought it", "Her grandfather Vicente died suddenly and left it to her", "She won it in a contest", "Her parents gave it to her as a gift"],
        correctIndex: 1,
        explanation:
          "\"Camila heredó la Bodega Del Valle a los veintiocho años, tras la muerte repentina de su abuelo Vicente.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Camila's brother Tomás want to do?",
        options: ["Sell the vineyard to an international corporation", "Convert to organic farming", "Move to the city together", "Close the bodega permanently"],
        correctIndex: 0,
        explanation:
          "\"insistía en que la solución más razonable era vender la bodega a una corporación internacional.\"",
      },
      {
        type: "multiple-choice",
        question: "What alternative strategy did Camila pursue instead?",
        options: ["Taking out a personal loan from friends", "Organic farming certification and direct online sales", "Selling to a different corporation", "Turning the vineyard into a hotel"],
        correctIndex: 1,
        explanation:
          "\"la producción orgánica y la venta directa como estrategias centrales para la recuperación financiera.\"",
      },
      {
        type: "multiple-choice",
        question: "What was Tomás's reaction when he finally visited the vineyard two years later?",
        options: ["He was still angry and demanded she sell", "He admitted he had underestimated her determination and vision", "He tried to take over the bodega", "He refused to drink the wine"],
        correctIndex: 1,
        explanation:
          "\"admitió... que se había equivocado al subestimar tanto su determinación como su visión.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To buy textiles for a shop", "To photograph the last practitioners of a disappearing weaving tradition", "To study the local dialect", "To build a school"],
        correctIndex: 1,
        explanation:
          "\"con una beca de fotografía documental y el propósito concreto de retratar a los últimos tejedores.\"",
      },
      {
        type: "multiple-choice",
        question: "Why had none of doña Herminia's children learned to weave?",
        options: ["They were physically unable", "They considered it unprofitable compared to city jobs", "Doña Herminia refused to teach them", "They moved away as babies"],
        correctIndex: 1,
        explanation:
          "\"considerándolo poco rentable comparado con los trabajos disponibles en la ciudad.\"",
      },
      {
        type: "multiple-choice",
        question: "What did doña Herminia give Sara before she left the village?",
        options: ["Money", "A backstrap loom, so Sara could keep practicing", "A photograph album", "Her house"],
        correctIndex: 1,
        explanation:
          "\"un telar de cintura que doña Herminia le había regalado, insistiendo en que siguiera practicando.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened at Sara's exhibition in the capital?",
        options: ["Nobody attended", "Doña Herminia gave a live weaving demonstration and young visitors asked her to teach workshops", "The photographs were stolen", "Doña Herminia refused to attend"],
        correctIndex: 1,
        explanation:
          "\"invitó a doña Herminia a viajar a la ciudad... para preguntarle si estaría dispuesta a dar talleres.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["For her father's job promotion", "An economic crisis that left her father unemployed", "To be near relatives", "For Paula's education"],
        correctIndex: 1,
        explanation:
          "\"huyendo de una crisis económica que había dejado a su padre sin trabajo.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Paula's grandmother's illness affect the story?",
        options: ["It had no real effect", "It prompted a long trip to Buenos Aires that reconnected Paula with Argentina", "It caused Paula to move permanently to Germany", "It was never resolved"],
        correctIndex: 1,
        explanation:
          "\"Paula viajó de urgencia para acompañar a su madre... aquel viaje... terminó por prolongarse durante casi tres meses.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Paula's grandmother tell her about identity?",
        options: ["\"You must choose one country and forget the other\"", "\"You don't have to choose a single place to be from\"", "\"Germany is better than Argentina\"", "\"Identity doesn't matter\""],
        correctIndex: 1,
        explanation:
          "\"No tienes que elegir un solo lugar para ser de allí.\"",
      },
      {
        type: "multiple-choice",
        question: "How did the relationship with Lukas end?",
        options: ["With bitter fighting", "Respectfully, both recognizing an incompatibility of life plans", "They got married instead", "Lukas moved to Argentina"],
        correctIndex: 1,
        explanation:
          "\"La ruptura, aunque dolorosa, resultó sorprendentemente respetuosa... una simple incompatibilidad de proyectos vitales.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Ten years", "Thirty-two years", "Five years", "Fifty years"],
        correctIndex: 1,
        explanation:
          "\"Don Alfredo llevaba treinta y dos años como farero del Cabo Negro.\"",
      },
      {
        type: "multiple-choice",
        question: "What project did Camila propose?",
        options: ["To sell the lighthouse", "To document her grandfather's last months there through photos and audio recordings", "To move the lighthouse", "To become the new automated system's operator"],
        correctIndex: 1,
        explanation:
          "\"propuso documentar los últimos meses de su abuelo en el faro a través de fotografías y grabaciones de audio.\"",
      },
      {
        type: "multiple-choice",
        question: "What made Alfredo's handwritten notebooks valuable?",
        options: ["They contained poetry", "They contained decades of detailed weather records of scientific value", "They were rare antiques", "They contained treasure maps"],
        correctIndex: 1,
        explanation:
          "\"contenían información valiosa que ningún registro oficial había recopilado con tanto detalle... digitalizar y estudiar aquellos datos únicos.\"",
      },
      {
        type: "multiple-choice",
        question: "What role did the maritime authority offer Alfredo after automation?",
        options: ["A desk job in the city", "Honorary advisor and occasional tour guide for lighthouse visitors", "Nothing, he was simply dismissed", "A promotion to regional director"],
        correctIndex: 1,
        explanation:
          "\"le ofreció... mantenerse como asesor honorífico y guía turístico ocasional.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She told her family voluntarily", "A fall that hospitalized her, during which her granddaughter found sketchbooks while retrieving belongings", "A newspaper article about her", "Her death"],
        correctIndex: 1,
        explanation:
          "\"Nieves sufrió una caída... Su nieta Lucía... encontró... una caja de madera cerrada que contenía decenas de cuadernos de dibujo.\"",
      },
      {
        type: "multiple-choice",
        question: "What had Nieves done in her youth?",
        options: ["Worked as a nurse", "Studied painting at a fine arts school and exhibited her work with some recognition", "Traveled the world", "Been a famous singer"],
        correctIndex: 1,
        explanation:
          "\"de joven había estudiado pintura en la escuela de bellas artes de la capital... había expuesto su obra con cierto reconocimiento.\"",
      },
      {
        type: "multiple-choice",
        question: "Why had Nieves stopped painting?",
        options: ["She lost interest", "Her husband's premature death forced her to dedicate herself entirely to raising her children", "She was banned from painting", "She lost her eyesight"],
        correctIndex: 1,
        explanation:
          "\"la muerte prematura de su marido la obligara a abandonar por completo la pintura para dedicarse enteramente a criar a sus hijos.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Nieves decide to do after the exhibition?",
        options: ["Never draw again", "Take up drawing again in her later years, out of love for it rather than seeking recognition", "Sell all her sketchbooks", "Move to a nursing home"],
        correctIndex: 1,
        explanation:
          "\"Decidió... retomar el dibujo en sus últimos años, no para buscar reconocimiento, sino simplemente porque... había vuelto a recordar cuánto lo amaba.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A fitness tracking app", "A mental wellbeing app offering meditation and a private digital journal", "A social media platform", "A dating app"],
        correctIndex: 1,
        explanation:
          "\"una aplicación de bienestar emocional que ofrecía ejercicios de meditación guiada y un diario digital privado.\"",
      },
      {
        type: "multiple-choice",
        question: "What condition did the investment fund require?",
        options: ["Diana had to step down as CEO", "Access to anonymized user data to sell to advertisers and insurers", "Moving the company headquarters", "Firing half the staff"],
        correctIndex: 1,
        explanation:
          "\"el fondo exigía acceso a los datos anonimizados de los usuarios... para venderlos a empresas de publicidad dirigida y aseguradoras.\"",
      },
      {
        type: "multiple-choice",
        question: "What alternative did a young developer propose?",
        options: ["Selling the company entirely", "Offering a voluntary premium subscription to fund the company without compromising data privacy", "Laying off all employees", "Taking out a bank loan"],
        correctIndex: 1,
        explanation:
          "\"ofreciéndoles una suscripción premium voluntaria... sin comprometerla comercialmente.\"",
      },
      {
        type: "multiple-choice",
        question: "How did users respond to the premium subscription campaign?",
        options: ["Almost nobody subscribed", "The response exceeded expectations, generating enough revenue to avoid the risky investment", "Users demanded refunds", "The campaign was cancelled"],
        correctIndex: 1,
        explanation:
          "\"La respuesta de los usuarios superó ampliamente las expectativas... generando ingresos suficientes para evitar... la necesidad de recurrir al fondo de inversión.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A fire", "The city hall's decision to sell the building housing it, with no plan to relocate the documents", "A flood", "Theft"],
        correctIndex: 1,
        explanation:
          "\"el ayuntamiento... había decidido vender el edificio que albergaba el archivo... el nuevo plan urbanístico no contemplaba destinar ningún espacio equivalente.\"",
      },
      {
        type: "multiple-choice",
        question: "What did the local university tell Ignacio?",
        options: ["They would take the entire archive immediately", "They lacked space and staff to take on the archive without additional funding", "They refused to even meet with him", "They demanded payment"],
        correctIndex: 1,
        explanation:
          "\"sin financiación adicional, la universidad tampoco disponía de espacio ni personal suficiente.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Ignacio mobilize public support?",
        options: ["He organized a protest march", "He posted striking photographs from the archive on social media", "He sued the city hall", "He went on a hunger strike"],
        correctIndex: 1,
        explanation:
          "\"publicando en las redes sociales algunas de las fotografías más impactantes del archivo.\"",
      },
      {
        type: "multiple-choice",
        question: "What did the cultural heritage foundation ultimately offer?",
        options: ["Nothing", "To fund complete digitization and relocate the documents to a climate-controlled storage facility", "To buy the documents and sell them", "To demolish the building faster"],
        correctIndex: 1,
        explanation:
          "\"ofreció finalmente financiar un proyecto de digitalización completa del archivo, además de gestionar el traslado físico.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A border dispute", "Sharing the waters of the Auroro River between two countries", "A trade tariff", "A military alliance"],
        correctIndex: 1,
        explanation:
          "\"el conflicto por el uso compartido del río Auroro, cuya cuenca atravesaba tanto su país como el vecino Estado de Marentia.\"",
      },
      {
        type: "multiple-choice",
        question: "What unexpected connection did Renata form with her counterpart Ilián?",
        options: ["They were secretly related", "A shared interest in poetry and classical music that built personal trust", "They had attended the same university", "They were previously married"],
        correctIndex: 1,
        explanation:
          "\"compartía con ella un interés genuino por la poesía y la música clásica.\"",
      },
      {
        type: "multiple-choice",
        question: "What was Renata's key proposal to break the deadlock?",
        options: ["A fixed 50/50 split", "A variable system adjusting water quotas based on actual seasonal rainfall levels", "Building a new dam", "Canceling the treaty entirely"],
        correctIndex: 1,
        explanation:
          "\"proponer un sistema variable que ajustara las cuotas de agua según los niveles reales de precipitación registrados cada temporada.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Renata and Ilián handle presenting the proposal to avoid political backlash?",
        options: ["They leaked it to the press first", "They coordinated simultaneous presentation to both governments so neither appeared to capitulate first", "They presented it only to Renata's government", "They refused to present it at all"],
        correctIndex: 1,
        explanation:
          "\"coordinaron cuidadosamente la presentación simultánea de la propuesta ante ambos gobiernos, evitando así que ninguna de las partes pudiera acusar a la otra de haber capitulado unilateralmente.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He fell off a mountain", "He lost a climbing partner during an unforeseen storm", "He retired from guiding", "He was injured in an avalanche"],
        correctIndex: 1,
        explanation:
          "\"había perdido a su compañero de cordada durante una tormenta que ningún pronóstico había anticipado.\"",
      },
      {
        type: "multiple-choice",
        question: "Why was Bruno stranded on the mountain?",
        options: ["He was pushed by another climber", "He had climbed without a guide, against explicit recommendations, and got caught in a sudden snowstorm", "His equipment failed", "He was lost for days"],
        correctIndex: 1,
        explanation:
          "\"había ascendido esa misma mañana sin guía y contra las recomendaciones explícitas del centro de montaña.\"",
      },
      {
        type: "multiple-choice",
        question: "What decision did Tomás make differently this time compared to fifteen years earlier?",
        options: ["He refused to attempt the rescue", "He stabilized Bruno and waited for a weather window instead of forcing an immediate descent", "He descended immediately regardless of risk", "He sent someone else instead"],
        correctIndex: 1,
        explanation:
          "\"optó por estabilizar a Bruno en un refugio improvisado... y esperar una ventana de mejora meteorológica.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Tomás feel at the end of the story?",
        options: ["Angry and bitter", "A profound relief, feeling he had made peace with his past", "Indifferent", "Determined to quit guiding forever"],
        correctIndex: 1,
        explanation:
          "\"se permitió llorar... no de tristeza sino de un alivio profundo... de haber hecho las paces con un pasado.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Her grandmother had summoned her to help sell the family lace business", "Something in her life in Madrid had fallen apart, though she doesn't explain what", "She had planned a long vacation months in advance", "Her grandmother was seriously ill and needed care"],
        correctIndex: 1,
        explanation:
          "The text says she left with 'la sensación de que algo en su vida se había roto sin que ella supiera exactamente cuándo' (the feeling that something in her life had broken without her knowing exactly when), and later mentions 'el despido' (the layoff) — she never explicitly narrates the cause, matching option B.",
      },
      {
        type: "multiple-choice",
        question: "What does Aurora tell Noa about the need to explain herself?",
        options: ["That she must tell her everything before she can stay", "That she should call Madrid and apologize immediately", "That there is no need to explain anything — the hands speak on their own if allowed to", "That silence is disrespectful in her house"],
        correctIndex: 2,
        explanation:
          "Aurora says: 'Aquí no hace falta que cuentes nada... Las manos hablan solas, si una las deja' (There's no need to tell anything here... hands speak on their own, if you let them).",
      },
      {
        type: "multiple-choice",
        question: "What does Aurora reveal about her own past when Noa asks if she ever wanted to leave?",
        options: ["She never once considered leaving the village", "She left once but came back for her husband", "She often wanted to leave, but working the lace pillow made her forget why", "She was forced to stay by her own mother"],
        correctIndex: 2,
        explanation:
          "Aurora confesses: 'Quise irme muchas veces... Pero cada vez que estaba a punto de hacerlo, me sentaba aquí, con el mundillo, y se me olvidaba por qué quería marcharme' (I wanted to leave many times... but I'd sit down with the lace pillow and forget why).",
      },
      {
        type: "multiple-choice",
        question: "How does the story end?",
        options: ["Noa firmly decides to move back to Camariñas permanently", "Noa leaves on the Sunday train as originally planned", "Noa buys a plane ticket to return to Madrid immediately", "Noa keeps her train ticket without a fixed date and stays another week"],
        correctIndex: 3,
        explanation:
          "The final lines say she found herself 'guardando el billete en el fondo del bolso, sin fecha fija' and sitting down again at the lace pillow — an open, undecided ending rather than a firm commitment.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Whether to sell the olive grove or keep it in the family", "Who should inherit their father's house in the village", "Whether to modernize the family's farming equipment", "How to split their father's savings account"],
        correctIndex: 0,
        explanation:
          "The conflict is explicit: 'Marta... quería vender; Julián... se negaba en redondo' (Marta wanted to sell; Julián flatly refused) — the dispute is over the olivar itself.",
      },
      {
        type: "multiple-choice",
        question: "What memory does Julián use to argue against selling?",
        options: ["The time their father won a regional olive-oil prize", "Mornings spent lighting fires among the trees to save the crop from frost", "The day their father planted the first olive tree", "A promise their father made on his deathbed to never sell"],
        correctIndex: 1,
        explanation:
          "Julián recalls 'las madrugadas en que salían juntos a encender fuegos entre los árboles para que el frío no matara los brotes' (the dawns when they went out together to light fires among the trees so the cold wouldn't kill the buds).",
      },
      {
        type: "multiple-choice",
        question: "What evidence does Julián offer that their father never wanted to sell?",
        options: ["A letter their father wrote explicitly refusing all offers", "The fact that he never sold even during hard years when banks offered to buy the land", "A clause in the will forbidding a sale", "Testimony from neighbors who heard him say so"],
        correctIndex: 1,
        explanation:
          "Julián says: 'Si él hubiera querido vender, lo habría hecho hace treinta años, cuando de verdad lo necesitábamos... No lo hizo. Eso también es una respuesta' (If he'd wanted to sell, he would have done it thirty years ago... He didn't. That's an answer too).",
      },
      {
        type: "multiple-choice",
        question: "How does the disagreement get resolved by the end of the story?",
        options: ["Marta forces an immediate sale against her siblings' wishes", "The siblings stop speaking to each other entirely", "Elena proposes postponing any final decision for a year, and Marta accepts", "A court settles the dispute by dividing the land equally"],
        correctIndex: 2,
        explanation:
          "Elena suggests leaving the decision for a year, and the text says 'Marta aceptó, no porque estuviera convencida, sino porque comprendió' that forcing a sale would open a lasting wound — no final decision is made, just a delay.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Alba refuses to perform in public at all", "Alba is writing entirely new lyrics that replace the old songs", "Alba mixes the traditional lyrics with electric guitars and unfamiliar rhythms", "Alba wants to stop singing copla altogether and switch genres"],
        correctIndex: 2,
        explanation:
          "The text states Alba began 'mezclar aquellas letras antiguas con guitarras eléctricas y ritmos que Remedios apenas reconocía' (mixing the old lyrics with electric guitars and rhythms Remedios barely recognized).",
      },
      {
        type: "multiple-choice",
        question: "What is Alba's justification for changing the arrangements?",
        options: ["She believes the old versions are simply outdated and embarrassing", "A music producer told her it was the only way to get paid", "She fears that if no one sings them differently, in twenty years no one will sing them at all", "She wants to make more money than her mother did"],
        correctIndex: 2,
        explanation:
          "Alba says: 'Si nadie las canta de otra forma, dentro de veinte años nadie las va a cantar de ninguna... Lo hago para que no se pierdan' (If no one sings them differently, in twenty years no one will sing them at all... I do it so they aren't lost).",
      },
      {
        type: "multiple-choice",
        question: "What does Remedios realize while listening outside Alba's door?",
        options: ["That Alba had actually changed the story of the song completely", "That what she feared losing was her own place in passing on the song, not the song itself", "That Alba's version was musically inferior to her own", "That she should forbid Alba from performing the song again"],
        correctIndex: 1,
        explanation:
          "The text says: 'Comprendió entonces que lo que temía perder no era la canción, sino el lugar que ella misma ocupaba en su transmisión' (she understood that what she feared losing wasn't the song, but her own place in passing it on).",
      },
      {
        type: "multiple-choice",
        question: "How does the story resolve at the festival?",
        options: ["Remedios refuses to appear on stage with Alba", "Remedios opens the song alone in the traditional style before Alba's arrangement joins in", "Alba abandons her electric arrangement to please her mother", "The two argue publicly and the performance is cancelled"],
        correctIndex: 1,
        explanation:
          "Remedios agrees 'con la condición de que fuera ella quien abriera la canción sola... antes de que entrara la guitarra eléctrica de su hija' — she sings the opening verses alone, then Alba's arrangement enters.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She was sent by the supermarket chain to negotiate a purchase", "Her company in the city closed unexpectedly and she lost her job", "Her grandfather asked her to come manage the bakery", "She had always planned to take over the family business"],
        correctIndex: 1,
        explanation:
          "The text says Sara returned 'después de que la empresa donde trabajaba cerrara sin previo aviso' (after the company she worked for closed without warning).",
      },
      {
        type: "multiple-choice",
        question: "What worries Sara about her grandfather in the months after her return?",
        options: ["He is spending too much money on new equipment", "He refuses to teach her anything about the bakery", "He is increasingly slow and tired, and looks at the oven with something like fear", "He wants to sell the bakery immediately without telling her"],
        correctIndex: 2,
        explanation:
          "The narration notes he 'se quedaba mirando el horno encendido con una expresión que no era cansancio, sino algo más parecido al miedo' (he'd stare at the lit oven with an expression that wasn't tiredness, but closer to fear).",
      },
      {
        type: "multiple-choice",
        question: "What offer does Cándido receive, and what does he say about it to Sara?",
        options: ["A supermarket chain offers to buy the bakery, and he says accepting it would let Sara return to the city without worrying about him", "A rival baker offers to merge businesses, and Cándido refuses outright", "The town hall offers a subsidy, and Cándido insists on refusing all outside help", "A journalist offers to write about the bakery, and Cándido feels flattered"],
        correctIndex: 0,
        explanation:
          "Cándido tells her: 'Si aceptara, no tendrías que preocuparte más por mí... Podrías volver a la ciudad tranquila' (If I accepted, you wouldn't have to worry about me anymore... you could go back to the city with peace of mind).",
      },
      {
        type: "multiple-choice",
        question: "How does the story end?",
        options: ["Cándido sells the bakery and retires to live with Sara in the city", "Sara leaves for the city without resolving anything with her grandfather", "Neither the offer is refused nor a permanent decision made, but Cándido lets Sara decide the bread's baking point alone, and feels at peace", "The bakery closes permanently due to lack of customers"],
        correctIndex: 2,
        explanation:
          "The final paragraph says they don't reject the offer immediately, but Cándido 'dejó que fuera su nieta quien decidiera sola el punto de cocción del pan' and felt a calm he hadn't felt in years — an open but hopeful ending.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["It is going to be demolished to build a hotel", "It will be automated, ending the need for a human keeper", "It will be sold to a private collector", "It will be converted into a museum with tour guides"],
        correctIndex: 1,
        explanation:
          "The story opens with the Autoridad Portuaria informing Elías 'que el faro sería automatizado' (that the lighthouse would be automated), ending his role as keeper.",
      },
      {
        type: "multiple-choice",
        question: "Why does Diego say he came to visit that weekend?",
        options: ["\"He venido por ti\" — he came for his father, not for the new system", "He came to inspect the new automated equipment for his job", "He came to convince his father to sell the lighthouse", "He came only because his mother insisted he visit"],
        correctIndex: 0,
        explanation:
          "When Elías says he can handle the installation alone, Diego responds: 'No he venido por el sistema... He venido por ti' (I didn't come for the system... I came for you).",
      },
      {
        type: "multiple-choice",
        question: "What does Elías teach Diego during their final climb together?",
        options: ["How to operate the new automated lighting system", "How to distinguish boat types by their movement and read the clouds for coming storms", "How to negotiate with the Autoridad Portuaria for compensation", "How to write official reports about the lighthouse's history"],
        correctIndex: 1,
        explanation:
          "Elías explains 'cómo distinguir un barco pesquero de uno de recreo por la forma en que se balanceaba, qué nubes anunciaban tormenta antes de que el cielo se oscureciera' — practical knowledge from decades of watching the sea.",
      },
      {
        type: "multiple-choice",
        question: "What does the story's ending suggest Elías is able to keep?",
        options: ["His job, since the automation plan is cancelled at the last minute", "The physical light mechanism, which he is allowed to take home", "The logbook where he recorded twenty-eight years of watches, storms, and sightings", "A formal position as a tour guide at the now-automated lighthouse"],
        correctIndex: 2,
        explanation:
          "Diego asks for 'el viejo cuaderno de bitácora donde, durante veintiocho años, Elías había anotado cada guardia, cada tormenta, cada barco avistado' — the logbook is what survives, not the post itself.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The factory owners refuse to pay for the materials", "The wall will be demolished within a month, yet she's still asked to decorate it beautifully", "The neighborhood association wants no art at all on the building", "The mural must be finished within a single day"],
        correctIndex: 1,
        explanation:
          "The wall 'sería derribado en menos de un mes' (would be demolished in less than a month), and Rosa finds it strange that anyone would pay to decorate something so soon to disappear.",
      },
      {
        type: "multiple-choice",
        question: "What question does Benito ask Rosa that changes her approach to the mural?",
        options: ["Whether she will be paid fairly for her work", "Whether she is going to paint something pretty to cover the factory up, or something that remembers it", "Whether she has ever worked in a factory herself", "Whether the mural will survive the demolition"],
        correctIndex: 1,
        explanation:
          "Benito asks: '¿Vas a pintar algo bonito para taparlo, o algo que lo recuerde?' (Are you going to paint something pretty to cover it up, or something that remembers it?) — this reframes her whole design.",
      },
      {
        type: "multiple-choice",
        question: "What does the finished mural depict?",
        options: ["A realistic portrait of the factory workers at their machines", "Dozens of overlapping hands of different ages, working over what reads as an open can", "An abstract geometric pattern unrelated to the factory", "A landscape of the sea and the fishing boats that supplied the factory"],
        correctIndex: 1,
        explanation:
          "The text describes 'decenas de manos superpuestas, en distintos tonos... todas trabajando sobre lo que podía leerse... como una lata de conserva abierta' (dozens of overlapping hands... working over what could be read as an open tin can).",
      },
      {
        type: "multiple-choice",
        question: "What is Benito's final response when Rosa apologizes that the mural will only last a month?",
        options: ["He tells her she wasted her time and should have refused the job", "He says the demolition should be stopped by the neighborhood", "He says what mattered inside the factory also lasted short spans of time, and that memory, not paint, is what endures", "He asks her to repaint it somewhere more permanent"],
        correctIndex: 2,
        explanation:
          "Benito says: 'Todo lo que de verdad importó aquí dentro duró menos de un mes... Lo que dura... es lo que alguien decide recordar. Y de esto, ya me acordaré yo por los dos' (Everything that truly mattered here also lasted less than a month... what endures is what someone chooses to remember. And I'll remember this for both of us).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He wants to take over the workshop full-time", "He plans to leave for the United States to work construction with a cousin", "He wants to sell the unfinished carvings in the workshop", "He wants to enroll in an art school in the capital"],
        correctIndex: 1,
        explanation:
          "The text says Marcos 'había decidido irse a Estados Unidos con un primo que ya llevaba allí dos años trabajando en la construcción' (had decided to go to the United States with a cousin already working construction there).",
      },
      {
        type: "multiple-choice",
        question: "Why does Marcos say he needs to leave, according to his own words?",
        options: ["\"Aquí no hay trabajo\" — he says there's no work there and he doesn't know what he could offer future children if he stays", "He says he simply dislikes his father's trade", "He says the cofradía refused to pay his father fairly", "He says he wants adventure more than economic necessity"],
        correctIndex: 0,
        explanation:
          "Marcos says: 'Si me quedo, no sé qué voy a poder ofrecerle a mis hijos... Aquí no hay trabajo, papá' (If I stay, I don't know what I'll be able to offer my children... There's no work here, dad).",
      },
      {
        type: "multiple-choice",
        question: "Why does Efraín ask Marcos to stay a few more weeks before leaving?",
        options: ["He genuinely needs the extra hands and has no other motive", "The cofradía forbids Marcos from leaving before the carving is done", "Officially it's to help finish the carving, but really he wants more time with his son", "He hopes Marcos will change his mind about leaving entirely"],
        correctIndex: 2,
        explanation:
          "The text says his excuse was needing help with delicate parts, 'aunque en realidad lo que quería era tener a su hijo cerca un poco más de tiempo' (though what he really wanted was to keep his son close a little longer).",
      },
      {
        type: "multiple-choice",
        question: "What does the closing letter from Marcos reveal?",
        options: ["He has decided to return home immediately", "He has found a wood-carving workshop abroad", "He has no wood to carve there, but says he still remembers exactly how it's done", "He regrets learning the craft at all"],
        correctIndex: 2,
        explanation:
          "Marcos writes: 'Aquí no hay madera que tallar, papá, pero cuando cierro los ojos, todavía sé exactamente cómo se hace' (There's no wood to carve here, dad, but when I close my eyes, I still know exactly how it's done) — the craft survives in memory even without the material.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["New fishing regulations from the government", "A supermarket buying directly from large boat owners, bypassing the auction", "A storm that destroyed the port infrastructure", "A lack of fish in the surrounding waters"],
        correctIndex: 1,
        explanation:
          "The text explains a supermarket 'había empezado a comprar directamente a un par de armadores grandes, sin pasar por la lonja' (had begun buying directly from a couple of large boat owners, bypassing the auction house).",
      },
      {
        type: "multiple-choice",
        question: "Why does Xosé refuse to simply retire when Marina suggests it?",
        options: ["He believes no one else could learn to auction properly and someone must keep the door open for small sellers", "He needs the income and has no pension", "He is legally obligated to keep working for another decade", "He doesn't trust Marina to take over the family finances"],
        correctIndex: 0,
        explanation:
          "Xosé says: 'mientras yo pueda abrir esa puerta a las seis, alguien va a poder vender su pescado sin que se lo compre un camión antes de que toque tierra. Eso... todavía vale la pena' — he keeps the auction alive for the small sellers' sake.",
      },
      {
        type: "multiple-choice",
        question: "What does Marina report to her father about the younger generation in the village?",
        options: ["They are eager to learn the auctioneering trade", "None of her cousins or the fishermen's children want to learn the trade — they've all studied or left", "They want to unionize against the supermarket chain", "They are planning to buy the lonja from Xosé"],
        correctIndex: 1,
        explanation:
          "The text states 'ninguno de sus primos ni de los hijos de los pescadores del pueblo quería aprender el oficio; todos habían estudiado o se habían marchado' (none of her cousins nor the fishermen's children wanted to learn the trade).",
      },
      {
        type: "multiple-choice",
        question: "How does the story end?",
        options: ["Marina moves back permanently and takes over the lonja immediately", "The lonja closes for good after Xosé's final auction", "Marina asks to be taught the auction bookkeeping on weekends, and Xosé feels less alone in the work, though nothing is guaranteed", "Xosé sells the business to the supermarket chain"],
        correctIndex: 2,
        explanation:
          "Marina asks 'si podía enseñarle, aunque fuera solo los fines de semana, a llevar los números de las pujas,' and though Xosé makes no promises, he no longer feels he's closing something doomed to vanish without a trace.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Running a traveling puppet theater through towns in Teruel province", "Selling wooden crafts at regional markets", "Managing a permanent theater in Zaragoza", "Touring as musicians during local festivals"],
        correctIndex: 0,
        explanation:
          "The story opens: 'La familia de Anselmo llevaba tres generaciones recorriendo los pueblos de la provincia de Teruel... montando su pequeño teatrillo de títeres' (the family had spent three generations touring Teruel's towns setting up their small puppet theater).",
      },
      {
        type: "multiple-choice",
        question: "What news does Clara give her father?",
        options: ["She has been accepted into a drama school in Zaragoza starting in September", "She wants to sell the family's puppets to a museum", "She is getting married and leaving the family business", "She wants to permanently retire the puppet show"],
        correctIndex: 0,
        explanation:
          "Clara says: 'Me han admitido en la escuela de arte dramático de Zaragoza... Empieza en septiembre' (I've been admitted to the drama school in Zaragoza... It starts in September).",
      },
      {
        type: "multiple-choice",
        question: "How does Clara explain her decision to her father?",
        options: ["She says she hates puppetry and wants nothing more to do with it", "She says she wants to learn directing and writing, and perhaps return later with something new to offer", "She says her father forced her to stay too long already", "She says the family business is losing money and must close"],
        correctIndex: 1,
        explanation:
          "Clara says: 'yo necesito aprender otras cosas... Quiero aprender a dirigir, a escribir para el teatro de verdad, y después, si quiero, volver a esto con algo nuevo que ofrecer.'",
      },
      {
        type: "multiple-choice",
        question: "What does Clara do on her last night before leaving, and what does it suggest?",
        options: ["She burns the old puppets in a symbolic break with the past", "She hands the family's oldest puppet to her younger brother, suggesting she is passing on the tradition rather than abandoning it", "She sells the puppet theater equipment to another family", "She refuses to perform one last time, upset with her father"],
        correctIndex: 1,
        explanation:
          "Clara gives her brother the great-grandfather's puppet saying 'Cuídalo tú ahora,' and Anselmo understands 'que su hija no se estaba despidiendo de los títeres, sino simplemente aprendiendo... a llevarlos consigo' — she's continuing the tradition, not ending it.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She got divorced from her husband Ramón", "Her husband Ramón died over the winter after an illness", "She sold half the inn to a business partner", "Her son Óscar moved back to help her run the inn"],
        correctIndex: 1,
        explanation:
          "The text states 'Ramón había muerto en invierno, tras una enfermedad que ninguno de los dos había querido nombrar en voz alta' (Ramón had died in winter after an illness neither of them had wanted to name aloud).",
      },
      {
        type: "multiple-choice",
        question: "What practical problem threatens the inn's survival?",
        options: ["A fire damaged half the building", "The town council raised property taxes drastically", "A new highway now bypasses the town, diverting almost all traffic away from the inn", "A competing inn opened right across the street"],
        correctIndex: 2,
        explanation:
          "The text explains that the new autovía 'rodeaba el pueblo por el norte, ahorrando a los conductores casi cuarenta minutos' and the crossroads 'dejó de ser un paso obligado' — the inn lost nearly all its passing traffic.",
      },
      {
        type: "multiple-choice",
        question: "What does the guest from Barcelona tell Teresa that shifts her thinking?",
        options: ["She should sell the inn and retire", "She should modernize faster than her son suggests", "She should not change anything, because finding a place unchanged from memory is valuable", "She should relocate the inn closer to the new highway"],
        correctIndex: 2,
        explanation:
          "The guest tells her 'que no cambiara nada, que en un mundo que se movía tan rápido, encontrar un lugar exactamente igual a como lo recordaba valía más de lo que Teresa imaginaba.'",
      },
      {
        type: "multiple-choice",
        question: "What compromise does Teresa reach by the end of the story?",
        options: ["She fully adopts her son's luxury spa plan", "She closes the inn permanently", "She keeps the inn essentially unchanged, but markets it, with Óscar's help, precisely as an unchanged place frozen in time", "She sells the inn to the woman from Barcelona"],
        correctIndex: 2,
        explanation:
          "Teresa decides to keep the inn 'tal como era, sin spa ni cocina de autor,' but advertise it 'como lo que realmente ofrecía, un lugar detenido en el tiempo' — a middle path between her original plan and her son's.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Olive harvesting between two regions", "Transhumance — moving livestock nearly 600 km between pastures in Soria and Extremadura each season", "A pilgrimage route connecting two cathedrals", "Seasonal fishing along a river route"],
        correctIndex: 1,
        explanation:
          "The text describes 'la cañada que unía los pastos de Soria con las dehesas de Extremadura, un recorrido de casi seiscientos kilómetros que la familia repetía cada primavera y cada otoño desde hacía casi un siglo.'",
      },
      {
        type: "multiple-choice",
        question: "What do some neighbors say about Águeda continuing the tradition?",
        options: ["That she lacks the physical strength required", "That it isn't a job for a woman alone in the mountains for months", "That she should study instead of working with animals", "That the tradition should end regardless of who continues it"],
        correctIndex: 1,
        explanation:
          "A neighbor says: 'No es un trabajo para una mujer sola, ir meses por el monte' (It's not a job for a woman alone, going months into the mountains).",
      },
      {
        type: "multiple-choice",
        question: "Why does Silvestre hesitate before letting Águeda lead the transhumance alone?",
        options: ["He doubts she knows the route well enough", "He fears what other shepherds and the village might say or do, not her actual competence", "He has already promised the task to one of his other children", "He believes the tradition should simply end with him"],
        correctIndex: 1,
        explanation:
          "The text clarifies: 'no porque dudara de la capacidad de su hija... sino porque temía lo que el resto del pueblo... pudiera decir o hacer' (not because he doubted his daughter's ability, but because he feared what the rest of the village might say or do).",
      },
      {
        type: "multiple-choice",
        question: "How does the journey conclude, and what does Silvestre say when Águeda calls?",
        options: ["She fails to complete the route and returns home early", "She arrives with nearly the whole flock intact and Silvestre tells her she arrived even better than he used to", "She arrives but refuses to speak to her father afterward", "She decides never to do the trashumancia again"],
        correctIndex: 1,
        explanation:
          "Águeda arrives 'con el rebaño casi completo, habiendo perdido solo dos cabezas,' and Silvestre says: 'Ya sabía yo que ibas a llegar... Lo que no sabía es que ibas a llegar mejor que yo.'",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She is the only person left who knows the historical dates of Puebla's ceramics", "She still works with traditional methods, without industrial molds or synthetic paint", "She owns the largest ceramics factory in the city", "She trained abroad in European ceramic techniques"],
        correctIndex: 1,
        explanation:
          "She is described as working 'sin moldes industriales ni pintura sintética, algo que cada vez menos talleres de la ciudad se molestaban en respetar' (without industrial molds or synthetic paint, something fewer and fewer workshops bothered to respect).",
      },
      {
        type: "multiple-choice",
        question: "What does Doña Pilar tell the young couple when they first ask her to restore their facade?",
        options: ["That the restoration will look identical to the eighteenth-century original", "That they should buy industrial tile if they want something perfect, but if they want something alive with history, they should talk", "That she refuses the job because the budget is too low", "That the work can be finished within two weeks"],
        correctIndex: 1,
        explanation:
          "She says: 'Si buscan algo perfecto, mejor compren azulejo industrial... Si quieren algo vivo, que respire un poco de historia, entonces hablemos.'",
      },
      {
        type: "multiple-choice",
        question: "Why does Doña Pilar accept the job despite the low budget?",
        options: ["She needs the money desperately and has no other clients", "The house reminds her of one she restored when young, and she wants an excuse to take on Iván as an apprentice", "The couple threatened to report her to authorities otherwise", "She was legally required to accept the commission"],
        correctIndex: 1,
        explanation:
          "The text explains she accepted 'en parte porque la casa le recordaba a otra que había restaurado de joven, y en parte porque llevaba tiempo buscando una excusa para tomar como aprendiz a Iván.'",
      },
      {
        type: "multiple-choice",
        question: "What does Doña Pilar ask for instead of the extra payment the couple offers?",
        options: ["A share of ownership in the house", "Free use of an empty ground-floor space so Iván can eventually set up his own workshop there", "A written recommendation letter for future clients", "Payment in the form of imported ceramic tools"],
        correctIndex: 1,
        explanation:
          "She asks 'que le permitieran usar, de manera gratuita, un pequeño local vacío que tenían en la planta baja de la casa, para que Iván pudiera instalar allí, algún día, su propio taller.'",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A large sum of money in a savings account", "A stone house with a small orchard and a handwritten notebook of recipes", "A jewelry collection and a car", "A bookshop in the town center"],
        correctIndex: 1,
        explanation:
          "Amparo left Clara 'la casa de piedra en las afueras de Sóller, con su pequeño huerto de higueras y almendros, y un cuaderno de tapas gastadas' with fifty years of family recipes.",
      },
      {
        type: "multiple-choice",
        question: "What tempts Clara to sell the property?",
        options: ["A real estate agent offers a large sum that could pay off much of her debt", "Her landlord in Palma threatens to raise her rent", "A cousin insists the property legally belongs to someone else", "The house is condemned by the local council"],
        correctIndex: 0,
        explanation:
          "A real estate agent offers her 'una cifra que, según él, no se repetiría, y que a Clara le habría permitido saldar buena parte de sus deudas.'",
      },
      {
        type: "multiple-choice",
        question: "What realization does Clara have after finding the recipe notebook and visiting the orchard?",
        options: ["That the recipes could be sold separately for a large profit", "That the recipes only make sense tied to this specific land and these specific trees", "That she should turn the house into a restaurant immediately", "That her grandmother had actually wanted her to sell"],
        correctIndex: 1,
        explanation:
          "Clara thinks: 'Si vendiera esto, no habría cuaderno que valiera nada... Las recetas están escritas para esta tierra, para estos árboles. En cualquier otro sitio, no serían más que palabras.'",
      },
      {
        type: "multiple-choice",
        question: "How does the story conclude?",
        options: ["Clara accepts the offer and moves back to Palma permanently", "Clara rejects the offer, keeps visiting on weekends, and eventually makes fig jam using her grandmother's recipe", "Clara sells the house but keeps the notebook for herself", "The house is destroyed by a fire before Clara can decide"],
        correctIndex: 1,
        explanation:
          "The final paragraph says she 'rechazó la oferta' and that August 'hizo mermelada de higos siguiendo la receta del cuaderno, palabra por palabra, hasta que la cocina entera olió exactamente como recordaba de niña.'",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He has no savings to pass the business on", "His daughters moved away and showed no interest in the trade, and he had no sons", "The town council plans to close all traditional workshops", "He never trained anyone in the craft on purpose"],
        correctIndex: 1,
        explanation:
          "The text notes his daughters 'se habían mudado hacía años a Guadalajara sin mostrar jamás interés alguno por la madera ni por el barniz,' and he had no sons, so he assumed the workshop would simply close.",
      },
      {
        type: "multiple-choice",
        question: "How does Don Herminio respond to the neighbor's comment that no woman has ever built guitars there?",
        options: ["He agrees and asks Ximena to stop helping", "He says 'Pues entonces será la primera' (Then she'll be the first) and ends the conversation", "He apologizes to the neighbor for allowing her to help", "He remains silent and avoids the topic entirely"],
        correctIndex: 1,
        explanation:
          "Don Herminio replies simply: 'Pues entonces será la primera,' closing off any further discussion of the matter.",
      },
      {
        type: "multiple-choice",
        question: "What decision does Ximena make after overhearing the neighbor's remark?",
        options: ["She decides to quit the workshop out of frustration", "She resolves to one day build a complete guitar entirely on her own", "She asks her uncle to fire the neighbor", "She decides to move to Guadalajara like her cousins"],
        correctIndex: 1,
        explanation:
          "The text says she decided 'que algún día construiría una guitarra completamente sola, de principio a fin, para que nadie pudiera decir que solo ayudaba.'",
      },
      {
        type: "multiple-choice",
        question: "What does Ximena find most meaningful about the story's outcome?",
        options: ["The high price the guitar sold for in Morelia", "That the musician who bought it wrote her a personal thank-you note", "That the town now speaks of her simply as a guitar-maker, like any other luthier, rather than as someone who merely helps", "That her uncle finally admitted she was better than him"],
        correctIndex: 2,
        explanation:
          "The final line says what mattered was that people in town 'hablaban de ella, con la misma naturalidad con la que hablaban de cualquier otro luthier, simplemente como la muchacha que hacía guitarras.'",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A supermarket chain offers a contract that would multiply production tenfold but require cheapening the recipe", "A foreign investor offers to buy the entire business outright", "A rival turrón maker offers to merge companies", "A bank threatens to foreclose on the workshop"],
        correctIndex: 0,
        explanation:
          "The supermarket chain proposes a contract that would multiply annual production tenfold 'a cambio de que adaptaran la receta para abaratar costes y de que renunciaran... al proceso artesanal.'",
      },
      {
        type: "multiple-choice",
        question: "What is Ramón's main objection to the supermarket contract?",
        options: ["He worries the supermarket would pay too slowly", "He believes the cheaper turrón wouldn't honestly be the same product his father and grandfather perfected", "He simply dislikes his brother's business ideas on principle", "He fears losing control of the family name legally"],
        correctIndex: 1,
        explanation:
          "Ramón says: 'Si firmamos esto, dejaríamos de ser los Marín para convertirnos en una marca cualquiera con nuestro apellido pegado encima' — he fears losing what actually makes the turrón theirs.",
      },
      {
        type: "multiple-choice",
        question: "What compromise do the brothers reach?",
        options: ["They accept the supermarket contract but keep a small artisanal side production", "They reject the supermarket contract and take a bank loan to open an online shop selling directly to loyal customers", "They sell the business entirely and retire", "They split the company into two separate businesses"],
        correctIndex: 1,
        explanation:
          "They 'rechazaron el contrato del supermercado, pero aceptaron un préstamo bancario para abrir una pequeña tienda online que les permitiera vender directamente... a clientes... dispuestos a pagar un poco más.'",
      },
      {
        type: "multiple-choice",
        question: "What moment reassures Ramón that they made the right choice?",
        options: ["The business becomes wildly profitable within the first year", "A loyal customer of thirty years orders the same turrón to send to his daughter studying abroad", "A newspaper writes a flattering article about the family", "Vicente admits he was wrong about everything"],
        correctIndex: 1,
        explanation:
          "The story ends with a customer who 'llevaba treinta años comprando el mismo turrón que compraba su padre' now sending it to his own daughter abroad — Ramón feels they remain 'exactamente quienes querían ser,' regardless of profit.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A new law banning the harvesting of wicker from the riverbank", "Buyers being drawn to cheap plastic baskets sold for a fraction of the price", "A flood that destroyed the wicker plantations", "Government regulations requiring certification he can't afford"],
        correctIndex: 1,
        explanation:
          "The text says buyers were 'atraídos por los cestos de plástico que se vendían en cualquier bazar por una fracción del precio' (drawn to plastic baskets sold in any bazaar for a fraction of the price).",
      },
      {
        type: "multiple-choice",
        question: "Why does Brais clarify that he's not asking about the craft in order to take it up professionally?",
        options: ["He is afraid his grandfather will charge him for lessons", "He worries his grandfather will misread his curiosity as a commitment he isn't ready to make", "He has already decided to become a professional basket weaver instead", "He wants to sell the technique to a company"],
        correctIndex: 1,
        explanation:
          "Brais says: 'No te lo pregunto porque quiera dedicarme a esto... Solo quiero entenderlo,' clarifying almost with embarrassment, 'como si temiera que su abuelo malinterpretara el interés.'",
      },
      {
        type: "multiple-choice",
        question: "What does Xoán say matters most to him about the craft's possible end?",
        options: ["That someone continue the business for financial reasons", "That it not end without at least someone understanding what it was for", "That his grandson promise to take over no matter what", "That the technique be documented in a written manual"],
        correctIndex: 1,
        explanation:
          "Xoán says: 'Las cosas se acaban. Lo que no me gustaría es que se acabara sin que nadie, ni siquiera tú, entendiera para qué servía.'",
      },
      {
        type: "multiple-choice",
        question: "How does the story suggest the craft survives, even though Brais pursues marine biology instead?",
        options: ["Brais opens his own basket shop near the university", "Brais keeps the basket as a practical object on his desk and can explain how it's made, and keeps returning each summer to learn more", "Brais publishes a scientific paper about wicker weaving", "Xoán forces Brais to promise he will take over eventually"],
        correctIndex: 1,
        explanation:
          "Brais uses the basket practically at university and can explain 'con un detalle que sorprendía a quien preguntaba, cómo se hacía,' and he keeps returning each summer to learn something new — the craft persists in partial, informal ways rather than through a clean succession.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A fire destroyed its mechanism", "Industrial flour mills in the capital offered prices no windmill could compete with", "A storm broke the sails permanently", "The government banned windmills for safety reasons"],
        correctIndex: 1,
        explanation:
          "The mill stopped 'después de que las harineras industriales de la capital ofrecieran precios con los que ningún molino de viento de La Mancha podía competir.'",
      },
      {
        type: "multiple-choice",
        question: "What does the tourism company propose to the town council?",
        options: ["To restore the windmill as a tourist attraction", "To buy the whole hill and build a hotel, which would require demolishing the windmill", "To rent the windmill for a documentary film", "To build a museum dedicated to the windmill's history"],
        correctIndex: 1,
        explanation:
          "The company proposes buying the hill 'para construir allí un hotel con vistas panorámicas' and the project 'incluía derribar el molino, considerado... un obstáculo estructural.'",
      },
      {
        type: "multiple-choice",
        question: "What idea does Lucía propose to save the windmill?",
        options: ["Turning it into a private residence for the family", "Restoring it so it can grind grain again and sell artisanal flour directly to bakeries and restaurants", "Selling it to a museum in Madrid", "Chaining herself to the windmill in protest"],
        correctIndex: 1,
        explanation:
          "Lucía says: 'Si lo reparáramos de verdad, no solo lo salvaríamos... Podría volver a moler grano... Vuelve a ser lo que siempre fue,' proposing a working restoration rather than mere preservation.",
      },
      {
        type: "multiple-choice",
        question: "What role does Ambrosio play in the restoration, beyond emotional support?",
        options: ["He funds the entire project personally", "He contributes the exact oral memory of how to adjust the sails to the wind, passed down from his own grandfather", "He hires the construction crew himself", "He writes the official government proposal"],
        correctIndex: 1,
        explanation:
          "The text says Ambrosio contributed 'la memoria exacta de cómo se ajustaban las aspas al viento, transmitida oralmente desde su propio abuelo' — knowledge no technical study could provide.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["His father kicked him out of the workshop", "He wanted to avoid a lifetime among the grinding wheels, heat, and smell of metal from the family knife workshop", "He was offered a scholarship to study abroad", "He had a falling out with his mother"],
        correctIndex: 1,
        explanation:
          "Tomás left 'decidido a no pasar el resto de su vida entre el ruido de las muelas y el olor a metal caliente del taller de cuchillería,' valuing the feeling of not smelling of steel at the end of each day.",
      },
      {
        type: "multiple-choice",
        question: "What event brings Tomás back to Albacete?",
        options: ["His father's stroke, which leaves reduced mobility in his working hand", "His parents' divorce", "A fire that destroyed part of the workshop", "An invitation to his sister's wedding"],
        correctIndex: 0,
        explanation:
          "Tomás's father 'había sufrido un ictus mientras trabajaba' and would be left with 'la movilidad de la mano derecha considerablemente reducida,' effectively ending his active work.",
      },
      {
        type: "multiple-choice",
        question: "What condition does Cayetano set for Tomás's decision about staying?",
        options: ["That he must decide with a clear head, not out of pity, since a workshop kept out of pity closes anyway", "That he sign a legal contract immediately", "That he first ask his mother's permission", "That he complete a formal apprenticeship first"],
        correctIndex: 0,
        explanation:
          "Cayetano says: 'Solo te pido que decidas con la cabeza despejada, no por lástima, porque un taller que se lleva por lástima acaba cerrando de todas formas.'",
      },
      {
        type: "multiple-choice",
        question: "What finally convinces Tomás to stay, according to the story's ending?",
        options: ["A sense of duty and pity for his father", "A financial calculation showing the workshop was more profitable than his office job", "The silent realization, while sharpening a blade, that the trade had never stopped being his own", "A direct order from his mother"],
        correctIndex: 2,
        explanation:
          "The final line says what convinced him was 'la certeza silenciosa... de que aquel oficio, por mucho que hubiera intentado dejarlo atrás, nunca había dejado de ser también el suyo' — not duty or pity, but recognition.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["In a valley near the coast, chosen for easy transportation", "In a natural cave in the Picos de Europa, where constant humidity and temperature allow the blue cheese to mature properly", "In a converted barn near the family house", "In an underground cellar built specifically for tourism"],
        correctIndex: 1,
        explanation:
          "The cave is 'encajada en una cueva natural de los Picos de Europa, a más de mil doscientos metros de altitud, donde la humedad y la temperatura constantes permitían que el queso azul madurara exactamente como lo había hecho durante casi ochenta años.'",
      },
      {
        type: "multiple-choice",
        question: "What does Rubén propose when consulted about the family business after their father's illness?",
        options: ["That he move back to help Nieves run it", "That they sell the herd and rent the cave to a larger cheese cooperative", "That they hire outside workers to manage everything", "That they close the business permanently without selling anything"],
        correctIndex: 1,
        explanation:
          "Rubén proposes 'que vendieran el rebaño y arrendaran la cueva a una cooperativa quesera más grande,' arguing it would give the siblings money without anyone sacrificing their life in the mountains.",
      },
      {
        type: "multiple-choice",
        question: "What does Nieves decide to do instead of accepting Rubén's plan?",
        options: ["She quits the veterinary job entirely and moves permanently to the cave", "She requests reduced hours at the veterinary clinic so she can manage both the herd and her job", "She hires a stranger to run the cheese cave for her", "She agrees to sell but keeps one goat as a memento"],
        correctIndex: 1,
        explanation:
          "Nieves decides to 'pedir una reducción de jornada en la veterinaria,' juggling both the cheese-making and her paid job rather than abandoning either.",
      },
      {
        type: "multiple-choice",
        question: "What does Rubén admit after tasting the first batch of cheese Nieves produces alone?",
        options: ["That the cheese is inferior to their father's and they should sell after all", "That he had perhaps underestimated what his sister was capable of doing alone", "That he wants to quit his job in Santander and help her", "That their father should never retire"],
        correctIndex: 1,
        explanation:
          "After tasting the cheese in silence, Rubén 'admitió que quizás había subestimado lo que su hermana era capaz de hacer sola' (admitted he had perhaps underestimated what his sister was capable of doing alone).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He applied voluntarily for an apprenticeship", "A juvenile court judge assigned him community service hours after he was caught stealing twice", "His school required a work placement for graduation", "His family paid Don Rogelio to train him"],
        correctIndex: 1,
        explanation:
          "The text explains 'El juez de menores le asignó... a un muchacho de dieciséis años llamado Iván, que había sido sorprendido robando en dos ocasiones' as part of a community service agreement to avoid formal charges.",
      },
      {
        type: "multiple-choice",
        question: "How does Don Rogelio respond when Iván says he knows nothing about stones?",
        options: ["He sends Iván away and requests a different assignment", "He tells him nobody knows anything about stones until they begin, and hands him a chisel to start", "He lectures him about the seriousness of his crimes", "He assigns him only administrative paperwork instead"],
        correctIndex: 1,
        explanation:
          "Don Rogelio replies: 'Nadie sabe nada de piedras hasta que empieza,' handing him a chisel and a scrap of stone to try.",
      },
      {
        type: "multiple-choice",
        question: "What marks the turning point in Iván's attitude toward the work?",
        options: ["He receives a monetary reward for good behavior", "He begins asking genuine questions about why certain stones fit better than others", "He is threatened with additional legal consequences", "Don Rogelio's family intervenes to encourage him"],
        correctIndex: 1,
        explanation:
          "The change comes 'cuando Iván empezó a hacer preguntas sobre por qué ciertas piedras encajaban mejor que otras' — genuine curiosity marks the shift from resentful compliance to real interest.",
      },
      {
        type: "multiple-choice",
        question: "What happens after Iván completes his required community service hours?",
        options: ["He leaves immediately and never returns", "He keeps showing up voluntarily, and Don Rogelio eventually gives him his own father's oldest chisel", "He is arrested again for a different crime", "He is hired formally by the town council as a paid worker"],
        correctIndex: 1,
        explanation:
          "After his hours ended, 'Iván no dejó de aparecer por la obra; simplemente empezó a hacerlo por voluntad propia,' and at the tower's completion Don Rogelio gives him 'su propio cincel más antiguo, el que había pertenecido a su padre.'",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["It kept making factual errors about important dates.", "Its responses became too eloquent and consistent, unlike the real Tomás.", "Diego admitted the whole project had been a fraud from the start.", "The app began requiring a monthly subscription fee."],
        correctIndex: 1,
        explanation:
          "The text says \"El verdadero Tomás titubeaba, se corregía, se quedaba a medio camino de las frases sentimentales; aquel Tomás digital, en cambio, no dudaba nunca\" — the real Tomás hesitated, but the digital voice never did, which is what unsettled her.",
      },
      {
        type: "multiple-choice",
        question: "What did Diego reveal about how the app behaved when it lacked enough data?",
        options: ["It refused to respond at all.", "It asked Irene to record more of Tomás's old messages.", "It invented, or \"completed,\" the most probable response.", "It replayed an old recording at random."],
        correctIndex: 2,
        explanation:
          "Diego explains that \"cuando el programa no tenía suficientes datos sobre un tema, inventaba —o, como él prefirió decir, 'completaba'— la respuesta más probable.\"",
      },
      {
        type: "multiple-choice",
        question: "What kind of test did Irene begin giving the voice after her suspicions grew?",
        options: ["She asked it to sing one of Tomás's favorite songs.", "She asked it questions only the real Tomás could have answered precisely.", "She asked Diego to reprogram the app entirely.", "She stopped speaking to it in Spanish to see if it would respond in English."],
        correctIndex: 1,
        explanation:
          "She asks about \"el nombre del perro que habían tenido de niños\" and other things \"que solo el verdadero Tomás habría podido recordar con exactitud\" — details only the real Tomás would know.",
      },
      {
        type: "multiple-choice",
        question: "How does the story end?",
        options: ["Irene deletes the app completely and forbids anyone from mentioning it again.", "Irene keeps using the app every night exactly as before.", "Irene archives the app without deleting the real recordings and begins speaking to a photograph instead.", "Irene sues the technology company for emotional damages."],
        correctIndex: 2,
        explanation:
          "The final paragraph states she \"archivó la aplicación sin borrarla del todo\" and then \"prefirió... hablarle a la fotografía que tenía sobre la mesilla,\" choosing an honest silence over the simulation.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["That he was being paid less than his colleagues.", "That disturbing images no longer provoked any reaction in him.", "That the algorithm was flagging too few videos.", "That his supervisor was constantly watching his screen."],
        correctIndex: 1,
        explanation:
          "The text says he was disturbed above all \"no sentir nada ante escenas que, meses atrás, le habrían quitado el sueño\" — feeling nothing about scenes that once would have kept him up at night.",
      },
      {
        type: "multiple-choice",
        question: "What happened when Bruno watched the unusual, low-quality video?",
        options: ["He immediately reported it without watching it fully.", "He felt genuinely affected for the first time in weeks, which itself unsettled him.", "He recognized someone he knew personally in the footage.", "The video turned out to be a technical glitch with no real content."],
        correctIndex: 1,
        explanation:
          "The story states it was \"la primera vez en semanas que algo lo afectaba de verdad, y esa misma sorpresa lo perturbó tanto como el contenido del vídeo\" — being affected surprised him as much as the video itself.",
      },
      {
        type: "multiple-choice",
        question: "How did the company respond when Bruno raised his concerns with human resources?",
        options: ["They fired him immediately for underperformance.", "They offered him a raise to stay in the same position.", "They offered a free therapy session and a possible team change in three months.", "They shut down the moderation department entirely."],
        correctIndex: 2,
        explanation:
          "HR offers \"una sesión gratuita con un psicólogo de la empresa y la posibilidad de rotar a otro equipo dentro de tres meses,\" which Bruno reads as a logistical, not human, response.",
      },
      {
        type: "multiple-choice",
        question: "Why did Bruno ultimately decide to resign?",
        options: ["He found a much better-paying job elsewhere.", "He preferred to leave feeling too much rather than end up feeling nothing at all.", "Alicia convinced him it was the only ethical option.", "The company was being investigated by regulators."],
        correctIndex: 1,
        explanation:
          "He reasons that \"prefería marcharse sintiendo demasiado a quedarse sin sentir nada en absoluto\" — he'd rather feel too much than nothing at all.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Identifying protesters at political demonstrations.", "Cameras in metro stations for public transport security.", "Verifying employee identities inside the company's offices.", "Unlocking smartphones without a password."],
        correctIndex: 1,
        explanation:
          "Hugo \"asumió, sin comprobarlo del todo, que aquello significaba cámaras en estaciones de metro y poco más\" — he assumed it meant metro station cameras, without checking further.",
      },
      {
        type: "multiple-choice",
        question: "What did Hugo discover when he reviewed the system's usage logs?",
        options: ["The system had never actually been deployed anywhere.", "It had been activated near demonstrations, generating lists of identified faces exported to an outside database.", "A competitor had stolen his source code.", "The algorithm had a bug that misidentified thousands of innocent people."],
        correctIndex: 1,
        explanation:
          "The logs show the system \"se había activado... en las inmediaciones de varias manifestaciones, y había generado listas de rostros identificados que después se habían exportado a una base de datos externa.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Hugo's supervisor respond when he raised the issue with her?",
        options: ["She promised to shut the program down immediately.", "She told him it wasn't the technical team's concern and to contact the legal department.", "She fired him on the spot.", "She admitted she had never heard of the protest data before."],
        correctIndex: 1,
        explanation:
          "She tells him \"aquello no era asunto del equipo técnico y que, si tenía alguna objeción, debía dirigirse al departamento legal\" — a cold, rehearsed deflection.",
      },
      {
        type: "multiple-choice",
        question: "What did Hugo ultimately do before leaving the company?",
        options: ["He publicly exposed the company to a journalist right away.", "He deleted the algorithm entirely so it could never be used again.", "He resigned citing personal reasons and quietly copied the incriminating records without deciding yet what to do with them.", "He confronted the city officials directly."],
        correctIndex: 2,
        explanation:
          "He \"renunció a su puesto alegando motivos personales y, antes de irse, copió discretamente los registros que había encontrado, sin decidir todavía qué haría con ellos.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She was immediately delighted and used it constantly.", "She viewed it with suspicion and left it almost switched off in a corner.", "She tried to return it to the store the same day.", "She reprogrammed it to sound like her late husband."],
        correctIndex: 1,
        explanation:
          "The text says the robot \"permaneció casi apagado en un rincón del salón, como un mueble más\" and that Elena \"desconfiaba de su voz sintética.\"",
      },
      {
        type: "multiple-choice",
        question: "What began to trouble Elena about her growing routine with Rodi?",
        options: ["The robot's voice kept malfunctioning and frightening her.", "She realized her children were becoming jealous of the machine.", "She caught herself wishing the machine could truly sit at the table with her instead of her son visiting.", "The robot started giving her incorrect medical advice."],
        correctIndex: 2,
        explanation:
          "After her son cancels his visit again, she wishes \"que Rodi pudiera sentarse de verdad a la mesa con ella,\" and wonders if a machine was filling gaps that people should fill.",
      },
      {
        type: "multiple-choice",
        question: "What did Elena's granddaughter confess when Elena shared her discomfort?",
        options: ["That she had never actually used a companion app herself.", "That she too sometimes preferred talking to apps and automated chats over calling real friends.", "That the robot had been a mistake and she would take it back.", "That she planned to move in with Elena permanently."],
        correctIndex: 1,
        explanation:
          "The granddaughter admits she \"algunas noches, prefería hablar con aplicaciones y chats automáticos antes que llamar a sus propios amigos,\" showing this wasn't just a generational issue.",
      },
      {
        type: "multiple-choice",
        question: "What did Elena decide to do after that conversation?",
        options: ["She got rid of Rodi entirely and refused to speak to it again.", "She set clear limits with Rodi and also started calling old friends again, despite awkward silences.", "She asked her granddaughter to buy her a second, more advanced robot.", "She moved into a retirement home to be around more people."],
        correctIndex: 1,
        explanation:
          "She \"empezó a poner límites claros\" with Rodi and \"volvió a llamar por teléfono a viejas amigas,\" preferring \"una conversación imperfecta con alguien vivo antes que una conversación perfecta\" with the machine.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The brakes failed completely in cold weather.", "At sunset, under a specific light angle, the sensor took an extra fraction of a second to recognize pedestrians.", "The GPS system misread street names in foreign languages.", "The car's battery caught fire after long charges."],
        correctIndex: 1,
        explanation:
          "She found that \"cuando la luz del atardecer incidía sobre el sensor desde cierto ángulo, el vehículo tardaba una fracción de segundo de más en reconocer a un peatón cruzando la calzada.\"",
      },
      {
        type: "multiple-choice",
        question: "How did the company's leadership justify continuing with the launch?",
        options: ["They claimed the flaw had already been completely fixed.", "They said the risk affected a statistically small percentage of situations and a software update would come in a few months.", "They denied the flaw existed at all.", "They promised to recall every unit immediately."],
        correctIndex: 1,
        explanation:
          "They tell her \"el problema afectaba a un porcentaje estadísticamente muy bajo de situaciones\" and that an update \"corregiría el fallo en un plazo de unos meses.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Marta's old professor advise her to do?",
        options: ["Go straight to the press with the information.", "Quit her job immediately in protest.", "Insist through internal channels and document everything, given the risk of legal consequences from her confidentiality agreement.", "Sabotage the software before launch."],
        correctIndex: 2,
        explanation:
          "He warns that going outside the company \"podría acarrearle consecuencias legales serias\" and suggests she \"insistiera internamente y documentara cada paso.\"",
      },
      {
        type: "multiple-choice",
        question: "How does the story end?",
        options: ["The launch is cancelled at the last minute.", "Marta is fired for raising the issue.", "The launch proceeds as planned, and Marta anxiously watches the cars on the street, especially at sunset.", "Marta successfully sues the company and wins damages."],
        correctIndex: 2,
        explanation:
          "The launch happens \"tal como estaba planeado,\" and afterward, seeing the cars especially at sunset, she \"no podía evitar contener la respiración hasta verlo pasar sin incidentes.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To refuse the assignment entirely.", "To be \"understanding\" of inconsistencies given the trauma of Amir's story.", "To translate everything word for word regardless of tone.", "To meet privately with the judge beforehand."],
        correctIndex: 1,
        explanation:
          "The lawyer asks her \"que fuera 'comprensiva' con las inconsistencias que pudieran surgir, dado lo traumático del relato.\"",
      },
      {
        type: "multiple-choice",
        question: "What dilemma did Yolanda face over the ambiguous expression Amir used?",
        options: ["She had to choose between two equally faithful translations, one sounding more coherent and one more hesitant.", "She could not understand the language Amir was speaking.", "She had to decide whether to interrupt the judge.", "She was asked to invent a translation because Amir had gone silent."],
        correctIndex: 0,
        explanation:
          "The expression \"podía traducirse de dos maneras distintas: una que reforzaba la coherencia de su testimonio y otra... que sonaba más vacilante e incierta,\" and she had to pick one.",
      },
      {
        type: "multiple-choice",
        question: "Why did Yolanda choose the more literal translation?",
        options: ["She believed Amir was lying and wanted to expose him.", "She feared losing her job if she didn't.", "She believed that softening people's words would turn her into something other than an interpreter.", "The judge explicitly ordered her to use only literal translations."],
        correctIndex: 2,
        explanation:
          "She reasons that \"si empezaba a suavizar las palabras de las personas a las que interpretaba... dejaría de ser intérprete para convertirse en otra cosa.\"",
      },
      {
        type: "multiple-choice",
        question: "What was the outcome for Amir, and how did Yolanda feel about it?",
        options: ["Amir was denied asylum, and Yolanda regretted her choice permanently.", "Amir was granted asylum thanks largely to documentary evidence, which relieved but did not fully settle Yolanda's unease.", "Amir dropped his case and left the country.", "Yolanda was fired for her literal translation."],
        correctIndex: 1,
        explanation:
          "Amir \"le habían concedido el asilo, gracias sobre todo a pruebas documentales,\" and the news \"la alivió, aunque no borró del todo la incomodidad de aquella tarde.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The prescriptions were clearly forged.", "The visits became more frequent than the treatment should require, and Gonzalo looked increasingly withdrawn.", "Doña Pilar stopped paying for the medication.", "Gonzalo switched to a different pharmacy entirely."],
        correctIndex: 1,
        explanation:
          "Rosa notices \"que las visitas se repetían con una frecuencia mayor de la que el tratamiento debería requerir\" and that Gonzalo had \"una mirada apagada.\"",
      },
      {
        type: "multiple-choice",
        question: "What did doña Pilar confess when Rosa said she needed to verify the prescription?",
        options: ["That the prescription had actually been stolen.", "That she feared her son had a serious problem and the medication now seemed like dependency rather than treatment.", "That Gonzalo no longer lived with her.", "That she had never actually met the prescribing doctor."],
        correctIndex: 1,
        explanation:
          "She confesses she feared Gonzalo had a serious problem and that the medication \"ya no le parecía un tratamiento sino una dependencia.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Rosa ultimately decide to do that day?",
        options: ["She filled the prescription as usual to avoid conflict.", "She called the police immediately.", "She declined to dispense the medication and offered information about a municipal addiction-support program instead.", "She permanently banned doña Pilar from the pharmacy."],
        correctIndex: 2,
        explanation:
          "Rosa decided \"no despachar el medicamento aquel día\" and instead offered \"información sobre un programa municipal de apoyo a familias que atravesaban situaciones de adicción.\"",
      },
      {
        type: "multiple-choice",
        question: "How does the story suggest things had changed when doña Pilar and Gonzalo returned weeks later?",
        options: ["They came to file a formal complaint against Rosa.", "Gonzalo looked thinner but had a different expression in his eyes, and doña Pilar gave Rosa's hand a meaningful squeeze.", "They had moved away and were saying goodbye.", "Gonzalo had become the new pharmacy assistant."],
        correctIndex: 1,
        explanation:
          "Gonzalo appears \"más delgado pero con una expresión distinta en los ojos,\" and doña Pilar \"le apretó la mano a Rosa un instante de más,\" a wordless gesture of gratitude.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Driving the ambulance to the accident scene herself.", "Deciding, with incomplete information and only seconds, who would be treated first.", "Notifying all the families of the victims personally.", "Training new doctors on the spot during the emergency."],
        correctIndex: 1,
        explanation:
          "As the most experienced doctor, she had to \"decidir, con información incompleta y segundos de margen, a quién atender primero.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened with the two children who arrived with similar injuries?",
        options: ["Both survived after Beatriz found a second operating room.", "Beatriz chose the one with more stable vital signs for the only available operating room, and the other child died before a second team could intervene.", "The hospital transferred both to another facility.", "Beatriz refused to choose and let a colleague decide instead."],
        correctIndex: 1,
        explanation:
          "She chose \"al niño cuyos signos vitales, aunque débiles, parecían más estables,\" and \"el segundo niño murió antes de que pudiera intervenirlo un segundo equipo.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Beatriz say to the resident who asked how she managed to decide so quickly?",
        options: ["That she had developed a foolproof formula that removed all doubt.", "That she still felt fear, but had learned to act anyway, since not deciding was itself usually the worst decision.", "That she avoided triage situations whenever possible after that day.", "That the hospital had since banned her from making triage decisions."],
        correctIndex: 1,
        explanation:
          "She admits \"nunca había dejado de sentir ese miedo\" and that she learned \"a actuar de todos modos, porque la alternativa —no decidir— también era, a su manera, una decisión, y casi siempre la peor de todas.\"",
      },
      {
        type: "multiple-choice",
        question: "How does Beatriz relate to the memory of the second child years later?",
        options: ["She has completely forgotten the incident.", "She still visits the child's grave every week in deep guilt.", "She allows the memory to visit her, viewing it as the accepted cost of continuing in her profession rather than a guilt to hide.", "She quit medicine entirely because of it."],
        correctIndex: 2,
        explanation:
          "She lets the memory visit her, \"no como una culpa que debía cargar en silencio, sino como el precio, ya asumido, de haber elegido seguir ejerciendo un oficio que a veces exigía lo imposible.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Evidence that a second council member was also involved.", "A private conversation of an unrelated official, Ricardo, about a personal family crisis.", "Proof that the anonymous source had fabricated everything.", "Her own name mentioned in a threatening message."],
        correctIndex: 1,
        explanation:
          "She found \"una conversación privada, ajena por completo al caso de corrupción, en la que un funcionario de nivel medio... le confesaba a un amigo que estaba atravesando una crisis personal grave.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Nadia's editor suggest she do?",
        options: ["Drop the story entirely to avoid any risk.", "Publish the documents as they were, arguing that editing leaked files could raise doubts about manipulation.", "Contact Ricardo directly for comment before publishing.", "Publish only Ricardo's conversation as a separate story."],
        correctIndex: 1,
        explanation:
          "The editor suggested publishing \"los documentos relevantes tal como estaban,\" arguing that editing them \"podía generar dudas sobre la manipulación de las pruebas.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Nadia ultimately decide regarding Ricardo's information?",
        options: ["She published everything exactly as her editor suggested.", "She removed any reference to Ricardo, even though it meant losing some supporting documentation.", "She contacted Ricardo to ask for his permission first.", "She sold the information to another outlet."],
        correctIndex: 1,
        explanation:
          "She decided to \"eliminar cualquier referencia a Ricardo o a su conversación privada, aunque eso significara renunciar a parte del respaldo documental.\"",
      },
      {
        type: "multiple-choice",
        question: "What principle does the story's ending emphasize about Nadia's decision?",
        options: ["That good journalism always requires publishing every available document.", "That some journalistic decisions are measured not by the outcome, but by what one chooses not to publish even when legally entitled to.", "That Nadia regretted protecting Ricardo's privacy in the end.", "That the editor eventually punished her for the omission."],
        correctIndex: 1,
        explanation:
          "The story closes on the idea that \"algunas decisiones periodísticas no se medían por el resultado obtenido, sino por lo que uno estaba dispuesto a no publicar, aun teniendo el derecho de hacerlo.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Refuse to give any statement at all.", "Say the scaffolding seemed normal, omitting the skipped safety reinforcements.", "Blame Fabián for his own fall.", "Report the incident directly to the press."],
        correctIndex: 1,
        explanation:
          "The manager suggested he state \"que el andamio parecía en condiciones normales antes de la caída, evitando cualquier referencia a las inspecciones de seguridad que se habían saltado.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Fabián ask Ismael to do when he visited him in the hospital?",
        options: ["To keep quiet to protect both their jobs.", "To tell the truth, so that safety measures would actually change afterward.", "To sue the company on his behalf.", "To resign immediately in solidarity with him."],
        correctIndex: 1,
        explanation:
          "Fabián \"le pidió... que dijera la verdad, porque de lo contrario ninguna medida de seguridad cambiaría después del accidente.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Ismael ultimately include in his official statement?",
        options: ["Only what his boss had suggested, to protect his job.", "All the details he witnessed, including the meeting about the reinforcements that were never installed.", "A vague statement that avoided taking any side.", "A statement blaming the equipment manufacturer only."],
        correctIndex: 1,
        explanation:
          "He wrote his statement \"con todos los detalles que había presenciado, incluida la reunión sobre los refuerzos pendientes.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened to Ismael in the months after he gave his honest statement?",
        options: ["He was promoted for his honesty.", "He was sidelined from major projects, treated coldly by colleagues, and eventually left the company on his own terms.", "He was immediately fired and blacklisted from the industry.", "Nothing changed at all in his daily work."],
        correctIndex: 1,
        explanation:
          "He was \"apartado de los proyectos más importantes,\" colleagues grew distant, and \"seis meses después, Ismael decidió dejar la empresa por su propia cuenta.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Designing new social media features.", "Processing families' requests to access, download, or delete the digital accounts of deceased relatives.", "Writing obituaries for a news website.", "Repairing corrupted digital files."],
        correctIndex: 1,
        explanation:
          "Her job was to \"tramitar las solicitudes de familiares que pedían acceder, descargar o eliminar las cuentas digitales de parientes fallecidos.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Cristina find while reviewing Marisol's account?",
        options: ["Evidence of a crime that needed to be reported to police.", "An unsent draft written days before Marisol's death, addressed to her daughter.", "Proof that the account had already been deleted.", "A message revealing Marisol was still alive."],
        correctIndex: 1,
        explanation:
          "She found \"un borrador sin enviar, redactado apenas dos días antes de la muerte de Marisol, dirigido a su hija.\"",
      },
      {
        type: "multiple-choice",
        question: "What made the unsent draft feel different to Cristina from the rest of the account?",
        options: ["It was written in a language Cristina didn't understand.", "Because it was never sent, it seemed to occupy an ambiguous space between belonging to the daughter and remaining a private, unshared thought.", "It was password-protected separately from the rest of the account.", "It contained financial information rather than personal content."],
        correctIndex: 1,
        explanation:
          "The text asks whether the draft \"pertenecía ya a la hija... o seguía siendo, en cierto modo, un pensamiento privado que Marisol nunca había decidido compartir.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Cristina ultimately do with the draft, and how does the story end?",
        options: ["She deleted it against protocol to protect Marisol's privacy.", "She transferred the complete file including the draft, as protocol required, and was left wondering about its effect without ever knowing.", "She sent it herself as a final message to the daughter.", "She resigned rather than make the decision."],
        correctIndex: 1,
        explanation:
          "She \"transfirió el archivo completo, incluido el borrador, tal como establecía el protocolo,\" and \"nunca lo supo con certeza\" what effect it had, since her job ended there.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Store photos in a secure cloud archive.", "Schedule messages to be delivered automatically to specific people at future dates, even after the sender's death.", "Chat live with an AI version of a deceased relative.", "Send anonymous letters to strangers."],
        correctIndex: 1,
        explanation:
          "The app allowed her to \"programar mensajes... para que se entregaran automáticamente a personas concretas en fechas futuras, mucho después de que el remitente hubiera muerto.\"",
      },
      {
        type: "multiple-choice",
        question: "What concern did Susana's husband, Ernesto, raise about the scheduled messages?",
        options: ["That the app was too expensive to justify.", "That receiving a message on a date chosen by Susana, not by the recipient, would reopen a wound at the wrong time.", "That Mateo was too young to understand the messages.", "That the technology was unreliable and messages might get lost."],
        correctIndex: 1,
        explanation:
          "Ernesto tells her \"cada carta sería reabrir la herida en la fecha que tú elegiste, no en la que yo estuviera listo.\"",
      },
      {
        type: "multiple-choice",
        question: "What question did Susana's therapist suggest she should really be asking herself?",
        options: ["Whether Mateo would forgive her for dying.", "Whether she was writing the messages for Mateo's comfort or to calm her own fear of disappearing without a trace.", "Whether the app was secure enough to protect her privacy.", "Whether she should tell Mateo about the diagnosis at all."],
        correctIndex: 1,
        explanation:
          "The therapist suggests the real question was \"para quién los estaba escribiendo realmente: si para dar consuelo a Mateo o para calmar su propio miedo a desaparecer sin dejar rastro.\"",
      },
      {
        type: "multiple-choice",
        question: "What compromise did Susana ultimately reach about the messages?",
        options: ["She abandoned the project entirely.", "She recorded five messages that would only be delivered if Mateo actively requested them as an adult, rather than automatically.", "She had Ernesto choose when Mateo would receive each message.", "She recorded a single long message covering every future milestone."],
        correctIndex: 1,
        explanation:
          "She recorded messages \"programado para entregarse solo si Mateo, ya adulto, decidía activamente solicitarlos,\" rather than at fixed automatic dates.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He wanted to buy the apartment back from its current owners.", "He found a childhood drawing with a note about a hidden treasure behind an electrical outlet.", "He was asked to appraise the building's value for a sale.", "His mother asked him to retrieve important documents."],
        correctIndex: 1,
        explanation:
          "He found a note reading \"Aquí escondí el tesoro, detrás del enchufe de mi cuarto,\" written in his own childhood handwriting.",
      },
      {
        type: "multiple-choice",
        question: "What did Álvaro recognize as unchanged when he entered his old bedroom?",
        options: ["The exact same furniture was still there.", "The position of the window and the way afternoon light entered the room.", "A mural he had painted as a child.", "The wallpaper his mother had chosen."],
        correctIndex: 1,
        explanation:
          "He recognized \"la disposición de la ventana y el ángulo exacto en que entraba la luz por las tardes,\" something no redecoration had erased.",
      },
      {
        type: "multiple-choice",
        question: "What did Álvaro find behind the outlet?",
        options: ["A significant sum of hidden money.", "Old marbles, a golden button, and a small photo of his father smiling.", "A letter his father had written to him before dying.", "Nothing at all — the hiding spot was empty."],
        correctIndex: 1,
        explanation:
          "He found \"tres canicas gastadas, un botón dorado y una fotografía pequeña de su padre sonriendo.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Álvaro conclude he had really come to find?",
        options: ["Financial compensation for his family's old belongings.", "Not a hidden object, but confirmation that certain places still hold the shape of who we once were.", "Proof that his childhood memories had been false.", "A reason to convince his mother to move back to the neighborhood."],
        correctIndex: 1,
        explanation:
          "He understood that what he'd come for was \"la confirmación de que ciertos lugares... siguen guardando, en algún rincón invisible, la forma exacta de quienes fuimos alguna vez.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She needed them for a legal case related to the accident.", "Her camera became the only reliable source of what had happened during years she could no longer remember.", "She was planning a retrospective exhibition of her work.", "The photos were the only copies left after a house fire."],
        correctIndex: 1,
        explanation:
          "The text says her camera \"se convirtió en la única fuente fiable de lo que le había ocurrido\" during the years she couldn't remember.",
      },
      {
        type: "multiple-choice",
        question: "What did Renata's sister reveal about the man in the beach photos?",
        options: ["He was a colleague from a photography workshop.", "He was someone Renata had dated intensely, and the relationship had ended badly shortly before the accident.", "He was a stranger who had photobombed her pictures.", "He was Renata's therapist."],
        correctIndex: 1,
        explanation:
          "Her sister explains it was \"alguien con quien Renata había mantenido una relación breve pero intensa, que había terminado mal apenas dos meses antes del accidente.\"",
      },
      {
        type: "multiple-choice",
        question: "What dilemma did Renata face regarding investigating the relationship further?",
        options: ["Whether to confront the man legally for emotional damages.", "Whether to respect her past self's wish never to discuss him again, or to investigate on her own behalf as someone with no memory of the pain.", "Whether to delete all evidence of the relationship immediately.", "Whether to publish the photos publicly for closure."],
        correctIndex: 1,
        explanation:
          "She wonders whether to \"respetar la voluntad de una versión anterior de sí misma\" or to investigate as \"superviviente de aquel dolor olvidado.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Renata change her approach to photography by a year after the accident?",
        options: ["She stopped taking photographs entirely.", "She began writing brief notes alongside some images about what she felt taking them, wanting to preserve meaning, not just images.", "She switched to only photographing landscapes, never people.", "She hired an assistant to organize her memories for her."],
        correctIndex: 1,
        explanation:
          "She \"empezó a escribir, junto a algunas imágenes, breves notas sobre lo que sentía al tomarlas,\" preferring to preserve meaning in case she lost her memory again.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To leave instructions for her husband about household finances.", "So her future self could listen and briefly recognize who she had been before losing certain memories.", "Because her doctor required it as part of a clinical trial.", "To create content for a public awareness campaign about Alzheimer's."],
        correctIndex: 1,
        explanation:
          "She wanted her future self to \"pudiera escucharlas y reconocer, aunque fuera brevemente, quién había sido antes de perder ciertos recuerdos.\"",
      },
      {
        type: "multiple-choice",
        question: "Why was Joaquín initially reluctant about the recording project?",
        options: ["He thought it was a waste of time and money.", "He feared it would constantly remind Marina of what she was about to lose.", "He didn't believe technology could help with memory loss.", "He wanted Marina to focus on medical treatment instead."],
        correctIndex: 1,
        explanation:
          "He feared \"aquel proyecto no hiciera sino recordarle constantemente a Marina lo que estaba a punto de perder.\"",
      },
      {
        type: "multiple-choice",
        question: "What sometimes happened when Marina listened to the recordings as her illness progressed?",
        options: ["She always immediately recognized her own voice with joy.", "Sometimes, confused, she couldn't understand why a stranger was speaking to her so familiarly, and Joaquín had to explain.", "The recordings caused her physical pain.", "She stopped listening to them altogether after a year."],
        correctIndex: 1,
        explanation:
          "Some afternoons \"Marina, confundida, no lograba entender por qué una desconocida le hablaba con tanta familiaridad,\" and Joaquín had to explain it was her own voice.",
      },
      {
        type: "multiple-choice",
        question: "What did the recording project ultimately achieve, according to the ending?",
        options: ["It fully restored Marina's lost memories.", "It failed completely and the family abandoned it.", "Even after she no longer recognized her own voice, it ensured she still felt accompanied by someone who loved her each night.", "It became a commercial product the family sold to other families."],
        correctIndex: 2,
        explanation:
          "Joaquín reflects that the project \"había logrado... asegurarse de que, incluso perdida la memoria, ella nunca dejara de sentirse, cada noche, acompañada por alguien que la quería.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Dani confessed it to him first without being asked.", "A reverse image search showed the photo belonged to a teenager from another country with an unrelated social media profile.", "A classmate recognized Dani in person.", "The forum administrators banned Dani's account publicly."],
        correctIndex: 1,
        explanation:
          "Using \"una búsqueda inversa,\" Nico found the photo \"pertenecía en realidad a un adolescente de otro país, cuya cuenta pública de redes sociales no tenía nada que ver con el perfil que Dani usaba.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Dani confess when Nico confronted him?",
        options: ["That he was actually Nico's classmate playing a prank.", "That he was thirty-four years old and had been talking to several teenagers under the false identity of Dani.", "That the entire forum was run by a company for advertising purposes.", "That he had never actually spoken to Nico and it was a different person now."],
        correctIndex: 1,
        explanation:
          "Dani admitted \"que en realidad tenía treinta y cuatro años, que llevaba tiempo hablando con varios adolescentes bajo la identidad falsa de Dani.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Nico feel in the weeks after discovering the truth?",
        options: ["Relieved and completely unaffected, since he'd expected it all along.", "A strange sense of grief, as if he had lost someone real despite knowing that person never existed as he knew them.", "Angry only at himself, with no sadness at all.", "Excited to find a new online friend immediately."],
        correctIndex: 1,
        explanation:
          "He felt \"una sensación extraña de duelo, como si hubiera perdido a alguien real a pesar de saber que esa persona jamás había existido tal como él la conocía.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Nico's mother reveal when he finally told her about Dani?",
        options: ["That she had already suspected something was wrong and had been monitoring him.", "That she, too, as a teenager, had felt that same desperate need to find someone who understood her.", "That she would report the incident to the police immediately.", "That she forbade him from using the internet again."],
        correctIndex: 1,
        explanation:
          "She confessed \"que ella también, de adolescente, había sentido esa misma necesidad desesperada de encontrar a alguien que la entendiera.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Valeria left her post early without permission.", "An eight-year-old boy stopped moving in the water for several terrifying seconds before Valeria pulled him out.", "A storm forced the pool to close suddenly.", "Valeria's whistle broke during an emergency."],
        correctIndex: 1,
        explanation:
          "A boy \"dejó de moverse en el agua durante unos segundos que a ella le parecieron eternos,\" and Valeria dove in to rescue him.",
      },
      {
        type: "multiple-choice",
        question: "What did Valeria's supervisor tell her that night?",
        options: ["That she should be fired for not noticing sooner.", "That no lifeguard can watch every swimmer every second, and what matters is the speed of reaction when something happens.", "That the pool would install more cameras because of the incident.", "That she should switch to a different, less demanding job."],
        correctIndex: 1,
        explanation:
          "He explains that \"ningún socorrista, por muy atento que fuera, podía vigilar cada segundo a cada bañista, y que lo importante no era la imposible perfección, sino la rapidez de reacción.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Valeria's mother tell her about becoming an adult?",
        options: ["That adulthood means never feeling fear again.", "That becoming an adult doesn't mean the fear disappears, but learning to act correctly despite feeling it.", "That she should quit the job immediately for her own safety.", "That fear was a sign she wasn't ready for responsibility."],
        correctIndex: 1,
        explanation:
          "Her mother tells her \"que convertirse en adulta no significaba dejar de tener miedo, sino aprender a actuar correctamente a pesar de sentirlo.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Valeria's relationship to her whistle change by the end of summer?",
        options: ["She stopped wearing it altogether, finding it unnecessary.", "It went from being a simple uniform accessory to a silent reminder of what was at stake.", "She had it replaced with a more modern safety device.", "She gave it away to a younger trainee as a gift."],
        correctIndex: 1,
        explanation:
          "She \"dejó de ver el silbato colgado de su cuello como un simple accesorio del uniforme y empezó a sentirlo... como un recordatorio silencioso de lo que estaba en juego.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He refused to attend classes regularly.", "His Spanish was insufficient for the speed at which his classmates spoke, leaving him isolated during breaks.", "The school had no Spanish classes available for him.", "He was bullied by a specific group of students."],
        correctIndex: 1,
        explanation:
          "His Spanish \"resultó insuficiente frente a la rapidez con la que hablaban sus nuevos compañeros,\" and \"Bayo pasaba los recreos solo.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Bayo and Marisela share as their conversations deepened?",
        options: ["Only grammar corrections and vocabulary lists.", "Bayo shared the difficulty of always feeling like \"the new kid,\" and Marisela shared the pressure to learn perfect English for her parents.", "Plans to meet in person during summer vacation.", "Complaints about their respective teachers."],
        correctIndex: 1,
        explanation:
          "Bayo told her about feeling like \"'el nuevo'... el que se equivocaba de verbo en cada frase,\" while Marisela spoke of \"la presión de sus padres para que aprendiera un inglés perfecto.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened after Bayo's classmate asked who he was talking to?",
        options: ["The classmate mocked him and told others.", "The classmate asked to be shown the app, marking the start of Bayo's first real friendship at his new school.", "The classmate reported him to a teacher for being on his phone.", "Nothing changed; the classmate lost interest immediately."],
        correctIndex: 1,
        explanation:
          "The classmate \"le pidió que le enseñara la aplicación, y esa conversación se convirtió... en el inicio de la primera amistad real que Bayo hacía en su nuevo instituto.\"",
      },
      {
        type: "multiple-choice",
        question: "What had Bayo's friendship with Marisela become by the end of the story?",
        options: ["It ended once Bayo no longer needed to practice Spanish.", "Something no longer dependent on language practice, but on the simple habit of telling each other how life was really going.", "A romantic relationship that led them to plan a trip together.", "A business partnership to create their own language app."],
        correctIndex: 1,
        explanation:
          "The friendship \"se había convertido en algo que ya no dependía del idioma que ambos hablaran, sino de la sencilla costumbre de contarse, cada semana, cómo les iba realmente la vida.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["They were assigned as lab partners in chemistry class.", "They coincidentally ended up on the same team in an online video game and formed an effective duo.", "Curro's parents asked Teo to check in on their son.", "They met at a summer sports camp."],
        correctIndex: 1,
        explanation:
          "They \"coincidieron en la misma partida y... formaron un equipo tan eficaz que decidieron seguir jugando juntos las noches siguientes.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Curro confess to Teo one night about why he was playing so much?",
        options: ["That he was trying to become a professional gamer.", "That his parents were constantly arguing and likely to separate, and gaming was the only time he didn't think about it.", "That he had failed several classes and was avoiding his homework.", "That he was being bullied by other players online."],
        correctIndex: 1,
        explanation:
          "Curro explains \"que sus padres llevaban meses discutiendo constantemente en casa, que probablemente se separarían pronto, y que las horas que pasaba jugando eran... las únicas horas del día en que lograba no pensar en ello.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Teo do when he grew worried about Curro's declining state?",
        options: ["He ignored it, not wanting to get involved.", "He confronted Curro angrily during a game.", "He spoke carefully with the school counselor about the situation.", "He told Curro's parents directly without telling Curro first."],
        correctIndex: 2,
        explanation:
          "Teo \"decidió hablar con el tutor del instituto,\" explaining the situation \"con cuidado, sin exagerar pero sin restarle importancia tampoco.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Curro initially react upon learning Teo had spoken to the tutor?",
        options: ["He was immediately grateful and thanked Teo in person.", "He avoided Teo for a few days, feeling exposed, before eventually thanking him.", "He reported Teo to the school for interfering.", "He stopped playing video games altogether in anger."],
        correctIndex: 1,
        explanation:
          "Curro \"evitó a Teo tanto en clase como en el juego, sintiéndose expuesto,\" before finally messaging him: \"gracias por preocuparte, aunque me costó admitirlo.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A love letter revealing Noelia's secret relationship.", "A printed copy of questions matching, almost word for word, those on the final exam.", "Evidence that Noelia had been skipping school.", "A diary describing Noelia's plans to move abroad."],
        correctIndex: 1,
        explanation:
          "She found \"una copia impresa de varias preguntas que coincidían, casi palabra por palabra, con las que habían aparecido en el examen final.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Noelia confess when confronted by Águeda?",
        options: ["That she had stolen the questions from a teacher's desk herself.", "That her father had obtained the questions, and she agreed to study them despite knowing it was unfair, out of fear of disappointing her family.", "That she had never actually seen the leaked questions before the exam.", "That another classmate had forced her to cheat."],
        correctIndex: 1,
        explanation:
          "Noelia confessed \"que su padre había conseguido las preguntas... pero que ella había aceptado estudiarlas de todos modos... porque tenía demasiado miedo de decepcionar a su familia.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Águeda ultimately report her suspicions?",
        options: ["She posted about it publicly on social media.", "She went to the school administration and raised general suspicions about a leak, without naming Noelia directly.", "She refused to say anything and let the matter drop entirely.", "She anonymously mailed the evidence to a newspaper."],
        correctIndex: 1,
        explanation:
          "She spoke to the school \"no para acusar directamente a Noelia por su nombre, sino para plantear, de manera general, sus sospechas sobre una posible filtración.\"",
      },
      {
        type: "multiple-choice",
        question: "What was the ultimate cost of Águeda's decision, according to the ending?",
        options: ["She lost the scholarship entirely as punishment for reporting it.", "She won the scholarship, but the friendship never fully recovered, leaving a bittersweet feeling rather than pure satisfaction.", "Both girls were expelled from school.", "Noelia's father was arrested and the school was shut down."],
        correctIndex: 1,
        explanation:
          "Águeda received the scholarship, but \"la amistad entre ambas nunca se recuperó del todo,\" and she felt she had won it \"con un sabor que no era exactamente el que había imaginado.\"",
      },
    ],
  },
];
