...
export const B1_LESSONS: Lesson[] = [
  {
    "slug": "present-subjunctive-formation",
    "level": "B1",
    "number": 1,
  ...
  {
    "slug": "subjunctive-wishes-doubt-emotion",
    "level": "B1",
    "number": 2,
    "title": "Subjunctive with Wishes, Doubt & Emotion",
  ...
  },
  {
    ...
    "exercises": [
      ...
      },
      {
        ...
        "altAnswers": ["Me sorprende que ellos no hayan llamado."],
      ...
      },
      {
        ...
        "altAnswers": ["It's a shame you still haven't found a job.", "What a pity you haven't found work yet."],
        "explanation": "\"Qué lástima que\" expresa una reacción emocional y requiere subjuntivo: encuentres."
      },
      {
        "type": "word-order",
        "prompt": "Ordena las palabras.",
        "words": ["Nos", "molesta", "que", "los", "vecinos", "hagan", "tanto", "ruido"],
      ...
      },
      {
        ...
        "instructions": "Empareja cada palabra con su significado.",
        "pairs": [
          { "left": "afirmar", "right": "to affirm" },
          { "left": "la certeza", "right": "the certainty" },
          { "left": "cuestionable", "right": "questionable" },
          { "left": "objetivo", "right": "objective" },
          { "left": "subjetivo", "right": "subjective" },
          { "left": "sin duda", "right": "without a doubt" },
          { "left": "reconsiderar", "right": "to reconsider" },
          { "left": "el hecho", "right": "the fact" },
          { "left": "improbable", "right": "improbable" },
          { "left": "estar en desacuerdo", "right": "to disagree" }
        ],
      ...
      },
      {
        ...
        "options": ["cometí", "cometo", "cometa", "cometiendo"],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": ["esperar", "es obvio que", "sorprender", "estar seguro de que"],
        "correctIndexes": [0, 2],
      ...
      },
      {
        "type": "word-order",
        "prompt": "Ordena las palabras.",
        "words": ["Qué", "bueno", "que", "hayan", "llegado", "sin", "problemas"],
      ...
      },
      {
        ...
        "options": ["terminamos", "terminemos", "terminar", "terminaríamos"],
        "correctIndex": 1,
  ...
  {
    "slug": "subjunctive-impersonal-ojala",
    "level": "B1",
    "number": 4,
    "title": "Subjunctive with Impersonal Expressions & Ojalá",
  ...
  {
    "slug": "commands-imperative",
    "level": "B1",
    "number": 5,
    "title": "Commands: Tú, Usted, Nosotros & Negatives",
  ...
  {
    "slug": "si-clauses-simple",
    "level": "B1",
    "number": 7,
    "title": "Simple If-Clauses: Si + Presente",
  ...
  },
  {
    ...
    "level": "B1",
    "number": 10,
    "title": "Relative Pronouns: Que, Quien, El Que, Lo Que",
  ...
  },
  {
    ...
    "exercises": [
      ...
      },
      {
        ...
        "altAnswers": ["La casa que compramos el año pasado necesita reparación."],
      ...
      },
      {
        ...
        "altAnswers": ["What annoys me is lateness.", "What bothers me is people being late."],
        "explanation": "\"Lo que\" se refiere a una idea abstracta (\"lo que me molesta\"), no a un sustantivo específico."
      },
      {
        "type": "word-order",
        "prompt": "Ordena las palabras.",
        "words": ["La", "razón", "por", "la", "que", "renuncié", "es", "personal"],
      ...
      },
      {
        "type": "word-order",
        "prompt": "Ordena las palabras.",
        "words": ["Mi", "vecino", "quien", "es", "abogado", "me", "ayudó", "con", "el", "contrato"],
      ...
      },
      {
        ...
        "instructions": "Empareja cada palabra con su significado.",
        "pairs": [
          { "left": "el rascacielos", "right": "the skyscraper" },
          { "left": "el ayuntamiento", "right": "the city hall" },
          { "left": "la parada de autobús", "right": "the bus stop" },
          { "left": "seguir derecho", "right": "to go straight" },
          { "left": "a la izquierda", "right": "to the left" },
          { "left": "el estacionamiento", "right": "the parking lot" },
          { "left": "la multa", "right": "the fine / ticket" },
          { "left": "residencial", "right": "residential" },
          { "left": "el centro histórico", "right": "the historic center" },
          { "left": "mudarse a", "right": "to move to" }
        ],
      ...
      },
      {
        ...
        "pairs": [
          { "left": "Referirse a una persona después de una preposición", "right": "quien / quienes" },
          { "left": "Referirse a una idea abstracta, no a un sustantivo específico", "right": "lo que" },
          { "left": "Referirse a personas o cosas sin preposición (el caso más común)", "right": "que" },
          { "left": "Dar énfasis o evitar ambigüedad, concordando en género y número", "right": "el que / la que / los que / las que" }
        ],
      ...
      },
      {
        ...
        "altAnswers": ["La colega con quien viajé habla cuatro idiomas."],
      ...
      },
      {
        ...
        "options": ["que", "quien", "lo que", "el que"],
        "correctIndex": 2,
...
{
  "slug": "combined-object-pronouns",
  "level": "B1",
  "number": 13,
  "title": "Pronombres de Objeto Combinados",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "¿Me prestas tu bolígrafo? —Sí, te lo presto.", "en": "Will you lend me your pen? —Yes, I'll lend it to you." },
        { "es": "Necesito la contraseña. ¿Me la puedes dar?", "en": "I need the password. Can you give it to me?" },
        { "es": "Siempre nos cuenta sus historias. Siempre nos las cuenta.", "en": "He always tells us his stories. He always tells them to us." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "¿Le diste la carta a Juan? —Sí, se la di.", "en": "Did you give Juan the letter? —Yes, I gave it to him." },
        { "es": "¿Les compraste los boletos a tus padres? —Sí, se los compré.", "en": "Did you buy your parents the tickets? —Yes, I bought them for them." },
        { "es": "Le expliqué el problema a mi jefa. Se lo expliqué con calma.", "en": "I explained the problem to my boss. I explained it to her calmly." },
        { "es": "Nunca les cuentan la verdad a los niños. Nunca se la cuentan.", "en": "They never tell the children the truth. They never tell it to them." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Cuál oración es correcta?",
          "options": ["Le lo di ayer.", "Se lo di ayer.", "Lo le di ayer.", "Se le di ayer."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "Te lo voy a explicar. / Voy a explicártelo.", "en": "I'm going to explain it to you." },
        { "es": "Nos las está preparando. / Está preparándonoslas.", "en": "She is preparing them for us." },
        { "es": "¡Dámelo ahora mismo!", "en": "Give it to me right now!" },
    ...
    },
    {
      ...
      "examples": [
        { "es": "MARTA: ¿Me prestaste las llaves del coche ayer?", "en": "Marta: Did you lend me the car keys yesterday?" },
        { "es": "DIEGO: Sí, te las presté por la tarde. ¿No te acuerdas?", "en": "Diego: Yes, I lent them to you in the afternoon. Don't you remember?" },
        { "es": "MARTA: Ah, es verdad. Oye, ¿le devolviste el libro a Ana?", "en": "Marta: Oh, that's right. Hey, did you return the book to Ana?" },
        { "es": "DIEGO: Todavía no. Voy a devolvérselo este fin de semana.", "en": "Diego: Not yet. I'm going to return it to her this weekend." },
        { "es": "MARTA: Perfecto. Y las fotos del viaje, ¿nos las vas a enviar pronto?", "en": "Marta: Perfect. And the trip photos, are you going to send them to us soon?" },
        { "es": "DIEGO: Claro, os las envío en cuanto las tenga editadas.", "en": "Diego: Of course, I'll send them to you all as soon as I have them edited." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
  ...
  "exercises": [
    {
      ...
      "options": ["le las", "se las", "la le", "se los"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "words": ["Se", "la", "expliqué", "con", "mucha", "paciencia"],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "¿Me prestas tu paraguas?", "right": "Sí, te lo presto." },
        { "left": "¿Le diste el recado a tu jefe?", "right": "Sí, se lo di." },
        { "left": "¿Te traigo la cuenta?", "right": "Sí, tráemela, por favor." },
        { "left": "¿Les explicaste la tarea a los estudiantes?", "right": "Sí, se la expliqué." }
      ],
    ...
    },
    {
      ...
      "options": ["Se lo dije ayer.", "Le lo dije ayer.", "Voy a dártelo mañana.", "Voy a te lo dar mañana.", "Dámelo, por favor."],
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "¿Es tu libro? —Sí, es el mío.", "en": "Is it your book? —Yes, it's mine." },
        { "es": "Mi casa es pequeña, pero la tuya es enorme.", "en": "My house is small, but yours is huge." },
        { "es": "Nuestro equipo perdió; el vuestro ganó.", "en": "Our team lost; yours (Spain, plural) won." },
        { "es": "Estos son mis apuntes; esos son los suyos.", "en": "These are my notes; those are theirs." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        ...
        { "es": "De todos los coches del garaje, el mío es el rojo.", "en": "Of all the cars in the garage, mine is the red one." },
        { "es": "Esas llaves no son tuyas; son nuestras.", "en": "Those keys aren't yours; they're ours." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Cuál oración es gramaticalmente correcta?",
          "options": ["Prefiero mío a tuyo.", "Prefiero el mío al tuyo.", "Prefiero lo mío a tuyo.", "Prefiero lo mío a lo tuyo."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "Ana y Luis tienen coches nuevos. El de ella es azul; el de él es negro.", "en": "Ana and Luis have new cars. Hers is blue; his is black." },
        { "es": "¿Esta es la maleta de usted? —No, la mía es la verde; la suya está allí.", "en": "Is this your suitcase (formal)? —No, mine is the green one; yours is over there." },
        { "es": "Si el de Marta no funciona, puede usar el nuestro.", "en": "If Marta's doesn't work, she can use ours." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "LUCÍA: Esta maleta gris, ¿es tuya o mía?", "en": "Lucía: This gray suitcase, is it yours or mine?" },
        { "es": "SARA: Es mía. La tuya es la negra, ¿no te acuerdas?", "en": "Sara: It's mine. Yours is the black one, don't you remember?" },
        { "es": "LUCÍA: Ah, cierto. Oye, ¿estos pasaportes son nuestros o son los de Carlos y Rita?", "en": "Lucía: Oh, right. Hey, are these passports ours or Carlos and Rita's?" },
        { "es": "SARA: El azul es el mío; el rojo debe de ser el tuyo. Los de ellos están en su mochila.", "en": "Sara: The blue one is mine; the red one must be yours. Theirs are in their backpack." },
        { "es": "LUCÍA: Entonces esta chaqueta no es ni la mía ni la tuya... —SARA: Es la suya, de Rita. Se le quedó aquí.", "en": "Lucía: Then this jacket isn't mine or yours... —Sara: It's hers, Rita's. She left it here." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Según el diálogo, ¿de quién es la chaqueta que encontraron?",
          "options": ["De Lucía", "De Sara", "De Rita", "De Carlos"],
          "correctIndex": 2,
  ...
  "exercises": [
    {
      ...
      "options": ["la suyo", "la suya", "el suyo", "la suyas"],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "altAnswers": ["Esta mochila no es la mía; es la tuya."],
    ...
    },
    {
      "type": "word-order",
      "prompt": "Ordena las palabras.",
      "words": ["El", "coche", "rojo", "es", "el", "nuestro"],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "mi", "right": "la mía" },
        { "left": "tu", "right": "la tuya" },
        { "left": "su", "right": "la suya" },
        { "left": "nuestra", "right": "la nuestra" }
      ],
    ...
    },
    {
      ...
      "options": ["Esta bici es la mía.", "Esta bici es la mío.", "Prefiero el tuyo al mío.", "Prefiero tuyo al mío.", "Son las suyas, de ellas."],
      "correctIndexes": [0, 2, 4],
...
},
{
  ...
  "level": "B1",
  "number": 15,
  "title": "El Imperativo de Vosotros",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "¡Chicos, esperad un momento!", "en": "Guys, wait a moment! (Spain)" },
        { "es": "Un profesor en Madrid le dice a la clase: 'Escuchad, por favor', no 'Escuchen'.", "en": "A teacher in Madrid tells the class: 'Listen, please' (vosotros), not 'Escuchen' (ustedes)." },
        { "es": "En España decimos 'Hablad más despacio'; en Latinoamérica se diría 'Hablen más despacio' para el mismo grupo de amigos.", "en": "In Spain we say 'Hablad más despacio'; in Latin America you'd say 'Hablen más despacio' for the same group of friends." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "Un grupo de amigos en Madrid le dice a otro grupo: '¡Entrad!' ¿Qué forma verbal están usando?",
          "options": ["La forma de ustedes", "La forma de vosotros", "La forma de tú", "La forma de nosotros"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "Hablad más alto, no os oigo bien.", "en": "Speak louder, I can't hear you well." },
        { "es": "Comed despacio, hay tiempo de sobra.", "en": "Eat slowly, there's plenty of time." },
        { "es": "Escribid vuestros nombres en la pizarra.", "en": "Write your names on the board." },
        { "es": "Venid a la fiesta el sábado.", "en": "Come to the party on Saturday." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "¡Levantaos, ya es tarde!", "en": "Get up, it's already late!" },
        { "es": "Sentaos, por favor, la reunión va a empezar.", "en": "Sit down, please, the meeting is about to start." },
        { "es": "Vestíos rápido, que perdemos el autobús.", "en": "Get dressed quickly, we're going to miss the bus." },
        { "es": "Idos ya; se está haciendo de noche.", "en": "Go away now; it's getting dark. (irregular: irse)" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Cuál es el mandato correcto de vosotros para 'lavarse las manos'?",
          "options": ["Lavados las manos.", "Lavaos las manos.", "Lavados os las manos.", "Os lavad las manos."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "No habléis todos a la vez.", "en": "Don't all talk at once." },
        { "es": "No comáis tan rápido.", "en": "Don't eat so fast." },
        { "es": "No os preocupéis por eso.", "en": "Don't worry about that." },
        { "es": "No os vayáis todavía.", "en": "Don't leave yet." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "¡Venga, niños, levantaos ya! No os quedéis en la cama.", "en": "Come on, kids, get up already! Don't stay in bed." },
        { "es": "Vestíos rápido y no olvidéis los abrigos.", "en": "Get dressed quickly and don't forget your coats." },
        { "es": "Comed el desayuno, no salgáis con el estómago vacío.", "en": "Eat breakfast, don't leave with an empty stomach." },
        { "es": "Coged las mochilas y no las dejéis tiradas por ahí.", "en": "Grab your backpacks and don't leave them lying around." },
        { "es": "Y por favor, ¡no os peleéis en el coche!", "en": "And please, don't fight in the car!" }
      ],
      "checkpoint": [
        {
          "type": "multi-select",
          "question": "¿Cuáles de estas frases del monólogo usan la forma NEGATIVA del mandato de vosotros? (Elige todas las correctas)",
          "options": ["Levantaos ya", "No os quedéis en la cama", "Vestíos rápido", "No olvidéis los abrigos", "No os peleéis en el coche"],
  ...
  "exercises": [
    {
      ...
      "options": ["escribid", "escribed", "escribir", "escribáis"],
      "correctIndex": 0,
    ...
    },
    {
      ...
      "altAnswers": ["No lleguéis tarde, chavales."],
    ...
    },
    {
      ...
      "words": ["No", "os", "preocupéis", "por", "nada"],
    ...
    },
    {
      ...
      "pairs": [
        { "left": "hablar", "right": "hablad" },
        { "left": "comer", "right": "comed" },
        { "left": "vivir", "right": "vivid" },
        { "left": "irse", "right": "idos" },
        { "left": "levantarse", "right": "levantaos" }
      ],
    ...
    },
    {
      ...
      "options": ["Sentaos aquí.", "Sentados aquí.", "No habléis tan alto.", "No hablad tan alto.", "Idos de aquí."],
      "correctIndexes": [0, 2, 4],
...
{
  "slug": "subjunctive-formation-drill",
  "level": "B1",
  "number": 16,
  "title": "Formación del Subjuntivo: Práctica Extra",
...
{
  "slug": "subjunctive-wishes-doubt-emotion-drill",
  "level": "B1",
  "number": 17,
  "title": "Subjuntivo con Deseos, Duda y Emoción: Práctica Extra",
...
{
  "slug": "subjunctive-impersonal-ojala-drill",
  "level": "B1",
  "number": 18,
  "title": "Subjuntivo con Expresiones Impersonales y Ojalá: Práctica Extra",
...
},
{
  ...
  "level": "B1",
  "number": 19,
  "title": "Los Mandatos: Práctica Extra",
...
{
  "slug": "conditional-tense-drill",
  "level": "B1",
  "number": 20,
  "title": "El Condicional: Práctica Extra",
...
{
  "slug": "si-clauses-drill",
  "level": "B1",
  "number": 21,
  "title": "Oraciones con Si: Práctica Extra",
...
{
  "slug": "present-past-perfect-drill",
  "level": "B1",
  "number": 22,
  "title": "El Pretérito Perfecto y el Pluscuamperfecto: Práctica Extra",
...
{
  "slug": "relative-pronouns-drill",
  "level": "B1",
  "number": 23,
  "title": "Los Pronombres Relativos: Práctica Extra",
...
{
  "slug": "passive-voice-possessive-pronouns-drill",
  "level": "B1",
  "number": 24,
  "title": "Voz Pasiva y Pronombres Posesivos: Práctica Extra",
  ...
  {
    "slug": "b1-vocabulary-practice-part-1",
    "level": "B1",
    "number": 25,
    "title": "B1 Vocabulary Practice (Part 1 of 2)",
  ...
  {
    "slug": "b1-vocabulary-practice-part-2",
    "level": "B1",
    "number": 26,
    "title": "B1 Vocabulary Practice (Part 2 of 2)",
    "summary": "Test yourself on all 500 words from the B1 vocabulary lists, grouped by lesson.",
    "duration": "38 min",
    "sections": [
      {
    ...
    exercises: [
      {
        ...
        options: ["They wanted to avoid other hikers", "Valentina thought there was a better view down a side path", "Diego needed to make a phone call", "They were looking for a place to camp"],
        correctIndex: 1,
        explanation:
          "Valentina says the side path \"probablemente llevaba a una vista mejor\" (probably led to a better view) of the lake.",
      },
      {
        type: "multiple-choice",
        question: "What advice did Camila remember for getting unlost in the mountains?",
        options: ["Climb to the highest point", "Stay perfectly still and wait for help", "Follow water downhill because it leads to valleys and roads", "Follow the direction of the wind"],
        correctIndex: 2,
        explanation:
          "Camila recalls that \"el agua siempre baja hacia los valles, donde suele haber caminos y gente.\"",
      },
      {
        type: "multiple-choice",
        question: "Who eventually helped the group find the main trail again?",
        options: ["A group of park rangers", "A local farmer", "Another group of hikers", "A helicopter rescue team"],
        correctIndex: 0,
        explanation:
          "The text says \"Era un grupo de guardaparques que hacía su ronda diaria\" who guided them back to the trail.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["An online contest advertisement", "A sign in a café window announcing a talent night", "A flyer at his school", "A message from a friend"],
        correctIndex: 1,
        explanation:
          "He sees a sign that reads \"Noche de talentos: los jueves a las ocho\" and decides to sign up.",
      },
      {
        type: "multiple-choice",
        question: "What did Rodrigo's song describe?",
        options: ["His guitar", "His sister Isabel", "The sea near his city", "His grandmother's kitchen"],
        correctIndex: 2,
        explanation:
          "The story says he wrote \"una composición propia que había escrito sobre el mar de su ciudad.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened right after Rodrigo finished his song?",
        options: ["Everyone left the café", "There was a brief silence, then the whole café applauded", "Teresa asked him to stop", "He forgot the last verse"],
        correctIndex: 1,
        explanation:
          "The text says \"hubo un momento de silencio... Después, el café entero explotó en aplausos.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Only on Sundays at noon", "Every day at midnight", "Tuesdays and Fridays, early in the morning before sunrise", "Only during full moons"],
        correctIndex: 2,
        explanation:
          "She noted the gifts \"siempre aparecían los martes y los viernes por la mañana, muy temprano, antes de que saliera el sol.\"",
      },
      {
        type: "multiple-choice",
        question: "Why did Tomás leave the gifts secretly?",
        options: ["He wanted to win a prize", "He was continuing a tradition his late grandmother had started", "He was trying to apologize to a neighbor", "He was collecting money for charity"],
        correctIndex: 1,
        explanation:
          "Tomás explains his grandmother believed helping others without expecting anything back was important, and he continued her tradition.",
      },
      {
        type: "multiple-choice",
        question: "What did Tomás eventually do at the town's plaza anniversary party?",
        options: ["He gave a musical performance", "He publicly told everyone his story", "He moved away from the town", "He asked Lucía to keep helping him secretly forever"],
        correctIndex: 1,
        explanation:
          "The text says \"Tomás finalmente decidió contar su historia frente a todos.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To cook his grandmother's recipes", "To copy the recipes of a famous TV chef", "To invent a completely new dish", "To ask his mother to cook for him"],
        correctIndex: 1,
        explanation:
          "The text says he thought \"la mejor estrategia era copiar exactamente sus recetas\" (of the famous TV chef).",
      },
      {
        type: "multiple-choice",
        question: "What went wrong with his dish in the first round?",
        options: ["He burned the pasta", "He used the wrong pan", "He added too much salt", "He forgot an ingredient entirely"],
        correctIndex: 2,
        explanation:
          "The story says \"se equivocó con las cantidades de sal y el plato quedó demasiado salado.\"",
      },
      {
        type: "multiple-choice",
        question: "What dish did Andrés cook for the second round, and how did the judge react?",
        options: ["Italian pasta again; she was unimpressed", "His grandmother's mole; she said it tasted like tradition and love", "A French dessert; she asked for the recipe", "Tamales; she said they needed more spice"],
        correctIndex: 1,
        explanation:
          "Chef Patricia tastes his mole and says, \"Esto sabe a tradición, a historia y a amor.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The lack of food", "Everyone talking at once, hugging constantly, and late dinners", "Having to cook for herself", "Not being allowed to go to school"],
        correctIndex: 1,
        explanation:
          "The text says \"Todos hablaban al mismo tiempo, se abrazaban constantemente\" and dinner was served \"a las nueve o diez de la noche.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Camila tell Yuki was important?",
        options: ["That Yuki should just stay silent and adapt", "That Yuki should tell them when something made her uncomfortable", "That Yuki should go back to Japan", "That Yuki needed to learn to cook Argentine food immediately"],
        correctIndex: 1,
        explanation:
          "Camila says, \"Es importante que nos digas cuando algo te incomode.\"",
      },
      {
        type: "multiple-choice",
        question: "How had Yuki changed by the end of her exchange?",
        options: ["She refused to hug anyone", "She hugged everyone freely and joined in soccer conversations", "She stopped eating dinner with the family", "She moved out to live alone"],
        correctIndex: 1,
        explanation:
          "The text says \"Yuki ya abrazaba a todos sin pensarlo dos veces y participaba activamente en las discusiones sobre fútbol.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Only girls could play", "Players from Águilas and Halcones had to form one combined team", "The match had to be played without a referee", "Ticket sales would fund new team uniforms"],
        correctIndex: 1,
        explanation:
          "The rivals had to combine into one team: \"los jugadores de Águilas y Halcones tendrían que combinarse en un solo equipo mixto.\"",
      },
      {
        type: "multiple-choice",
        question: "Where did Sebastián and Nicolás first have an honest conversation?",
        options: ["In the coach's office", "At a bus stop", "During the final match", "At the hospital"],
        correctIndex: 1,
        explanation:
          "The text says \"Sebastián y Nicolás coincidieron en la misma parada de autobús\" and began talking honestly.",
      },
      {
        type: "multiple-choice",
        question: "What was the outcome of the charity match?",
        options: ["The team lost badly", "The team won 3-1 and raised more money than expected for the hospital", "The match was cancelled due to rain", "Sebastián quit the team"],
        correctIndex: 1,
        explanation:
          "The story states \"El equipo ganó el partido tres a uno\" and they raised more money than expected for the children's hospital.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To buy a new phone", "To save up for a new bicycle", "To pay for school supplies", "To help his mother with rent"],
        correctIndex: 1,
        explanation:
          "The text says he \"quería ahorrar dinero para comprarse una bicicleta nueva.\"",
      },
      {
        type: "multiple-choice",
        question: "What problem did Martín have with Mr. Osvaldo's two dogs?",
        options: ["They refused to walk at all", "They constantly fought with each other", "They ran away every time", "They were too old to walk"],
        correctIndex: 1,
        explanation:
          "The story says the dogs \"se peleaban constantemente entre ellos,\" so he had to separate them.",
      },
      {
        type: "multiple-choice",
        question: "What did Martín do after finally saving enough for the bicycle?",
        options: ["He immediately quit walking dogs", "He kept walking dogs because he had grown to enjoy it", "He sold the business to a friend", "He gave the bicycle to his sister"],
        correctIndex: 1,
        explanation:
          "The text says he \"decidió seguir paseando perros incluso después de comprarla, porque había empezado a disfrutar realmente\" of the time with the animals.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A trip to a luxury hotel", "Camping in the mountains without phones or electricity", "A cruise around South America", "Staying home and relaxing"],
        correctIndex: 1,
        explanation:
          "Ricardo proposes \"acampar en las montañas cerca de Bariloche... sin teléfonos, sin electricidad y sin ninguna comodidad moderna.\"",
      },
      {
        type: "multiple-choice",
        question: "What went wrong on the first night at the campsite?",
        options: ["It rained heavily", "The tent collapsed", "The firewood was wet and they couldn't cook, so they ate cold crackers", "A bear approached the camp"],
        correctIndex: 2,
        explanation:
          "The text says \"la madera estaba húmeda y no lograba prender el fuego\" so they ended up eating cold crackers.",
      },
      {
        type: "multiple-choice",
        question: "What moment changed Bruno and Julieta's attitude toward the trip?",
        options: ["Winning a card game", "Seeing the sky full of stars before dawn", "Catching a fish", "Getting phone signal again"],
        correctIndex: 1,
        explanation:
          "Bruno wakes early and sees \"el cielo lleno de estrellas todavía visibles antes del amanecer\" and calls Julieta to see it too.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Not studying at all", "Sleeping only four or five hours and drinking a lot of caffeine", "Studying only with her parents", "Skipping school to study alone"],
        correctIndex: 1,
        explanation:
          "The text says she was \"durmiendo solo cuatro o cinco horas, y tomando muchas bebidas con cafeína.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened to Joaquín the previous year when he studied the same way?",
        options: ["He failed the exam", "He got sick from stress and lack of sleep on exam day", "He lost his notes", "He fell asleep during the exam"],
        correctIndex: 1,
        explanation:
          "Joaquín says he \"terminó enfermándose justo el día del examen por el estrés y la falta de sueño.\"",
      },
      {
        type: "multiple-choice",
        question: "What new study method did Renata and Joaquín try together?",
        options: ["Studying all night without breaks", "Taking ten-minute breaks each hour, drinking water instead of caffeine, and sleeping before midnight", "Only studying on the day of the exam", "Hiring a private tutor"],
        correctIndex: 1,
        explanation:
          "Joaquín proposes they \"harían pausas de diez minutos cada hora, tomarían agua... y se irían a dormir antes de la medianoche.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A girl who discovers an old letter hidden in a wall", "A boy who learns to fish", "A trip to the mountains", "Her grandmother's garden"],
        correctIndex: 0,
        explanation:
          "The story is described as \"un relato sobre una niña que descubre una carta antigua escondida en la pared de su casa.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Felipe tell Antonia about famous writers to comfort her?",
        options: ["That they never faced rejection", "That a writer they admired was rejected more than thirty times before publishing", "That writing is not a real career", "That she should give up writing fiction"],
        correctIndex: 1,
        explanation:
          "Felipe tells her a writer they admired \"había sido rechazado más de treinta veces antes de publicar su primera novela.\"",
      },
      {
        type: "multiple-choice",
        question: "What inspired Antonia to start writing again?",
        options: ["A new writing contest advertisement", "Finding her great-grandmother's old letters in the attic", "A conversation with a stranger", "Watching a movie about writers"],
        correctIndex: 1,
        explanation:
          "She found \"cartas antiguas escritas por su bisabuela\" while cleaning the attic, which inspired her new story.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She wanted to become a veterinarian", "She thought it would be easier than working with people because she was shy", "Her best friend convinced her", "She needed money"],
        correctIndex: 1,
        explanation:
          "The text says she was shy and \"pensando que sería más fácil trabajar con animales que con personas.\"",
      },
      {
        type: "multiple-choice",
        question: "Why had no one adopted the dog named Café?",
        options: ["He was too old", "He had suffered mistreatment before and seemed very frightened", "He was too aggressive with other dogs", "The shelter wouldn't allow it"],
        correctIndex: 1,
        explanation:
          "Marisol explains Café \"había sufrido maltrato en su hogar anterior\" and no one wanted him because he was always so scared.",
      },
      {
        type: "multiple-choice",
        question: "What happened when Café arrived at his new home?",
        options: ["He immediately felt comfortable", "He hid under a table for hours, then came out to lie beside Emilia that night", "He ran away", "He refused to eat for a week"],
        correctIndex: 1,
        explanation:
          "The text says Café \"se escondió debajo de una mesa durante horas,\" but that night he came out and lay down beside Emilia.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["It ran out of gasoline", "A radiator hose had come loose", "The battery died", "She got a flat tire"],
        correctIndex: 1,
        explanation:
          "Don Rogelio identifies the problem: \"una manguera del radiador se había desconectado.\"",
      },
      {
        type: "multiple-choice",
        question: "How was don Rogelio able to fix Beatriz's car?",
        options: ["He called a tow truck", "He had once worked as a mechanic before farming and used tools from his truck", "He used his phone to find instructions", "He couldn't fix it and they waited for help"],
        correctIndex: 1,
        explanation:
          "The text explains he \"había trabajado como mecánico años atrás, antes de dedicarse completamente al campo\" and fixed it with tools from his truck.",
      },
      {
        type: "multiple-choice",
        question: "What did Beatriz decide to do a month after the breakdown?",
        options: ["Move to the countryside permanently", "Take a course in automotive mechanics", "Buy a new car", "Stop driving on highways"],
        correctIndex: 1,
        explanation:
          "The story says she \"decidió tomar un curso de mecánica automotriz, algo que nunca antes había considerado.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He never wanted to practice with her", "His constant shouted instructions made her more nervous and cause more mistakes", "He refused to let her drive at all", "He was always late to practice sessions"],
        correctIndex: 1,
        explanation:
          "Camila says \"Cada vez que grita, me pongo tan nerviosa que cometo más errores.\"",
      },
      {
        type: "multiple-choice",
        question: "What new system did Marcelo propose after apologizing?",
        options: ["He would only speak if he saw real danger, otherwise stay quiet", "He would stop teaching her entirely", "He would hire a professional instructor instead", "He would only let her practice at night"],
        correctIndex: 0,
        explanation:
          "Marcelo proposes he \"solo hablaría si veía un peligro real, y por lo demás, dejaría que Camila condujera sin interrupciones.\"",
      },
      {
        type: "multiple-choice",
        question: "What happened when a dog crossed the street during practice?",
        options: ["Camila hit the dog", "Camila braked late and almost hit the car ahead, so Marcelo shouted despite his promise", "Marcelo took over the wheel", "They stopped practicing driving altogether"],
        correctIndex: 1,
        explanation:
          "Camila \"frenó demasiado tarde y estuvo a punto de chocar,\" and Marcelo \"no pudo evitar gritar '¡Frena!'\" in that real danger.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He got a new job in another city", "His father fell and he needed to help care for him", "He lost his voice", "He decided he no longer wanted to act"],
        correctIndex: 1,
        explanation:
          "Daniel's sister calls saying \"su padre había sufrido una caída y necesitaba que Daniel viajara inmediatamente.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Valeria already know many of the lead role's lines?",
        options: ["She had read the script cover to cover on her own", "She had accidentally memorized them from hearing them so often during rehearsals", "Daniel taught them to her directly", "She had played the role before in a different town"],
        correctIndex: 1,
        explanation:
          "The text says she \"había memorizado accidentalmente muchas de las líneas de Daniel simplemente por escucharlas tantas veces.\"",
      },
      {
        type: "multiple-choice",
        question: "How did the audience react at the end of the performance?",
        options: ["They left quietly, unimpressed", "The whole town stood up applauding, some with tears in their eyes", "They demanded a refund", "They asked for Daniel to be brought back"],
        correctIndex: 1,
        explanation:
          "The story says \"el pueblo entero se puso de pie para aplaudir, y varios vecinos tenían lágrimas en los ojos.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["It required immediate surgery", "It was nothing serious and she could keep training normally", "She needed at least six weeks of rest to recover fully", "It would never heal completely"],
        correctIndex: 2,
        explanation:
          "The doctor explains she would \"necesitaría descansar al menos seis semanas para recuperarse completamente.\"",
      },
      {
        type: "multiple-choice",
        question: "What did the physical therapist Susana tell Marta about patience?",
        options: ["It didn't matter for recovery", "It was better to arrive at the championship at 80% strength than risk not competing at all", "She should quit swimming permanently", "She should train twice as hard to make up for lost time"],
        correctIndex: 1,
        explanation:
          "Susana says, \"Es mejor que llegues al campeonato con un ochenta por ciento de tu fuerza normal que arriesgarte a no llegar en absoluto.\"",
      },
      {
        type: "multiple-choice",
        question: "How did Marta do at the regional championship?",
        options: ["She won first place", "She finished third and felt proud given her recovery", "She didn't finish the race", "She decided not to compete after all"],
        correctIndex: 1,
        explanation:
          "The text says she \"terminó en tercer lugar, un resultado que la llenó de orgullo.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["They wanted to work more than her", "Ismael and Pablo weren't completing their parts, leaving her to do everything", "They finished the project without her", "They kept changing the topic"],
        correctIndex: 1,
        explanation:
          "Nayeli says \"No es justo que yo trabaje el doble mientras ustedes no hacen nada.\"",
      },
      {
        type: "multiple-choice",
        question: "What solution did Fernanda propose to fix the group's problem?",
        options: ["Report progress daily in a group chat so no one falls behind unnoticed", "Split into two separate projects", "Ask the teacher to assign new groups", "Do all the work over one weekend"],
        correctIndex: 0,
        explanation:
          "Fernanda proposed that \"cada uno debía informar diariamente sobre su progreso en un chat grupal.\"",
      },
      {
        type: "multiple-choice",
        question: "What task did Pablo take responsibility for after apologizing?",
        options: ["Writing the research report", "Creating the final video, since he enjoyed editing", "Designing the posters", "Presenting alone to the class"],
        correctIndex: 1,
        explanation:
          "Pablo proposed \"que él se encargara de crear el video final, una tarea que realmente disfrutaba.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["They disagreed about where to hold the reunion", "They had a serious argument years ago about money and caring for their late father", "They never got along as children", "Gustavo missed the grandmother's birthday before"],
        correctIndex: 1,
        explanation:
          "The mother explains they \"habían tenido una fuerte discusión hace más de una década, relacionada con dinero y con decisiones sobre el cuidado de su padre.\"",
      },
      {
        type: "multiple-choice",
        question: "Who arranged the private conversation between the two brothers?",
        options: ["Sofía", "Their mother", "Grandmother Consuelo", "A family friend"],
        correctIndex: 2,
        explanation:
          "The text says \"La abuela Consuelo... pidió hablar con Ernesto y Gustavo a solas en la cocina.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Gustavo say in his speech at the birthday party?",
        options: ["He criticized Ernesto for not visiting enough", "He thanked Ernesto for caring for their father in his last years", "He announced he was moving back permanently", "He asked for money"],
        correctIndex: 1,
        explanation:
          "Gustavo \"agradeció a su hermano Ernesto por haber cuidado de su padre durante sus últimos años.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["So he could play video games", "So he could video call his family who lived far away, like Camila in Spain", "Because he asked her to teach him", "So he could use it for work"],
        correctIndex: 1,
        explanation:
          "Camila wanted him \"que pudiera hacer videollamadas y ver a toda su familia más seguido, sin importar dónde estuvieran.\"",
      },
      {
        type: "multiple-choice",
        question: "What almost made Ramón give up on learning the new phone?",
        options: ["He broke the phone", "He kept forgetting how to open apps and pressed wrong buttons, feeling frustrated", "His eyesight was too poor", "Camila stopped helping him"],
        correctIndex: 1,
        explanation:
          "The text says \"Olvidaba constantemente cómo abrir las aplicaciones\" and he said he preferred his old phone.",
      },
      {
        type: "multiple-choice",
        question: "What did Ramón and Camila agree to do every week after she returned to Spain?",
        options: ["Send letters by mail", "Have a video call every Sunday afternoon", "Meet in person", "Call only on birthdays"],
        correctIndex: 1,
        explanation:
          "The story says they \"mantuvieron su promesa de hacer videollamadas cada domingo por la tarde.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["That the school was closing early for summer", "That the principal planned to cancel the senior graduation trip due to budget problems", "That a new principal was being hired", "That final exams were being cancelled"],
        correctIndex: 1,
        explanation:
          "The rumor was \"que el director del colegio planeaba cancelar el viaje de graduación de los estudiantes de último año debido a problemas de presupuesto.\"",
      },
      {
        type: "multiple-choice",
        question: "What was actually true, according to the principal?",
        options: ["The trip was completely cancelled", "The trip's cost had increased and the school was considering changes like a shorter trip, not cancellation", "The rumor was entirely made up with no basis", "The trip had already happened early"],
        correctIndex: 1,
        explanation:
          "The principal explains \"el costo del viaje había aumentado... la administración estaba buscando maneras de reducir esos gastos,\" but cancellation was never the plan.",
      },
      {
        type: "multiple-choice",
        question: "What was the headline of Camilo and Antonella's published article?",
        options: ["\"The Principal Resigns\"", "\"El viaje de graduación no será cancelado: la verdad detrás del rumor\"", "\"Budget Cuts Hit Our School\"", "\"Students Protest Graduation Trip\""],
        correctIndex: 1,
        explanation:
          "The article's headline was \"El viaje de graduación no será cancelado: la verdad detrás del rumor.\"",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Build new apartments", "Turn it into a public parking lot", "Sell it to a private company", "Expand a nearby school"],
        correctIndex: 1,
        explanation:
          "The notice announced a project \"para convertir el terreno en un estacionamiento público.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Isabela do to help gather wider support besides collecting signatures in person?",
        options: ["She organized a march", "She created an online petition page that went viral after a local journalist wrote about it", "She contacted a lawyer to sue the city", "She moved the garden to a new location"],
        correctIndex: 1,
        explanation:
          "Isabela \"propuso además crear una página en internet\" and the petition \"se hizo viral rápidamente después de que un periodista local escribiera un artículo.\"",
      },
      {
        type: "multiple-choice",
        question: "What was the final outcome after the meeting with the mayor?",
        options: ["The garden was destroyed anyway", "The parking lot would be built on a different empty lot nearby instead", "The neighbors had to pay for the garden themselves", "The mayor resigned"],
        correctIndex: 1,
        explanation:
          "The mayor announced \"que el estacionamiento se construiría en otro terreno cercano que estaba desocupado,\" so the garden stayed intact.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She was cold on the walk to work", "It was her first day at a new job and she was nervous", "She had slept badly all week", "She arrived late to the office"],
        correctIndex: 1,
        explanation:
          "The story says she felt her hands tremble because \"Era su primer día como diseñadora gráfica en una agencia de publicidad\" — it was her first day at a new job, which made her nervous.",
      },
      {
        type: "multiple-choice",
        question: "What did Lucía do when Marina asked for help?",
        options: ["She told her she was too busy", "She showed her step by step how to use the program", "She called the boss to complain", "She gave the task to someone else"],
        correctIndex: 1,
        explanation:
          "The text states \"Le mostró paso a paso cómo abrir los archivos y cómo guardar el trabajo correctamente\" — Lucía showed her step by step how to open and save files.",
      },
      {
        type: "multiple-choice",
        question: "What did señor Contreras ask Marina to change in her design?",
        options: ["The size of the text", "The colors", "The logo", "The project deadline"],
        correctIndex: 1,
        explanation:
          "He told her: \"cambia estos colores y hazlo más simple\" — change these colors and make it simpler.",
      },
      {
        type: "multiple-choice",
        question: "How did Marina feel by the end of her first day?",
        options: ["Determined to quit the job", "Angry with Lucía", "Aware she had learned a lot despite the difficulties", "Indifferent about the whole experience"],
        correctIndex: 2,
        explanation:
          "She felt that \"aunque el día había sido difícil, había aprendido más en ocho horas que en muchas clases de la universidad\" — despite the hard day, she had learned more than in many university classes.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He didn't need the money", "He trusted the client, who had promised to pay within a week", "He had already been paid in cash", "He forgot about the invoice"],
        correctIndex: 1,
        explanation:
          "The señora Rojas \"le prometió que pagaría la factura en una semana\" and \"Diego confiaba en ella, así que no se preocupó al principio\" — he trusted her promise.",
      },
      {
        type: "multiple-choice",
        question: "What did Diego's friend suggest he do?",
        options: ["Stop working as a freelancer", "Talk to a lawyer", "Ignore the missing payment", "Give the client a discount"],
        correctIndex: 1,
        explanation:
          "His friend \"le sugirió hablar con un abogado\" — suggested he speak with a lawyer.",
      },
      {
        type: "multiple-choice",
        question: "What solution did Diego propose to resolve the payment issue?",
        options: ["Cancel the debt completely", "Take the client to court immediately", "Pay the invoice in three parts instead of all at once", "Refuse to ever work with her again"],
        correctIndex: 2,
        explanation:
          "Diego \"le propuso pagar la factura en tres partes, en vez de todo junto\" — he proposed splitting the payment into three parts.",
      },
      {
        type: "multiple-choice",
        question: "What lesson did Diego learn from this experience?",
        options: ["Never trust any client again", "Always work for free the first time", "It was better to have clear contracts specifying payment terms", "Freelance work is not worth doing"],
        correctIndex: 2,
        explanation:
          "The story says he learned it \"era mejor tener contratos claros desde el principio, en los que se especificara cuándo y cómo se pagaría el trabajo\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He was late to work", "He sent an old version of the report with wrong figures", "He lost an important client", "He forgot to attend a meeting"],
        correctIndex: 1,
        explanation:
          "He realized \"había mandado la versión antigua del informe, la que todavía tenía cifras equivocadas\" — he had sent the old, incorrect version.",
      },
      {
        type: "multiple-choice",
        question: "What advice did Pablo's coworker give him?",
        options: ["To hide the mistake and hope no one noticed", "To quit the internship", "To tell señora Núñez himself before the client found out", "To blame someone else for the error"],
        correctIndex: 2,
        explanation:
          "His coworker said: \"Es mejor que se lo digas tú antes de que lo descubra el cliente\" — it's better that you tell her yourself before the client discovers it.",
      },
      {
        type: "multiple-choice",
        question: "How did señora Núñez react when Pablo confessed?",
        options: ["She fired him immediately", "She thanked him and asked him to correct the error", "She yelled at him in front of everyone", "She ignored what he said"],
        correctIndex: 1,
        explanation:
          "She said \"Gracias por decírmelo tan pronto. Ahora escribe un correo al cliente, discúlpate y envía el informe correcto\" — thanking him and telling him to fix it.",
      },
      {
        type: "multiple-choice",
        question: "What did señora Núñez say she valued in the final conversation?",
        options: ["Perfect work with no mistakes ever", "Employees who work the longest hours", "The courage to admit mistakes quickly", "Never asking questions"],
        correctIndex: 2,
        explanation:
          "She told him \"pocos becarios tienen el valor de admitirlos tan rápido. Eso es lo que buscamos en esta empresa\" — few interns have the courage to admit mistakes so fast, and that's what the company looks for.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Friendly and talkative", "Impatient and rude", "Silent and shy", "Cheerful and generous"],
        correctIndex: 1,
        explanation:
          "The story says \"desde el primer momento, se mostró impaciente y grosero\" — from the first moment he was impatient and rude.",
      },
      {
        type: "multiple-choice",
        question: "What did Elena accidentally overhear while he was on the phone?",
        options: ["He was talking about a work problem", "His wife was in the hospital and doctors didn't know what was wrong", "He was complaining about the restaurant to a friend", "He was arguing with his boss"],
        correctIndex: 1,
        explanation:
          "She heard that \"su esposa estaba en el hospital y los médicos no sabían todavía qué le pasaba\".",
      },
      {
        type: "multiple-choice",
        question: "What did Elena say to señor Beltrán when she brought the bill?",
        options: ["She told him he was a terrible customer", "She asked if he was okay", "She refused to serve him again", "She called the manager"],
        correctIndex: 1,
        explanation:
          "She asked him: \"Disculpe que le pregunte, pero ¿está usted bien?\"",
      },
      {
        type: "multiple-choice",
        question: "What lesson does Elena take away from the experience?",
        options: ["Rude customers should never be forgiven", "Behind a difficult customer there is often a story you don't know about", "It's better to avoid all customers", "Restaurant work is not worth the stress"],
        correctIndex: 1,
        explanation:
          "The story ends: \"Elena aprendió que, detrás de un cliente difícil, muchas veces hay una historia que no se conoce\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["They both wanted the same vacation dates", "They both applied for the same team leader position", "Julián was fired and Sara wasn't", "They disagreed about a client's contract"],
        correctIndex: 1,
        explanation:
          "The story explains \"la empresa anunció que buscaba un nuevo jefe de equipo, y que el puesto se elegiría entre los empleados actuales\", and both applied.",
      },
      {
        type: "multiple-choice",
        question: "How did Sara feel when she found out Julián had mentioned her old mistake to the director?",
        options: ["Amused", "Betrayed and furious", "Grateful", "Indifferent"],
        correctIndex: 1,
        explanation:
          "The text says directly: \"Se sintió traicionada y furiosa\".",
      },
      {
        type: "multiple-choice",
        question: "What was Julián's explanation for mentioning the mistake?",
        options: ["He did it on purpose to win the promotion", "It slipped out unintentionally during the conversation", "The director asked him directly about it", "He didn't remember saying it"],
        correctIndex: 1,
        explanation:
          "He explained \"que no lo había hecho a propósito, que simplemente se le había escapado durante la conversación\".",
      },
      {
        type: "multiple-choice",
        question: "How did the director resolve the competition for the promotion?",
        options: ["She chose Julián over Sara", "She canceled the promotion entirely", "She split the position into two different roles", "She asked them to reapply in a year"],
        correctIndex: 2,
        explanation:
          "The director \"había decidido dividir el puesto en dos roles distintos, porque ambos tenían fortalezas diferentes que la empresa necesitaba\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Construction noise on her street", "Noise from her upstairs neighbors' new baby", "A broken heater", "Loud traffic outside"],
        correctIndex: 1,
        explanation:
          "The upstairs baby caused it: \"el ruido por las noches le estaba afectando mucho el sueño\", and the baby was \"un bebé recién nacido\".",
      },
      {
        type: "multiple-choice",
        question: "What solution did Marta first propose to reduce noise?",
        options: ["Move to a different apartment", "Put rugs on the floor to reduce footstep noise", "Stop having visitors", "Soundproof the walls"],
        correctIndex: 1,
        explanation:
          "Marta promised \"que hablaría con Óscar para poner alfombras en el suelo y así reducir el ruido de los pasos\".",
      },
      {
        type: "multiple-choice",
        question: "What did Rosa propose at the building meeting?",
        options: ["Evicting Marta and Óscar", "A written agreement about quiet hours for everyone", "Banning babies from the building", "Raising everyone's rent"],
        correctIndex: 1,
        explanation:
          "She said \"Es importante que todos respetemos ciertas horas de silencio\", leading to a written agreement for the whole building.",
      },
      {
        type: "multiple-choice",
        question: "What did Rosa ultimately learn from the experience?",
        options: ["It's best to avoid conflict by staying silent", "Speaking directly with others usually brings better results than staying quiet", "Babies should not live in apartment buildings", "Neighbors can never really become friends"],
        correctIndex: 1,
        explanation:
          "The story concludes: \"hablar directamente con los demás, en vez de quedarse callada, casi siempre trae mejores resultados\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A house in the countryside", "A small neighborhood bakery", "A car repair shop", "A large sum of money only"],
        correctIndex: 1,
        explanation:
          "He left \"una pequeña panadería que había abierto hacía treinta años en el barrio\".",
      },
      {
        type: "multiple-choice",
        question: "What did Ana initially want to do with the bakery?",
        options: ["Keep it open and run it herself", "Sell it", "Turn it into a different kind of business", "Give it to a stranger"],
        correctIndex: 1,
        explanation:
          "She thought \"que sería más práctico venderla\" — that it would be more practical to sell it.",
      },
      {
        type: "multiple-choice",
        question: "What changed Ana's mind about the bakery?",
        options: ["A phone call from a buyer", "Finding a letter their father had written explaining why he opened it", "A visit from an old family friend", "Losing her job as a lawyer"],
        correctIndex: 1,
        explanation:
          "\"Ana encontró una carta que su padre había escrito años atrás, en la que explicaba por qué había abierto el negocio\", and this changed how she saw things.",
      },
      {
        type: "multiple-choice",
        question: "What arrangement did the siblings finally agree on?",
        options: ["Ana would sell her share to Tomás", "Ana would invest money to modernize it, and Tomás would manage it daily", "They would close the bakery permanently", "Tomás would move to Ana's city"],
        correctIndex: 1,
        explanation:
          "Ana proposed that \"ella invertiría dinero para modernizar la panadería, y él se encargaría de dirigirla día a día\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Mexico", "Colombia", "Argentina", "Peru"],
        correctIndex: 1,
        explanation:
          "The story says \"Había emigrado de Colombia hacía apenas un mes\".",
      },
      {
        type: "multiple-choice",
        question: "What made señor Domínguez first knock on Amara's door?",
        options: ["A noise complaint", "The smell of the food she was cooking", "A package delivered to the wrong address", "A building meeting notice"],
        correctIndex: 1,
        explanation:
          "\"El olor a especias llenó todo el pasillo del edificio\" and he \"tocó la puerta para preguntar qué estaba cocinando\".",
      },
      {
        type: "multiple-choice",
        question: "What did señor Domínguez admit about his initial distrust of Amara?",
        options: ["He thought she was too loud", "He simply wasn't used to changes after living alone a long time", "He didn't like her cooking style", "He was afraid of losing his apartment"],
        correctIndex: 1,
        explanation:
          "He confessed \"había sentido cierta desconfianza simplemente porque no estaba acostumbrado a los cambios\" after \"Llevo mucho tiempo viviendo solo\".",
      },
      {
        type: "multiple-choice",
        question: "How did the friendship between Amara and señor Domínguez affect the rest of the building?",
        options: ["It caused jealousy among other neighbors", "It led to a gathering where neighbors shared food from their regions", "It had no effect on anyone else", "It caused Amara to move out"],
        correctIndex: 1,
        explanation:
          "Amara \"organizó una pequeña reunión en el patio del edificio, en la que cada vecino llevó un plato típico de su región\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She had stopped paying rent", "The building's owner decided to sell it", "The building was being demolished", "She had broken building rules"],
        correctIndex: 1,
        explanation:
          "\"El dueño del edificio había decidido vender el inmueble\", so all tenants had to leave.",
      },
      {
        type: "multiple-choice",
        question: "What did the housing lawyer explain to the tenants?",
        options: ["They had no legal protections at all", "The owner had legal deadlines and rights he had to respect", "They should move out immediately", "Only Lucía had rights, not the other tenants"],
        correctIndex: 1,
        explanation:
          "The lawyer explained \"el dueño no podía echarlos de un día para otro sin respetar ciertos plazos y derechos que protegían a los inquilinos\".",
      },
      {
        type: "multiple-choice",
        question: "What did the tenants do together after learning their rights?",
        options: ["They sued the owner immediately", "They wrote a joint letter asking for more time", "They refused to leave under any circumstances", "They each negotiated separately"],
        correctIndex: 1,
        explanation:
          "They \"escribieron una carta conjunta al dueño en la que pedían más tiempo... Firmaron la carta todos los inquilinos del edificio\".",
      },
      {
        type: "multiple-choice",
        question: "What was the final outcome of the negotiation with the owner?",
        options: ["The owner canceled the sale of the building", "The deadline was extended to four months, and he offered reference letters", "The tenants were forced out in two months anyway", "The owner lowered everyone's rent instead"],
        correctIndex: 1,
        explanation:
          "The owner \"accedió a extender el plazo a cuatro meses... También prometió ayudar a los inquilinos que necesitaran una carta de referencia\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A complaint about noise", "A complaint about a badly parked car", "A dispute over unpaid fees", "A disagreement about pets"],
        correctIndex: 1,
        explanation:
          "It began when \"alguien escribió un mensaje quejándose de que un vecino dejaba su coche mal aparcado en el garaje\".",
      },
      {
        type: "multiple-choice",
        question: "What did Carmen propose to calm the situation down?",
        options: ["Deleting the WhatsApp group entirely", "An in-person meeting instead of arguing in the chat", "Fining whoever complained the most", "Ignoring the messages completely"],
        correctIndex: 1,
        explanation:
          "She proposed \"que organicemos una reunión presencial para hablar de las normas del garaje, en vez de seguir escribiendo mensajes\".",
      },
      {
        type: "multiple-choice",
        question: "What turned out to be the real reason for the bad parking?",
        options: ["He was in a hurry for work", "He had a problem with his tire that night", "He didn't know the parking rules", "His car was broken permanently"],
        correctIndex: 1,
        explanation:
          "He explained \"que había tenido un problema con la rueda esa noche y que por eso había aparcado mal\".",
      },
      {
        type: "multiple-choice",
        question: "What new rule did the neighbors agree on for the WhatsApp group?",
        options: ["No one could post more than once a day", "Use it only for useful notices and resolve disagreements in person", "Only Carmen could post messages", "The group would be deleted after the meeting"],
        correctIndex: 1,
        explanation:
          "They agreed to \"usarlo solo para avisos útiles, y resolver los desacuerdos personales en persona, no por mensaje\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A long day at a second job", "Spending over an hour repeating the same pose to get the perfect light", "An argument with her sister", "Losing followers suddenly"],
        correctIndex: 1,
        explanation:
          "She had spent \"más de una hora repitiendo la misma pose, buscando la luz perfecta\" and felt exhausted in a deeper way.",
      },
      {
        type: "multiple-choice",
        question: "What did Valentina's sister advise her to do?",
        options: ["Quit social media completely", "Dare to show something more real sometimes", "Hire someone to manage her account", "Post even more frequently"],
        correctIndex: 1,
        explanation:
          "Her sister said: \"Ojalá te atrevas a mostrar algo más real de vez en cuando\".",
      },
      {
        type: "multiple-choice",
        question: "How did followers respond to Valentina's honest, unedited post?",
        options: ["Most of them unfollowed her immediately", "Many thanked her for her honesty and said they felt similar pressure", "No one noticed the post", "They demanded she delete it"],
        correctIndex: 1,
        explanation:
          "\"Muchos de seguidores que le agradecían su honestidad y que compartían que ellos también sentían presión por mostrar vidas perfectas\".",
      },
      {
        type: "multiple-choice",
        question: "What message did Valentina share with students during her talk?",
        options: ["Everyone should become an influencer", "What you see on a screen is rarely the whole story", "Social media should be banned for teenagers", "Perfect photos always tell the truth"],
        correctIndex: 1,
        explanation:
          "She told them: \"lo que se ve en una pantalla casi nunca es la historia completa\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To study at a university", "To work caring for elderly people, for better pay", "To join her husband", "To open her own business"],
        correctIndex: 1,
        explanation:
          "She moved \"para trabajar cuidando a personas mayores, un empleo que pagaba mucho mejor que cualquier cosa que había encontrado en su país\".",
      },
      {
        type: "multiple-choice",
        question: "What changed about the Sunday video calls over time?",
        options: ["They became longer and more detailed", "They got shorter as Sofía grew distracted by her phone", "They stopped happening altogether", "They moved to a different day"],
        correctIndex: 1,
        explanation:
          "Sofía \"apareció en la pantalla con el teléfono en una mano y respondiendo mensajes con la otra, apenas mirando a la cámara\", and the calls became shorter.",
      },
      {
        type: "multiple-choice",
        question: "What did Carmen do to express how she felt about the distant calls?",
        options: ["She stopped calling for a month", "She wrote her daughter a letter", "She asked the grandmother to intervene", "She flew home immediately"],
        correctIndex: 1,
        explanation:
          "\"Decidió escribirle una carta... en la que le explicaba cuánto la extrañaba y por qué esas llamadas eran tan importantes para ella\".",
      },
      {
        type: "multiple-choice",
        question: "What did Sofía do differently on the following Sunday?",
        options: ["She canceled the call", "She left her phone in another room during the call", "She invited a friend to join the call", "She asked to shorten the calls further"],
        correctIndex: 1,
        explanation:
          "\"Sofía dejó el teléfono en otra habitación antes de empezar la videollamada\" and talked to her mother with more attention.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["It was the cheapest way to meet people", "It was, according to them, the best way to meet people in a big city", "His sister worked for the company", "He had already tried everything else"],
        correctIndex: 1,
        explanation:
          "His friends assured him \"que era la mejor manera de conocer gente en una ciudad grande\".",
      },
      {
        type: "multiple-choice",
        question: "What made Andrés reach out to Laura specifically?",
        options: ["A mutual friend introduced them", "Her profile description made him laugh, about wanting someone who wouldn't mind her talking about work", "She messaged him first", "They matched on a random swipe"],
        correctIndex: 1,
        explanation:
          "Her profile said \"Ojalá encuentre a alguien a quien no le moleste que hable de mi trabajo todo el tiempo\", which made him laugh and message her.",
      },
      {
        type: "multiple-choice",
        question: "What did Andrés notice was different about Laura compared to other people from the app?",
        options: ["She never wanted to meet in person", "She was exactly as she seemed in her messages: honest, funny, and direct", "She only talked about her job", "She lived very far away"],
        correctIndex: 1,
        explanation:
          "\"Laura era exactamente como se mostraba en sus mensajes: honesta, divertida y directa\".",
      },
      {
        type: "multiple-choice",
        question: "According to Andrés, what really matters in dating, regardless of the app?",
        options: ["Having the most attractive photos", "Being willing to show yourself as you really are", "Never being nervous on a first date", "Choosing the most popular app"],
        correctIndex: 1,
        explanation:
          "He said: \"Lo importante no es la aplicación... sino estar dispuesto a mostrarte tal como eres, incluso cuando da miedo\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["His salary was too low", "The isolation, going entire days without speaking to anyone out loud", "His apartment was too small", "He missed traveling for work"],
        correctIndex: 1,
        explanation:
          "He noticed \"pasaban días enteros en los que apenas hablaba con otra persona en voz alta\".",
      },
      {
        type: "multiple-choice",
        question: "How did his coworkers react to the return-to-office announcement?",
        options: ["Everyone was thrilled", "Everyone quit immediately", "Reactions were mixed — some were happy, others upset about losing flexibility", "No one had any opinion"],
        correctIndex: 2,
        explanation:
          "\"La noticia generó reacciones muy distintas entre sus compañeros: algunos se alegraron, mientras que otros protestaron\".",
      },
      {
        type: "multiple-choice",
        question: "What did Fernando notice once he was back in the office?",
        options: ["Nothing had changed at all", "Spontaneous conversations solved problems faster than message chains", "He preferred working alone in silence", "The office was completely empty"],
        correctIndex: 1,
        explanation:
          "He noticed that \"ciertas conversaciones espontáneas... resolvían problemas mucho más rápido que largas cadenas de mensajes escritos\".",
      },
      {
        type: "multiple-choice",
        question: "What conclusion did Fernando reach about remote work versus the office?",
        options: ["Remote work is always better", "The office is always better", "A balance between both was ideal for him", "Neither option was worth considering"],
        correctIndex: 2,
        explanation:
          "He concluded that \"ni el trabajo completamente remoto ni la oficina de siempre eran la solución perfecta; lo ideal, para él, era un equilibrio entre ambos\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Her doctor recommended it", "Watching a documentary about excessive technology use", "She lost her phone for a week", "A friend dared her to do it"],
        correctIndex: 1,
        explanation:
          "The idea came \"mientras veía un documental sobre el uso excesivo de la tecnología\".",
      },
      {
        type: "multiple-choice",
        question: "What almost made Claudia give up the challenge in week two?",
        options: ["She missed an important work email", "She found out about a party she wasn't invited to via message, and felt excluded", "Her phone broke completely", "She got lost without GPS"],
        correctIndex: 1,
        explanation:
          "She learned \"de que se había organizado una fiesta importante a la que no la habían invitado directamente por mensaje. Se sintió excluida\".",
      },
      {
        type: "multiple-choice",
        question: "How was the misunderstanding about the party resolved?",
        options: ["She never found out what happened", "A five-minute phone call revealed the invite went to an old group she wasn't in anymore", "She showed up uninvited", "Her friend apologized in writing"],
        correctIndex: 1,
        explanation:
          "\"El problema se resolvió con una llamada de cinco minutos\" — the invitation had gone to \"un grupo antiguo del que Claudia ya no formaba parte\".",
      },
      {
        type: "multiple-choice",
        question: "What did Claudia decide to do once the thirty days were over?",
        options: ["Turn all notifications back on", "Keep only the most important notifications on, like direct messages, and leave social media off", "Delete her phone number", "Give up on the idea entirely"],
        correctIndex: 1,
        explanation:
          "\"Decidió activar solo las más importantes, como los mensajes directos, pero mantuvo desactivadas las de las redes sociales\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["That Ricardo had won a prize", "That his bank account had been blocked and he needed to verify his identity", "That his package was delayed", "That his subscription had expired"],
        correctIndex: 1,
        explanation:
          "The email said \"su cuenta había sido bloqueada por actividad sospechosa y que debía hacer clic en un enlace para verificar su identidad\".",
      },
      {
        type: "multiple-choice",
        question: "What made Ricardo stop before entering his password?",
        options: ["The page loaded too slowly", "He noticed the web address didn't match the bank's official site", "He got a phone call", "The page asked for too much information"],
        correctIndex: 1,
        explanation:
          "He \"notó algo extraño en la dirección web: no terminaba como el sitio oficial del banco\".",
      },
      {
        type: "multiple-choice",
        question: "What did the bank confirm when Ricardo called?",
        options: ["That there really was a problem with his account", "That the bank never emails asking for passwords or security codes, and it was a scam", "That he needed to visit a branch immediately", "That his card had already been used fraudulently"],
        correctIndex: 1,
        explanation:
          "The bank confirmed \"el banco nunca enviaba correos pidiendo contraseñas ni códigos de seguridad\" and that it was \"un intento de estafa\".",
      },
      {
        type: "multiple-choice",
        question: "How did Ricardo's advice help his mother later on?",
        options: ["It didn't help her at all", "She recognized a similar fake text message about an electricity company and avoided clicking it", "She stopped using her phone completely", "She changed banks"],
        correctIndex: 1,
        explanation:
          "She received a fake message \"fingiendo ser de la empresa de electricidad\" and, \"Gracias al consejo de Ricardo, se dio cuenta de inmediato de que algo no encajaba y no hizo clic en el enlace\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The trees were diseased and dangerous", "To build a new parking lot", "To widen the street", "To build a new school"],
        correctIndex: 1,
        explanation:
          "The sign announced that the trees \"serían cortados para construir un aparcamiento nuevo\".",
      },
      {
        type: "multiple-choice",
        question: "What did Valeria organize in response to the announcement?",
        options: ["A petition to fire the mayor", "A neighborhood meeting under the trees to discuss the plan", "A boycott of local businesses", "A lawsuit against the city"],
        correctIndex: 1,
        explanation:
          "She organized \"una reunión en la plaza misma, bajo los árboles que querían proteger\".",
      },
      {
        type: "multiple-choice",
        question: "What compromise did the city hall finally agree to?",
        options: ["Canceling the parking lot completely", "Building a smaller lot on nearby land and cutting only two damaged trees instead of ten", "Cutting all ten trees but planting new ones elsewhere", "Building the parking lot exactly as originally planned"],
        correctIndex: 1,
        explanation:
          "The final plan was that \"se construiría un aparcamiento más pequeño, usando parte del terreno cercano, y solo se cortarían dos árboles\".",
      },
      {
        type: "multiple-choice",
        question: "What lesson did Valeria learn from the experience?",
        options: ["Complaining loudly is the most effective strategy", "Organizing with concrete solutions makes it easier for authorities to listen and change their minds", "City hall never listens to residents", "It's better not to get involved in local issues"],
        correctIndex: 1,
        explanation:
          "She learned that \"cuando los vecinos se organizan y proponen soluciones concretas en vez de solo quejarse, es más fácil que las autoridades escuchen y cambien de opinión\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A store that only sold plastic products", "A plastic-free store where customers bring their own containers for bulk goods", "A regular supermarket with lower prices", "An online-only grocery delivery service"],
        correctIndex: 1,
        explanation:
          "She opened \"un supermercado sin envases de plástico, donde los clientes llevaran sus propios recipientes para comprar... productos a granel\".",
      },
      {
        type: "multiple-choice",
        question: "How does the payment system in Bea's store work?",
        options: ["A flat fee no matter how much you buy", "You weigh the empty container, fill it, and pay only for the weight of the product", "You pay a monthly subscription", "Everything is free with a membership card"],
        correctIndex: 1,
        explanation:
          "\"Se pesaba el recipiente vacío primero, se llenaba con la cantidad deseada de producto, y luego se pagaba solo por el peso de lo que realmente se llevaba\".",
      },
      {
        type: "multiple-choice",
        question: "What convinced doña Pilar to keep shopping at Bea's store?",
        options: ["The store gave her a discount coupon", "She realized she spent less money because she only paid for what she needed", "Her friends pressured her to shop there", "The store was closer to her home"],
        correctIndex: 1,
        explanation:
          "She noticed \"que había gastado menos dinero que en el supermercado habitual, porque solo pagaba por la cantidad exacta que necesitaba, sin desperdiciar nada\".",
      },
      {
        type: "multiple-choice",
        question: "What did the big neighborhood supermarket eventually do?",
        options: ["It closed down due to competition", "It started offering its own bulk section, inspired by Bea's store", "It banned plastic bags entirely", "It bought Bea's store"],
        correctIndex: 1,
        explanation:
          "\"El supermercado grande de la zona empezó a ofrecer una pequeña sección a granel, una idea que... habían tomado directamente del ejemplo de la tienda de Bea\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Recycling paper at school", "Tracking how much food his family wasted in a week", "Planting trees in the neighborhood", "Studying local wildlife"],
        correctIndex: 1,
        explanation:
          "He had to \"investigar cuánta comida se desperdiciaba en su propia casa durante una semana\".",
      },
      {
        type: "multiple-choice",
        question: "What was Julio's initial reaction to the composting idea?",
        options: ["He was immediately enthusiastic", "He was skeptical and worried it would smell bad", "He refused to let them try it", "He didn't notice the compost box at all"],
        correctIndex: 1,
        explanation:
          "He asked, worried, \"¿No va a oler mal?\" and \"se mostró escéptico al principio\".",
      },
      {
        type: "multiple-choice",
        question: "What role did Mateo take on within the family?",
        options: ["He refused to help after the project ended", "He became the household expert on what could and couldn't go in the compost", "He built the compost box alone without help", "He convinced the family to stop composting"],
        correctIndex: 1,
        explanation:
          "\"Mateo se convirtió en el experto de la casa, revisando en internet cada duda que surgía\".",
      },
      {
        type: "multiple-choice",
        question: "What happened after Mateo presented his project at school?",
        options: ["Nothing changed for anyone else", "His teacher asked him to share the experience with the whole school, and other families started composting too", "The school banned the project topic", "His family stopped composting"],
        correctIndex: 1,
        explanation:
          "\"Su profesora quedó tan impresionada que le pidió compartir la experiencia con el resto de la escuela\", and \"varias familias del barrio... también habían empezado a hacer su propio compost\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Designing wind turbines in a city", "Installing solar panels at a rural school with frequent power outages", "Repairing electrical wires in an office building", "Building a new university lab"],
        correctIndex: 1,
        explanation:
          "Her first assignment was \"ayudar a instalar paneles solares en una escuela rural que sufría cortes de electricidad constantes\".",
      },
      {
        type: "multiple-choice",
        question: "How did Rogelio initially treat Iris's ideas?",
        options: ["With immediate enthusiasm and support", "With distrust, often questioning her calculations in front of others", "He refused to work on the project at all", "He asked to be transferred to another team"],
        correctIndex: 1,
        explanation:
          "\"Rogelio se mostraba desconfiado con las ideas de Iris, y a menudo cuestionaba sus cálculos delante de los demás compañeros\".",
      },
      {
        type: "multiple-choice",
        question: "What technical problem came up during the installation?",
        options: ["The school had no budget for the project", "The roof didn't have the ideal angle for the solar panels", "The panels arrived broken", "There was no sunlight in the area"],
        correctIndex: 1,
        explanation:
          "\"El tejado de la escuela no tenía la inclinación ideal para los paneles solares, lo que reducía la cantidad de energía que podrían generar\".",
      },
      {
        type: "multiple-choice",
        question: "What solution did Iris propose instead of Rogelio's idea of adding more panels?",
        options: ["Canceling the project entirely", "A special structure that adjusted the angle of the panels", "Moving the school to a different building", "Using only traditional electricity"],
        correctIndex: 1,
        explanation:
          "\"Iris propuso una solución distinta: instalar los paneles con una estructura especial que ajustara el ángulo, en vez de simplemente añadir más unidades\".",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She packed things she probably didn't need", "She was carrying gifts for other pilgrims", "Miguel gave her his heavy bag to carry", "She had an injury that made everything feel heavier"],
        correctIndex: 0,
        explanation:
          "The story says she packed \"una mochila enorme que llenó de cosas que probablemente no necesitaría\" (an enormous backpack she filled with things she probably wouldn't need).",
      },
      {
        type: "multiple-choice",
        question: "What advice does Miguel give Elena?",
        options: ["Walk faster to keep up with the group", "Don't carry what you don't need", "Buy new boots before continuing", "Sleep more at each albergue"],
        correctIndex: 1,
        explanation:
          "Miguel tells her, \"No cargues lo que no necesitas\" (Don't carry what you don't need), which becomes the turning point of the story.",
      },
      {
        type: "multiple-choice",
        question: "What did Elena do with her extra belongings?",
        options: ["She sold them at a market", "She mailed them back home", "She gave away books and a hair dryer to another pilgrim", "She threw them in the trash"],
        correctIndex: 2,
        explanation:
          "The text states, \"Regaló tres libros y un secador de pelo a otra peregrina\" (She gave away three books and a hair dryer to another pilgrim).",
      },
      {
        type: "multiple-choice",
        question: "What lesson does Elena take home at the end of the story?",
        options: ["She wants to keep traveling forever", "She wants to simplify her belongings and relationships", "She wants to become a tour guide", "She wants to open a hostel on the Camino"],
        correctIndex: 1,
        explanation:
          "The story explains she \"no quería volver a llenar su vida de cosas ni de relaciones que no le hacían bien\" (didn't want to fill her life again with things or relationships that weren't good for her).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["His doctor said his cholesterol was high and he needed exercise", "He wanted to win prize money", "His wife challenged him to a bet", "He lost a bet with his coworkers"],
        correctIndex: 0,
        explanation:
          "The story says \"su médico le había dicho que el colesterol estaba muy alto y que debía hacer más ejercicio\" (his doctor had told him his cholesterol was very high and he needed more exercise).",
      },
      {
        type: "multiple-choice",
        question: "What happened two weeks before the marathon?",
        options: ["He quit training entirely", "He injured his ankle during a training session", "He got sick with the flu", "He moved to another city for work"],
        correctIndex: 1,
        explanation:
          "The text states \"Andrés se lesionó el tobillo durante un entrenamiento\" (Andrés injured his ankle during a training session).",
      },
      {
        type: "multiple-choice",
        question: "What did his coach tell him about the injury?",
        options: ["\"Rest now, or you'll regret it later\"", "\"Keep running through the pain\"", "\"You should give up the marathon\"", "\"See a different doctor immediately\""],
        correctIndex: 0,
        explanation:
          "His coach says, \"Descansa ahora, o te arrepentirás después\" (Rest now, or you'll regret it later).",
      },
      {
        type: "multiple-choice",
        question: "How did Andrés feel crossing the finish line, despite his slow time?",
        options: ["Disappointed in himself", "Indifferent about the whole race", "Proud and happy", "Angry that he was so slow"],
        correctIndex: 2,
        explanation:
          "The story says \"no le importó el tiempo\" (the time didn't matter to him) and he was \"llorando de cansancio y de alegría\" (crying from exhaustion and joy).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Her boss required it as team building", "A friend invited her and she didn't want to disappoint her", "She wanted a complete career change", "It was cheaper than seeing a therapist"],
        correctIndex: 1,
        explanation:
          "The story says \"Una amiga la invitó...Al final aceptó, sobre todo porque no quería decepcionar a su amiga\" (A friend invited her...she accepted mainly because she didn't want to disappoint her friend).",
      },
      {
        type: "multiple-choice",
        question: "What did Carmen find valuable about working with clay?",
        options: ["It earned her extra money", "It allowed mistakes and second chances", "It was faster than her office job", "It impressed her boss"],
        correctIndex: 1,
        explanation:
          "The text explains \"el barro permitía errores y segundas oportunidades\" (the clay allowed for mistakes and second chances).",
      },
      {
        type: "multiple-choice",
        question: "What happened at the exhibition?",
        options: ["Nobody noticed her piece", "A woman wanted to buy her vase", "She won first prize", "She accidentally broke her piece"],
        correctIndex: 1,
        explanation:
          "The story states \"una mujer incluso quiso comprarla\" (a woman even wanted to buy it), referring to Carmen's vase.",
      },
      {
        type: "multiple-choice",
        question: "What does the ending suggest about Carmen's transformation?",
        options: ["She quit her office job entirely", "She found pottery as necessary to her as her salary", "She became a full-time professional potter", "She stopped going to work altogether"],
        correctIndex: 1,
        explanation:
          "The final line says she \"necesitaba esas horas con las manos en el barro tanto como necesitaba el sueldo de su trabajo\" (needed those hours with her hands in clay as much as she needed her paycheck).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He needed extra money", "His daughter suggested it because he was often alone and idle", "A friend forced him to sign up", "He wanted free meals every week"],
        correctIndex: 1,
        explanation:
          "The story says \"Su hija le sugirió que se apuntara como voluntario\" (His daughter suggested he sign up as a volunteer) because he was alone with little to do.",
      },
      {
        type: "multiple-choice",
        question: "What did Ramón notice about Iker?",
        options: ["He was rude to the volunteers", "He always sat alone and sometimes didn't eat", "He stole food from the kitchen", "He never came back after the first night"],
        correctIndex: 1,
        explanation:
          "The text describes Iker as someone who \"siempre se sentaba solo...a veces se quedaba mirando el plato sin comer\" (always sat alone...sometimes just stared at his plate without eating).",
      },
      {
        type: "multiple-choice",
        question: "How did Ramón help Iker beyond serving him dinner?",
        options: ["He gave him cash directly", "He taught him cooking skills and helped him get a kitchen job", "He let Iker move into his apartment", "He paid Iker's rent for a year"],
        correctIndex: 1,
        explanation:
          "Ramón \"le ofreció a Iker enseñarle algunas recetas básicas\" and later \"le habló de Iker al dueño\" of a restaurant, leading Iker to get hired that same week.",
      },
      {
        type: "multiple-choice",
        question: "What is Iker's role at the soup kitchen by the end of the story?",
        options: ["He stopped going entirely", "He became a volunteer alongside Ramón", "He became the head coordinator", "He opened his own restaurant"],
        correctIndex: 1,
        explanation:
          "The final paragraph says Iker kept coming on Tuesdays \"ya no como comensal, sino como voluntario, igual que Ramón\" (no longer as a diner, but as a volunteer, just like Ramón).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She had planned to visit it all along", "She got on the wrong bus by mistake", "Her original hotel booking failed", "A friend recommended a detour"],
        correctIndex: 1,
        explanation:
          "The story says \"Sofía sintió pánico: había subido al autobús equivocado\" (Sofía panicked: she had gotten on the wrong bus).",
      },
      {
        type: "multiple-choice",
        question: "How did Sofía initially react to being lost?",
        options: ["She panicked", "She was completely indifferent", "She felt excited right away", "She called the police immediately"],
        correctIndex: 0,
        explanation:
          "The text explicitly states \"Sofía sintió pánico\" (Sofía felt panic) when she realized her mistake.",
      },
      {
        type: "multiple-choice",
        question: "What did the innkeeper say about travel plans?",
        options: ["Plans are always necessary for a good trip", "The best moments of a trip are rarely in the plan", "Tourists should avoid small villages", "She should complain to the bus company"],
        correctIndex: 1,
        explanation:
          "He tells her, \"los mejores momentos de un viaje casi nunca estén en el plan\" (the best moments of a trip are almost never part of the plan).",
      },
      {
        type: "multiple-choice",
        question: "How did the experience change Sofía's approach for the rest of the trip?",
        options: ["She stopped traveling and went home", "She left free time each day for the unexpected", "She returned to Piódão instead of continuing", "She planned her days even more strictly"],
        correctIndex: 1,
        explanation:
          "The story says she \"dejaba tiempo libre cada día para lo inesperado\" (left free time each day for the unexpected).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She simply never learned as a child by choice", "She nearly drowned in a pool as a child", "She got seasick easily", "A movie about sharks frightened her"],
        correctIndex: 1,
        explanation:
          "The story says she \"había estado a punto de ahogarse en una piscina\" (had nearly drowned in a pool) as a child.",
      },
      {
        type: "multiple-choice",
        question: "What did swimming teacher Dolores emphasize?",
        options: ["Swimming as fast as possible", "Going at her own pace, without forcing anything", "Competing with the other students", "Holding her breath as long as she could"],
        correctIndex: 1,
        explanation:
          "Dolores tells her, \"no te obligues a nada, ve a tu ritmo\" (don't force yourself into anything, go at your own pace).",
      },
      {
        type: "multiple-choice",
        question: "What breakthrough moment does Marisol experience?",
        options: ["She wins a swimming competition", "She floats on her back for the first time in 25 years", "She teaches another student to swim", "She buys her own kayak"],
        correctIndex: 1,
        explanation:
          "The text says she \"sintió que el agua la sostenía en vez de tragarla\" (felt the water holding her up instead of swallowing her), the first time in 25 years.",
      },
      {
        type: "multiple-choice",
        question: "What does Marisol do at the beach with her friends?",
        options: ["She refuses to go near the water", "She floats in the sea without panicking", "She goes home early from the trip", "She only watches from the sand"],
        correctIndex: 1,
        explanation:
          "The final paragraph says \"se metió en el mar hasta la cintura y se dejó flotar bajo el sol\" (she went into the sea up to her waist and let herself float under the sun).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["At a music school", "Through an online ad looking for musicians", "They were childhood friends", "At a family wedding"],
        correctIndex: 1,
        explanation:
          "Diego saw \"un anuncio en una aplicación: se buscan músicos para formar una banda\" (an ad in an app: musicians wanted to form a band).",
      },
      {
        type: "multiple-choice",
        question: "How did Diego feel playing guitar in front of others for the first time?",
        options: ["Completely confident", "Embarrassed, but he managed to do it anyway", "Bored by the experience", "Angry at his bandmates"],
        correctIndex: 1,
        explanation:
          "The story notes it was \"la primera vez que Diego tocó la guitarra delante de otras personas sin sentir que se moría de vergüenza\" (the first time Diego played in front of others without feeling like he was dying of embarrassment).",
      },
      {
        type: "multiple-choice",
        question: "How did Pablo feel about performing at the bar?",
        options: ["Excited from the very start", "Nervous and unsure he was ready", "Completely indifferent", "He refused to play at all"],
        correctIndex: 1,
        explanation:
          "Pablo says, \"No sé si estoy listo, nunca he tocado delante de desconocidos\" (I don't know if I'm ready, I've never played in front of strangers).",
      },
      {
        type: "multiple-choice",
        question: "What did the band members gain beyond musical skill?",
        options: ["A record deal", "A genuine friendship", "A large sum of money", "Widespread fame"],
        correctIndex: 1,
        explanation:
          "The ending says they found \"algo que ninguno de ellos esperaba encontrar en un anuncio de internet: una verdadera amistad\" (something none of them expected to find in an online ad: a real friendship).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She had an untreated learning disability", "She left school as a child to work in the fields", "She refused to be taught by anyone", "She had lost her reading glasses"],
        correctIndex: 1,
        explanation:
          "The story explains \"Rosa había dejado la escuela de niña para trabajar en el campo\" (Rosa had left school as a child to work in the fields).",
      },
      {
        type: "multiple-choice",
        question: "Why did Rosa reject the children's books Valentina first brought?",
        options: ["They were too expensive", "She wanted to read the newspaper like her neighbor, not children's stories", "She couldn't see the pictures well", "They were written in the wrong language"],
        correctIndex: 1,
        explanation:
          "Rosa says, \"No quiero leer cuentos de niños, quiero leer el periódico como hace mi vecina\" (I don't want to read children's stories, I want to read the newspaper like my neighbor does).",
      },
      {
        type: "multiple-choice",
        question: "What emotional milestone did Rosa reach after three months?",
        options: ["She read a letter from her grandson alone for the first time", "She published a short story", "She started teaching another student", "She got a library card for the first time"],
        correctIndex: 0,
        explanation:
          "The text says Rosa \"leyó sola, por primera vez en su vida, una carta que su nieto le había enviado\" (read alone, for the first time in her life, a letter her grandson had sent her).",
      },
      {
        type: "multiple-choice",
        question: "What did Rosa begin doing a year later?",
        options: ["Teaching literacy classes to other elders", "Writing a notebook of memories for her grandchildren", "Attending school full-time", "Working as a professional translator"],
        correctIndex: 1,
        explanation:
          "The story says Rosa \"había empezado a escribir...un cuaderno con recuerdos de su vida para sus nietos\" (had begun writing a notebook of memories from her life for her grandchildren).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She twisted her ankle on loose rocks", "She felt dizzy and had a headache from the altitude", "She got separated from the group", "She ran out of drinking water"],
        correctIndex: 1,
        explanation:
          "The story says Teresa \"empezó a sentirse mareada y con dolor de cabeza\" (began to feel dizzy and had a headache) as they climbed higher.",
      },
      {
        type: "multiple-choice",
        question: "What did the group decide to do when Teresa couldn't continue?",
        options: ["Leave her behind and continue to the summit", "All turn back together to keep her safe", "Call for a helicopter rescue", "Argue and split into two groups"],
        correctIndex: 1,
        explanation:
          "Marcos says, \"No la vamos a dejar aquí...bajaremos con ella, la cumbre estará ahí otro día\" (We're not going to leave her here...we'll go down with her, the summit will still be there another day).",
      },
      {
        type: "multiple-choice",
        question: "How did the friends experience the sunrise that day?",
        options: ["They missed it entirely", "They saw it from much lower on the mountain than planned", "They saw it from the summit as originally planned", "They rescheduled the whole trip"],
        correctIndex: 1,
        explanation:
          "The text says they \"vieron el amanecer de todos modos, aunque desde mucho más abajo de lo planeado\" (saw the sunrise anyway, although from much lower than planned).",
      },
      {
        type: "multiple-choice",
        question: "What did Teresa do a year later?",
        options: ["She never attempted the climb again", "She returned alone and reached the summit", "She moved permanently to Tenerife", "She became a professional mountain guide"],
        correctIndex: 1,
        explanation:
          "The story says Teresa \"volvió al Teide, esta vez sola y mejor preparada, y llegó a la cumbre justo antes del amanecer\" (returned to the Teide, this time alone and better prepared, and reached the summit just before sunrise).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Beatriz had asked for it herself", "Beatriz was overworked and not sleeping well", "It was an annual family tradition", "Beatriz was recovering from surgery"],
        correctIndex: 1,
        explanation:
          "The story says Beatriz \"llevaba meses sin dormir bien, revisando correos hasta la medianoche\" (had gone months without sleeping well, checking emails until midnight).",
      },
      {
        type: "multiple-choice",
        question: "How did Beatriz feel during the first hours of silence?",
        options: ["Relaxed right away", "Anxious, as if something important were missing", "Bored but calm", "Sleepy the entire time"],
        correctIndex: 1,
        explanation:
          "The text says she \"sintió una ansiedad que no esperaba, como si le faltara algo importante\" (felt an anxiety she didn't expect, as if something important were missing).",
      },
      {
        type: "multiple-choice",
        question: "What habit did Beatriz decide to let go of during the guided meditation?",
        options: ["Her job entirely", "The habit of answering emails at any hour", "Her phone forever", "Talking to her sister"],
        correctIndex: 1,
        explanation:
          "She thought about \"la costumbre de contestar correos a cualquier hora, algo que le había robado años de tranquilidad\" (the habit of answering emails at any hour, something that had stolen years of peace from her).",
      },
      {
        type: "multiple-choice",
        question: "What change did Beatriz make after returning to the city?",
        options: ["She quit her job at the law firm", "She turned off her phone every night after nine", "She moved to live in the mountains", "She stopped speaking to her sister"],
        correctIndex: 1,
        explanation:
          "The story says she \"decidió apagar el teléfono todas las noches a partir de las nueve\" (decided to turn off her phone every night starting at nine).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He had specifically asked for them", "He seemed withdrawn and depressed after his wife's death", "It was a long family tradition", "His doctor recommended art therapy"],
        correctIndex: 1,
        explanation:
          "The story says she was \"preocupada por verlo tan apagado\" (worried about seeing him so withdrawn) and gave him the paint set for that reason.",
      },
      {
        type: "multiple-choice",
        question: "What did Fernando notice about his paintings over time?",
        options: ["They were all portraits of strangers", "They mostly contained the color blue that his wife loved", "They were all landscapes of the countryside", "They were signed with his wife's name"],
        correctIndex: 1,
        explanation:
          "The text says \"casi todos tenían el color azul que tanto le gustaba a su esposa\" (almost all of them had the blue color his wife loved so much).",
      },
      {
        type: "multiple-choice",
        question: "What did Fernando say when a classmate asked why he painted so much blue?",
        options: ["He denied noticing the pattern", "\"Creo que sigo pintándola a ella sin saberlo\"", "He said blue paint was simply cheaper", "He said it was a coincidence and changed the subject"],
        correctIndex: 1,
        explanation:
          "Fernando admits, \"Creo que sigo pintándola a ella sin saberlo\" (I think I keep painting her without realizing it).",
      },
      {
        type: "multiple-choice",
        question: "What did the woman at the exhibition tell Fernando?",
        options: ["He should stop painting and rest", "It's never too late to start something that makes you feel alive", "He should sell his paintings for more money", "His art needed brighter colors"],
        correctIndex: 1,
        explanation:
          "She tells him, \"Nunca es tarde para empezar algo que te haga sentir vivo\" (It's never too late to start something that makes you feel alive).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A music festival left it dirty", "A storm washed debris ashore", "Tourists littered heavily over the summer", "A nearby shipwreck"],
        correctIndex: 1,
        explanation:
          "The story says the beach \"amaneció cubierta de plástico, redes de pesca rotas y basura que el mar había arrastrado\" (woke up covered in plastic, broken fishing nets, and trash the sea had dragged in) after the storm.",
      },
      {
        type: "multiple-choice",
        question: "How many volunteers showed up after Nadia's WhatsApp message?",
        options: ["Almost no one came", "More than thirty people", "Exactly ten people", "Only her own family"],
        correctIndex: 1,
        explanation:
          "The text says \"más de treinta personas llegaron con guantes, bolsas y ganas de ayudar\" (more than thirty people arrived with gloves, bags, and a desire to help).",
      },
      {
        type: "multiple-choice",
        question: "What did the group decide to do going forward?",
        options: ["Never clean the beach again", "Clean it every first Saturday of the month, not just after storms", "Wait for the government to take action", "Move their efforts to a different beach"],
        correctIndex: 1,
        explanation:
          "Hugo proposes, \"Hagámoslo un grupo fijo...así no esperamos a que llegue otra tormenta para actuar\" (Let's make this a regular group...that way we don't wait for another storm to act).",
      },
      {
        type: "multiple-choice",
        question: "What did the cleanup group eventually become?",
        options: ["A local political party", "An official association that also gave talks at the school", "A commercial fishing company", "A tourism agency"],
        correctIndex: 1,
        explanation:
          "The story says the group grew into \"una asociación con nombre propio, que organizaba limpiezas y también charlas en el colegio del pueblo\" (an association with its own name, which organized cleanups and also talks at the village school).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She had ongoing health problems", "She was shy and had never traveled alone before", "Japan was extremely expensive", "She didn't speak any foreign language at all"],
        correctIndex: 1,
        explanation:
          "The story says \"Yolanda era tímida y nunca había viajado sola a ningún sitio\" (Yolanda was shy and had never traveled alone anywhere).",
      },
      {
        type: "multiple-choice",
        question: "What did Hana advise Yolanda to do?",
        options: ["Stay in the hostel where it's safe", "Go out walking without any plan", "Only eat food from the hostel", "Avoid speaking with locals"],
        correctIndex: 1,
        explanation:
          "Hana tells her, \"Sal a caminar sin plan...en Kioto te vas a perder muchas veces, pero eso es parte del viaje\" (Go walk without a plan...in Kyoto you'll get lost many times, but that's part of the trip).",
      },
      {
        type: "multiple-choice",
        question: "What did the old man at the restaurant tell Yolanda?",
        options: ["To always order the same dish for safety", "To try new things even without knowing exactly what they are", "To avoid restaurants entirely", "To bring her own food from the hostel"],
        correctIndex: 1,
        explanation:
          "He says, \"Es importante que pruebes cosas nuevas aunque no sepas exactamente qué son\" (It's important to try new things even if you don't know exactly what they are).",
      },
      {
        type: "multiple-choice",
        question: "How did Yolanda change by the end of her trip?",
        options: ["She became fluent in Japanese", "She became more willing to talk to strangers and ask for help", "She decided she never wanted to travel again", "She decided to stay in Japan permanently"],
        correctIndex: 1,
        explanation:
          "The story says she \"ya se atrevía a hablar con desconocidos, a pedir ayuda cuando se perdía\" (already dared to talk to strangers, to ask for help when lost).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He genuinely loved deep water", "He was embarrassed to admit his fear in front of his friends", "It was required for his job", "He lost a bet with a friend"],
        correctIndex: 1,
        explanation:
          "The story says he was \"avergonzado de admitir su miedo, se apuntó también sin pensarlo demasiado\" (embarrassed to admit his fear, he signed up too without thinking much about it).",
      },
      {
        type: "multiple-choice",
        question: "What did instructor Julio do when he noticed Tomás's anxiety?",
        options: ["He made him quit the course", "He stopped to talk with him and let him practice extra time", "He ignored it and continued the lesson", "He told the group to laugh it off"],
        correctIndex: 1,
        explanation:
          "Julio tells him, \"Cuéntame qué te pasa, no vamos a avanzar hasta que te sientas seguro\" (Tell me what's wrong, we won't move forward until you feel safe).",
      },
      {
        type: "multiple-choice",
        question: "What happened during Tomás's first real dive in the ocean?",
        options: ["He panicked and left the water immediately", "His fear gradually calmed as he watched the colorful fish", "He got separated from the group", "His equipment malfunctioned"],
        correctIndex: 1,
        explanation:
          "The text says \"la respiración de Tomás se fue calmando, y empezó a fijarse en los peces de colores\" (Tomás's breathing gradually calmed, and he started noticing the colorful fish).",
      },
      {
        type: "multiple-choice",
        question: "What did the certificate mean to Tomás?",
        options: ["Just a formality needed for future travel", "A reminder that he had faced a fear he'd carried for almost fifteen years", "A requirement for a new job", "Nothing particularly important to him"],
        correctIndex: 1,
        explanation:
          "The story says he kept it \"como recuerdo de que había logrado enfrentar un miedo de casi quince años\" (as a reminder that he had managed to face a fear of almost fifteen years).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["An old car", "An old bicycle", "A small boat", "Only travel journals"],
        correctIndex: 1,
        explanation:
          "The story says he found \"una bicicleta vieja, guardada en el garaje desde hacía años\" (an old bicycle, stored in the garage for years).",
      },
      {
        type: "multiple-choice",
        question: "What had Bruno's father told him about the bicycle?",
        options: ["He had won it in a raffle", "He had once ridden it 500 km between his hometown and the city", "He built it himself as a hobby", "It had belonged to Bruno's grandfather"],
        correctIndex: 1,
        explanation:
          "His father had said he \"había recorrido en bicicleta los quinientos kilómetros entre su pueblo natal y la ciudad\" (had ridden the 500 kilometers between his hometown and the city by bicycle).",
      },
      {
        type: "multiple-choice",
        question: "What did the old woman in one village tell Bruno?",
        options: ["She had never heard of anyone like his father", "It was possible that a young man with the same surname had passed through decades earlier", "His father had lived in that village", "The road ahead was too dangerous"],
        correctIndex: 1,
        explanation:
          "She tells him, \"Es posible que fuera tu padre...aquí no pasa mucha gente en bicicleta\" (It's possible it was your father...not many people pass through here by bicycle).",
      },
      {
        type: "multiple-choice",
        question: "What did Bruno realize about inheritance at the end of the story?",
        options: ["Money is the only real inheritance", "Some inheritances live in memory and physical effort, not in a bank", "He wished he had sold the bicycle", "His father left him nothing meaningful"],
        correctIndex: 1,
        explanation:
          "The final line says \"algunas herencias no se guardan en un banco, sino en las piernas y en la memoria\" (some inheritances aren't kept in a bank, but in one's legs and memory).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To help him lose weight", "To push him out of his social comfort zone", "To help him earn more money", "To help him quit his accounting job"],
        correctIndex: 1,
        explanation:
          "The therapist suggested \"una actividad que lo sacara completamente de su zona de confort\" (an activity that would take him completely out of his comfort zone).",
      },
      {
        type: "multiple-choice",
        question: "What made the first salsa class especially difficult for Iván?",
        options: ["The music was too loud for him", "He had to touch strangers' hands and move in front of a huge mirror", "The class was too expensive for him", "He didn't understand Spanish"],
        correctIndex: 1,
        explanation:
          "The story says he had to \"tocar la mano de desconocidas, moverse al ritmo de la música delante de un espejo enorme\" (touch the hands of strangers, move to the music in front of a huge mirror).",
      },
      {
        type: "multiple-choice",
        question: "What did Iván notice that dancing forced him to do?",
        options: ["Avoid eye contact entirely", "Look his dance partner in the eyes, something nearly impossible for him elsewhere", "Speak much louder than usual", "Memorize long complicated routines"],
        correctIndex: 1,
        explanation:
          "The text says \"bailar lo obligaba a mirar a los ojos a su pareja de baile\" (dancing forced him to look his dance partner in the eyes).",
      },
      {
        type: "multiple-choice",
        question: "What happened at the end-of-course performance when Iván and Cecilia made mistakes?",
        options: ["They stopped and left the dance floor", "They laughed and kept dancing", "The teacher scolded them in front of everyone", "The audience booed them"],
        correctIndex: 1,
        explanation:
          "The story says \"ambos se rieron y siguieron bailando\" (both of them laughed and kept dancing).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She already had construction experience", "Something in the ad convinced her she needed to do something different that summer", "Her company required it as a work project", "She needed the extra money"],
        correctIndex: 1,
        explanation:
          "The story says \"algo en el anuncio la convenció de que necesitaba hacer algo distinto ese verano\" (something in the ad convinced her she needed to do something different that summer).",
      },
      {
        type: "multiple-choice",
        question: "What setback did the group face during the project?",
        options: ["They ran out of building materials", "Heavy rain caused them to lose several days of work", "A volunteer was seriously injured", "The family changed their minds about the house"],
        correctIndex: 1,
        explanation:
          "The text says \"empezó a llover mucho más de lo esperado, y varios días de trabajo se perdieron por el mal tiempo\" (it started raining much more than expected, and several work days were lost due to the weather).",
      },
      {
        type: "multiple-choice",
        question: "What did Doña Elvira say when the house was finished?",
        options: ["She complained about the design", "It was the first time in twenty years her children would sleep without fear of rain", "She wanted an even bigger house", "She only thanked the coordinator"],
        correctIndex: 1,
        explanation:
          "She says, \"Es la primera vez en veinte años que mis hijos van a dormir sin miedo a la lluvia\" (It's the first time in twenty years that my children will sleep without fear of the rain).",
      },
      {
        type: "multiple-choice",
        question: "What did Marta plan to do after returning home?",
        options: ["Never volunteer again", "Save money to return the next year for the same project", "Move to Centroamérica permanently", "Stop working as a designer"],
        correctIndex: 1,
        explanation:
          "The story says she \"ya estaba ahorrando para volver el año siguiente con el mismo proyecto\" (was already saving to return the following year for the same project).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["They didn't want to attend classes", "Their legal papers were not yet in order", "There was no school nearby", "Their parents refused to send them"],
        correctIndex: 1,
        explanation:
          "The story says they were \"sin ir a la escuela porque los papeles todavía no estaban en regla\" (not attending school because their papers were not yet in order).",
      },
      {
        type: "multiple-choice",
        question: "How did Custodia start teaching the children?",
        options: ["In a rented classroom with desks", "Sitting on the ground under the bridge with just a notebook and pencils", "Through online video calls", "At her own house"],
        correctIndex: 1,
        explanation:
          "The text says \"Se sentaban en el suelo, bajo el puente\" and she \"llevaba solo un cuaderno, unos lápices\" (they sat on the ground under the bridge, and she brought just a notebook and some pencils).",
      },
      {
        type: "multiple-choice",
        question: "What milestone did Yusuf reach?",
        options: ["He learned to write his full name", "He read his first complete word and could read the street name where he lived", "He passed an official school exam", "He started teaching another child"],
        correctIndex: 1,
        explanation:
          "The story says he \"aprendió a leer su primera palabra completa...por fin podía leer el nombre de la calle donde vivían\" (learned to read his first complete word...he could finally read the name of the street where they lived).",
      },
      {
        type: "multiple-choice",
        question: "What happened to the class eventually?",
        options: ["It was shut down by the authorities", "A local association offered a small heated space, and most children later joined official school", "Custodia stopped teaching entirely", "The children's families moved away"],
        correctIndex: 1,
        explanation:
          "The story mentions \"una asociación local que ofreció un local pequeño y calefacción\" and that later \"la mayoría de los niños había empezado por fin la escuela oficial\" (a local association offered a small space and heating, and most of the children finally started official school).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Professional photographer", "Delivery driver on a motorcycle", "Gallery owner", "Newspaper journalist"],
        correctIndex: 1,
        explanation:
          "The story says he \"trabajaba repartiendo paquetes en moto por toda la ciudad\" (worked delivering packages by motorcycle around the city).",
      },
      {
        type: "multiple-choice",
        question: "How did the gallery owner discover his photos?",
        options: ["He submitted them to a contest", "She saw them by chance on his social media account", "A mutual friend recommended him", "He walked into her gallery uninvited"],
        correctIndex: 1,
        explanation:
          "The text says she wrote to him \"después de ver sus fotos por casualidad\" (after seeing his photos by chance).",
      },
      {
        type: "multiple-choice",
        question: "What advice did the gallery owner give him about choosing photos?",
        options: ["Choose only the prettiest photos", "Choose the ones that tell something about him and his city", "Choose only black-and-white photos", "Choose only his most recent photos"],
        correctIndex: 1,
        explanation:
          "She tells him, \"no elijas las fotos más bonitas, elige las que cuenten algo sobre ti y sobre tu ciudad\" (don't choose the prettiest photos, choose the ones that tell something about you and your city).",
      },
      {
        type: "multiple-choice",
        question: "What did Ezequiel do after the exhibition?",
        options: ["He quit his delivery job immediately", "He kept delivering packages but also started taking small photography jobs on weekends", "He moved to another country", "He stopped taking photos altogether"],
        correctIndex: 1,
        explanation:
          "The story says he \"siguió repartiendo paquetes...también empezó a recibir encargos pequeños de fotografía los fines de semana\" (kept delivering packages...also started getting small photography jobs on weekends).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She loved extreme sports", "More out of obligation than real desire, since it was a company retreat", "She wanted to impress her boss specifically", "It was mandatory safety training"],
        correctIndex: 1,
        explanation:
          "The story says she signed up \"más por compromiso que por ganas reales de hacerlo\" (more out of obligation than real desire to do it).",
      },
      {
        type: "multiple-choice",
        question: "What did the guide Néstor emphasize before starting?",
        options: ["Setting speed records on the river", "That trust in the team was everything", "Individual skill above teamwork", "Staying completely silent at all times"],
        correctIndex: 1,
        explanation:
          "Néstor tells them, \"Aquí, la confianza en el equipo lo es todo\" (Here, trust in the team is everything).",
      },
      {
        type: "multiple-choice",
        question: "What did Cristina learn about her coworker Álvaro during the trip?",
        options: ["He was secretly afraid of water", "He felt invisible at the office and that no one noticed his work", "He wanted to quit his job soon", "He was the best swimmer in the company"],
        correctIndex: 1,
        explanation:
          "Álvaro tells her he had spent months \"sintiéndose invisible en la oficina, que nadie parecía notar su trabajo\" (feeling invisible at the office, like no one noticed his work).",
      },
      {
        type: "multiple-choice",
        question: "How did the team's office dynamic change after the trip?",
        options: ["It stayed exactly the same as before", "Coworkers greeted each other with more confidence and helped each other more", "They started avoiding each other", "Several coworkers quit their jobs"],
        correctIndex: 1,
        explanation:
          "The story says they \"se saludaban con más confianza...se ayudaban más entre ellos durante el trabajo\" (greeted each other with more confidence...helped each other more during work).",
      },
    ],
  },
];
