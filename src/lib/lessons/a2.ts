...
export const A2_LESSONS: Lesson[] = [
  ...
  {
    "slug": "preterite-irregular-verbs",
    "level": "A2",
    "number": 2,
  ...
  {
    "slug": "reflexive-verbs-daily-routine",
    "level": "A2",
    "number": 8,
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "Veo a María en el parque.", "en": "I see María in the park." },
        { "es": "Busco a mi hermano.", "en": "I'm looking for my brother." },
        { "es": "Llamo a mi amiga todos los días.", "en": "I call my friend every day." },
        { "es": "Veo al profesor en la oficina.", "en": "I see the professor in the office." },
        { "es": "Veo la casa desde aquí.", "en": "I see the house from here." },
        { "es": "Compro el libro nuevo.", "en": "I buy the new book." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "Hay dos estudiantes en la clase.", "en": "There are two students in class." },
        { "es": "Quiero a mi perro Rex.", "en": "I love my dog Rex." },
        { "es": "Veo animales en el zoológico.", "en": "I see animals at the zoo." },
        { "es": "No veo a nadie en la calle.", "en": "I don't see anybody on the street." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Cuál oración NO necesita la a personal?",
          "options": ["Busco ___ mi hermana.", "Leo ___ el periódico.", "Visito ___ mi tío.", "Llamo ___ Carlos."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        ...
        { "es": "Tengo tres hijos.", "en": "I have three children." },
        { "es": "Tengo a mi hija en brazos.", "en": "I have my daughter in my arms." },
        { "es": "Tengo al perro en el coche.", "en": "I have the dog in the car." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Qué oración usa correctamente el verbo tener?",
          "options": ["Tengo a dos hermanos menores.", "Tengo a mi hijo dormido en los brazos.", "Tengo a tres gatos en casa.", "Tengo a una prima en México."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        ...
        { "es": "ver", "en": "to see" },
        { "es": "conocer", "en": "to know / to meet" },
        { "es": "llamar", "en": "to call" },
        { "es": "visitar", "en": "to visit" },
        { "es": "ayudar", "en": "to help" },
        { "es": "esperar", "en": "to wait for" },
        { "es": "invitar", "en": "to invite" },
        { "es": "saludar", "en": "to greet" },
        { "es": "extrañar", "en": "to miss (someone)" },
      ...
      "checkpoint": [
        {
          ...
          "pairs": [
            ...
            { "left": "ver", "right": "to see" },
            { "left": "conocer", "right": "to know / to meet" },
            { "left": "llamar", "right": "to call" },
            { "left": "visitar", "right": "to visit" },
            { "left": "ayudar", "right": "to help" },
            { "left": "esperar", "right": "to wait for" },
            { "left": "invitar", "right": "to invite" },
            { "left": "saludar", "right": "to greet" },
            { "left": "extrañar", "right": "to miss (someone)" },
            { "left": "encontrar", "right": "to find" },
            { "left": "acompañar", "right": "to accompany" }
          ],
  ...
  "exercises": [
    {
      "type": "multiple-choice",
      "question": "¿Qué oración es correcta?",
      "options": ["Conozco a Pedro desde hace años.", "Conozco Pedro desde hace años.", "Conozco a la ciudad de Roma.", "Conozco al libro nuevo."],
      "correctIndex": 0,
    ...
    },
    {
      "type": "word-order",
      "prompt": "Ordena las palabras.",
      "words": ["Busco", "a", "mi", "amigo", "en", "el", "café"],
    ...
    },
    {
      ...
      "options": ["Veo ___ Juan en la tienda.", "Veo ___ la tienda desde mi casa.", "Ayudo ___ mi vecina con las compras.", "Leo ___ el periódico por la mañana.", "Invito ___ mis primos a la boda."],
    ...
    },
    {
      ...
      "altAnswers": ["Amo mucho a mi perro Max."],
...
},
{
  ...
  "level": "A2",
  "number": 14,
  "title": "Palabras Negativas y la Doble Negación",
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "No veo a nadie en la sala.", "en": "I don't see anybody in the room." },
        { "es": "Nadie viene a la fiesta.", "en": "Nobody is coming to the party." },
        { "es": "No tengo nada en la mochila.", "en": "I don't have anything in my backpack." },
        { "es": "Nunca voy al gimnasio los domingos.", "en": "I never go to the gym on Sundays." }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "Nunca como carne los viernes.", "en": "I never eat meat on Fridays." },
        { "es": "No conozco a nadie en esta ciudad.", "en": "I don't know anybody in this city." },
        { "es": "No tengo ningún interés en ese tema.", "en": "I have no interest in that topic." },
        { "es": "Ninguna de mis amigas habla alemán.", "en": "None of my friends speak German." },
        { "es": "No hay ninguna razón para preocuparse.", "en": "There's no reason to worry." }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Cuál es la forma correcta?",
          "options": ["No tengo ninguno problema.", "No tengo ningún problema.", "No tengo ninguna problema.", "No tengo nadie problema."],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "No hablo francés. Mi hermana tampoco habla francés.", "en": "I don't speak French. My sister doesn't speak French either." },
        { "es": "No quiero salir esta noche. Yo tampoco.", "en": "I don't want to go out tonight. Me neither." },
        { "es": "No como ni carne ni pescado.", "en": "I eat neither meat nor fish." },
        { "es": "Ni Juan ni Pedro vinieron a la reunión.", "en": "Neither Juan nor Pedro came to the meeting." },
        { "es": "No tengo ni tiempo ni dinero para el viaje.", "en": "I have neither time nor money for the trip." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Ordena las palabras.",
          "words": ["Ni", "mi", "padre", "ni", "mi", "madre", "cocinan", "hoy"],
    ...
    },
    {
      ...
      "examples": [
        ...
        { "es": "nada", "en": "nothing" },
        { "es": "alguno / alguna", "en": "some" },
        { "es": "ninguno / ninguna", "en": "none, not any" },
        { "es": "también", "en": "also" },
      ...
      "checkpoint": [
        {
          ...
          "pairs": [
            ...
            { "left": "alguien", "right": "somebody" },
            { "left": "nadie", "right": "nobody" },
            { "left": "algo", "right": "something" },
            { "left": "nada", "right": "nothing" },
            { "left": "alguno / alguna", "right": "some" },
            { "left": "ninguno / ninguna", "right": "none, not any" },
            { "left": "también", "right": "also" },
            { "left": "tampoco", "right": "neither, not either" },
            { "left": "o...o", "right": "either...or" },
            { "left": "ni...ni", "right": "neither...nor" }
          ],
  ...
  "exercises": [
    {
      ...
      "options": ["Nadie no viene a la fiesta.", "No viene nadie a la fiesta.", "No nadie viene a la fiesta.", "Viene no nadie a la fiesta."],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "altAnswers": ["She's never late to meetings."],
    ...
    },
    {
      ...
      "options": ["No tengo ningún problema.", "Tengo ningún problema.", "Nadie llama a la puerta.", "No nadie llama a la puerta.", "No hablo ni inglés ni francés."],
      "correctIndexes": [0, 2, 4],
...
},
{
  ...
  "sections": [
    {
      ...
      "examples": [
        { "es": "rápido → rápidamente", "en": "quickly" },
        { "es": "lento → lentamente", "en": "slowly" },
        { "es": "fácil → fácilmente", "en": "easily" },
        { "es": "feliz → felizmente", "en": "happily" },
        { "es": "elegante → elegantemente", "en": "elegantly" }
      ],
      "checkpoint": [
        {
          "type": "fill-blank",
    ...
    },
    {
      ...
      "examples": [
        { "es": "fácil → fácilmente", "en": "easily" },
        { "es": "difícil → difícilmente", "en": "with difficulty" },
        { "es": "rápido → rápidamente", "en": "quickly" },
        { "es": "común → comúnmente", "en": "commonly" },
        { "es": "cortés → cortésmente", "en": "courteously" }
      ],
      "checkpoint": [
        {
          "type": "multiple-choice",
          "question": "¿Cuál adverbio está escrito correctamente?",
          "options": ["dificilmente", "difícilmente", "difícilménte", "dificílmente"],
          "correctIndex": 1,
    ...
    },
    {
      ...
      "examples": [
        { "es": "Habló clara y lentamente.", "en": "She spoke clearly and slowly." },
        { "es": "Explicó el problema simple y directamente.", "en": "He explained the problem simply and directly." },
        { "es": "Trabaja rápida pero cuidadosamente.", "en": "She works quickly but carefully." },
        { "es": "Respondió honesta y abiertamente.", "en": "He answered honestly and openly." }
      ],
      "checkpoint": [
        {
          "type": "word-order",
          "prompt": "Ordena las palabras.",
          "words": ["Escribió", "el", "informe", "clara", "y", "cuidadosamente"],
    ...
    },
    {
      ...
      "examples": [
        ...
        { "es": "difícilmente", "en": "with difficulty" },
      ...
      "checkpoint": [
        {
          ...
          "pairs": [
            { "left": "rápidamente", "right": "quickly" },
            { "left": "lentamente", "right": "slowly" },
            { "left": "fácilmente", "right": "easily" },
            { "left": "difícilmente", "right": "with difficulty" },
            { "left": "claramente", "right": "clearly" },
            { "left": "simplemente", "right": "simply" },
            { "left": "felizmente", "right": "happily" },
            { "left": "honestamente", "right": "honestly" },
            { "left": "directamente", "right": "directly" },
            { "left": "cuidadosamente", "right": "carefully" },
            { "left": "generalmente", "right": "generally" },
            { "left": "especialmente", "right": "especially" }
          ],
  ...
  "exercises": [
    ...
    },
    {
      ...
      "options": ["Ella conduce cuidadosomente.", "Ella conduce cuidadosamente.", "Ella conduce cuidadomente.", "Ella conduce cuidadosoamente."],
      "correctIndex": 1,
    ...
    },
    {
      ...
      "options": ["rápidamente", "rapidamente", "fácilmente", "facilmente", "felizmente"],
      "correctIndexes": [0, 2, 4],
...
},
  {
    ...
    "level": "A2",
    "number": 16,
    "title": "Cómo Pedir y Dar Direcciones",
    ...
    "sections": [
      {
        ...
        "examples": [
          { "es": "Disculpe, ¿me puede ayudar? Estoy perdido.", "en": "Excuse me, can you help me? I'm lost." },
          { "es": "¿Cómo llego a la estación de tren?", "en": "How do I get to the train station?" },
          { "es": "¿Está lejos de aquí la farmacia?", "en": "Is the pharmacy far from here?" }
        ],
        "checkpoint": [
          {
            "type": "multiple-choice",
            "question": "¿Cuál es la forma más cortés de comenzar a pedir direcciones a un desconocido en la calle?",
            "options": ["Oye, dime cómo llegar.", "Perdón, ¿me puede ayudar?", "¿Qué haces?", "Ven aquí."],
            "correctIndex": 1,
      ...
      },
      {
        ...
        "examples": [
          { "es": "Siga derecho hasta el semáforo.", "en": "Go straight until the traffic light." },
          { "es": "Gire a la izquierda en la esquina.", "en": "Turn left at the corner." },
          { "es": "Tome la segunda calle a la derecha.", "en": "Take the second street on the right." },
          { "es": "Cruce la calle y el museo está enfrente.", "en": "Cross the street and the museum is in front." }
        ],
        "checkpoint": [
          {
            "type": "fill-blank",
      ...
      },
      {
        ...
        "examples": [
          { "es": "El banco está al lado del supermercado.", "en": "The bank is next to the supermarket." },
          { "es": "La plaza está entre la iglesia y el parque.", "en": "The square is between the church and the park." },
          { "es": "El hotel está a dos cuadras de aquí.", "en": "The hotel is two blocks from here." }
        ],
        "checkpoint": [
          {
            "type": "matching",
            ...
            "pairs": [
              { "left": "al lado de", "right": "next to" },
              { "left": "enfrente de", "right": "in front of / across from" },
              { "left": "detrás de", "right": "behind" },
              { "left": "a dos cuadras de", "right": "two blocks from" }
            ],
      ...
      },
      {
        ...
        "examples": [
          { "es": "Doble en la esquina donde está el semáforo.", "en": "Turn at the corner where the traffic light is." },
          { "es": "Cruce el cruce con mucho cuidado.", "en": "Cross the intersection very carefully." },
          { "es": "La plaza principal está cerca del cruce.", "en": "The main square is near the intersection." }
        ],
        "checkpoint": [
          {
            "type": "multi-select",
            "question": "¿Cuáles de las siguientes palabras son puntos de referencia útiles para dar direcciones?",
            "options": ["el semáforo", "la esquina", "el cumpleaños", "la plaza", "el paraguas", "el cruce"],
      ...
      },
      {
        ...
        "examples": [
          { "es": "Turista: Disculpe, señora, ¿me puede ayudar? Busco el Museo de Arte.", "en": "Tourist: Excuse me, ma'am, can you help me? I'm looking for the Art Museum." },
          { "es": "Señora: Claro. Siga derecho por esta calle dos cuadras.", "en": "Woman: Of course. Go straight down this street two blocks." },
          { "es": "Señora: Luego gire a la derecha en la esquina, al lado de la farmacia.", "en": "Woman: Then turn right at the corner, next to the pharmacy." },
          { "es": "Señora: Cruce la plaza y el museo está enfrente, detrás del semáforo.", "en": "Woman: Cross the square and the museum is in front, behind the traffic light." },
          { "es": "Turista: Muchas gracias, ¡es usted muy amable!", "en": "Tourist: Thank you very much, you're very kind!" }
        ],
        "checkpoint": [
          {
            "type": "fill-blank",
    ...
    "exercises": [
      {
        ...
        "options": ["Dobla a la izquierda", "Doble a la izquierda", "Doblas a la izquierda", "Doblar a la izquierda"],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": ["¿Cómo llego a...?", "Me gusta mucho este lugar.", "¿Dónde está...?", "Vivo aquí desde hace años.", "¿Está cerca de aquí?"],
        "correctIndexes": [0, 2, 4],
      ...
      },
      {
        ...
        "pairs": [
          { "left": "Siga derecho", "right": "Go straight" },
          { "left": "Gire a la derecha", "right": "Turn right" },
          { "left": "Cruce la calle", "right": "Cross the street" },
          { "left": "Tome la primera calle", "right": "Take the first street" }
        ],
      ...
      },
      {
        ...
        "altAnswers": ["Go straight until the square and then turn left.", "Keep going straight to the square and then turn left."],
      ...
      },
      {
        ...
        "altAnswers": ["Perdón, ¿el museo está lejos de aquí?", "Disculpe, ¿el museo está lejos de aquí?"],
      ...
      },
      {
        ...
        "words": ["Gire", "a", "la", "derecha", "en", "la", "esquina"],
      ...
      },
      {
        ...
        "options": ["Sigue derecho dos cuadras.", "Siga derecho dos cuadras.", "Sigues derecho dos cuadras.", "Seguir derecho dos cuadras."],
        "correctIndex": 1,
    ...
    "sections": [
      {
        ...
        "examples": [
          { "es": "Tengo una reserva a nombre de Carlos.", "en": "I have a reservation under the name Carlos." },
          { "es": "¿Tiene una mesa para dos, por favor?", "en": "Do you have a table for two, please?" },
          { "es": "¿Podríamos sentarnos junto a la ventana?", "en": "Could we sit by the window?" }
        ],
        "checkpoint": [
          {
            "type": "fill-blank",
      ...
      },
      {
        ...
        "examples": [
          { "es": "¿Nos puede traer la carta, por favor?", "en": "Could you bring us the menu, please?" },
          { "es": "El mesero nos recomendó el plato del día.", "en": "The waiter recommended the daily special to us." },
          { "es": "De postre, quiero un flan.", "en": "For dessert, I want a flan." }
        ],
        "checkpoint": [
          {
            "type": "multiple-choice",
            "question": "¿Cuál palabra se usa más comúnmente para 'waiter' en muchos países de Latinoamérica?",
            "options": ["el camarero", "el mesero", "el cocinero", "el cliente"],
            "correctIndex": 1,
      ...
      },
      {
        ...
        "examples": [
          { "es": "Para mí, la ensalada César, por favor.", "en": "For me, the Caesar salad, please." },
          { "es": "Yo quisiera el pescado a la plancha.", "en": "I would like the grilled fish." },
          { "es": "¿Qué me recomienda usted?", "en": "What do you recommend (to me)?" }
        ],
        "checkpoint": [
          {
            "type": "multiple-choice",
            "question": "¿Cuál de estas frases suena más educada y natural al pedir en un restaurante?",
            "options": ["Yo quiero el pollo.", "Yo quisiera el pollo.", "Dame el pollo.", "Yo como el pollo."],
            "correctIndex": 1,
      ...
      },
      {
        ...
        "examples": [
          { "es": "¿Me podría traer un poco más de pan?", "en": "Could you bring me a bit more bread?" },
          { "es": "Soy alérgica a los mariscos.", "en": "I'm allergic to shellfish." },
      ...
      },
      {
        ...
        "examples": [
          ...
          { "es": "¿Podemos dividir la cuenta?", "en": "Can we split the check?" }
        ],
        "checkpoint": [
          {
            "type": "translate",
            ...
            "altAnswers": ["¿Podemos pagar con la tarjeta?"],
      ...
      },
      {
        ...
        "examples": [
          { "es": "¿Qué le puedo ofrecer para beber?", "en": "What can I get you to drink?" },
          { "es": "No se preocupe, no lleva frutos secos.", "en": "Don't worry, it doesn't have nuts in it." }
        ],
        "checkpoint": [
          {
            "type": "multi-select",
            "question": "Según el diálogo, ¿qué dos cosas pide la clienta al final de la comida? Selecciona ambas.",
            "options": ["La carta", "La cuenta", "Pagar con tarjeta", "Una mesa junto a la ventana"],
            "correctIndexes": [1, 2],
    ...
    "exercises": [
      {
        ...
        "options": ["¿Me podría traer la cuenta?", "¿Tiene una mesa para dos?", "Soy vegetariano.", "¿Está incluida la propina?"],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": ["el camarero", "el mesero", "el cocinero", "la camarera"],
      ...
      },
      {
        ...
        "pairs": [
          { "left": "La cuenta, por favor.", "right": "The check, please." },
          { "left": "Soy alérgico a los mariscos.", "right": "I'm allergic to shellfish." },
          { "left": "¿Está incluida la propina?", "right": "Is the tip included?" },
          { "left": "¿Podemos dividir la cuenta?", "right": "Can we split the check?" }
        ],
      ...
      },
      {
        ...
        "altAnswers": ["Could you bring me a bit more water, please?"],
      ...
      },
      {
        ...
        "altAnswers": ["Soy vegetariana. ¿Tiene algo sin carne?", "Soy vegetariano/a. ¿Tienen algo sin carne?"],
      ...
      },
      {
        ...
        "words": ["¿Nos", "podría", "traer", "la", "cuenta,", "por", "favor?"],
      ...
      },
      {
        ...
        "options": ["Para pedir la cuenta", "Para confirmar que el plato del día no los contiene", "Para reservar una mesa", "Para pagar con tarjeta"],
        "correctIndex": 1,
...
{
  "slug": "preterite-drill",
  "level": "A2",
  "number": 18,
  "title": "El Pretérito: Práctica Extra",
...
{
  "slug": "imperfect-drill",
  "level": "A2",
  "number": 19,
  "title": "El Imperfecto: Práctica Extra",
...
{
  "slug": "preterite-vs-imperfect-drill",
  "level": "A2",
  "number": 20,
  "title": "Pretérito vs. Imperfecto: Práctica Extra",
...
{
  "slug": "object-pronouns-drill",
  "level": "A2",
  "number": 21,
  "title": "Pronombres de Objeto Directo e Indirecto: Práctica Extra",
...
{
  "slug": "reflexive-verbs-drill",
  "level": "A2",
  "number": 22,
  "title": "Verbos Reflexivos y Rutina Diaria: Práctica Extra",
...
{
  "slug": "comparisons-superlatives-drill",
  "level": "A2",
  "number": 23,
  "title": "Comparaciones y Superlativos: Práctica Extra",
...
{
  "slug": "future-tense-drill",
  "level": "A2",
  "number": 24,
  "title": "El Futuro: Práctica Extra",
...
{
  "slug": "por-vs-para-drill",
  "level": "A2",
  "number": 25,
  "title": "Por vs. Para: Práctica Extra",
...
{
  "slug": "personal-a-negation-mente-drill",
  "level": "A2",
  "number": 26,
  "title": "La A Personal, Negación y Adverbios en -mente: Práctica Extra",
  ...
  {
    "slug": "a2-vocabulary-practice-part-1",
    "level": "A2",
    "number": 27,
    "title": "A2 Vocabulary Practice (Part 1 of 2)",
    ...
    "exercises": [
      ...
      },
      {
        ...
        "answer": "tanto como",
        "altAnswers": ["tanta como", "tantos como", "tantas como"],
  ...
  {
    "slug": "a2-vocabulary-practice-part-2",
    "level": "A2",
    "number": 28,
    "title": "A2 Vocabulary Practice (Part 2 of 2)",
    "summary": "Test yourself on all 300 words from the A2 vocabulary lists, grouped by lesson.",
    "duration": "25 min",
    "sections": [
      {
    ...
    exercises: [
      {
        ...
        options: ["He hears a loud noise", "He chases a cat", "He sees another dog", "He runs after a ball"],
        correctIndex: 1,
        explanation:
          "\"un gato cruza el camino y Toby corre muy rápido detrás de él\" — a cat crosses the path and Toby runs fast after it.",
      },
      {
        type: "multiple-choice",
        question: "How does Rosa figure out how to contact Tomás's family?",
        options: ["A neighbor recognizes the dog", "She sees a poster", "She reads the phone number on his collar", "She asks people in the park"],
        correctIndex: 2,
        explanation:
          "\"Rosa mira el collar del perro y ve un número de teléfono\" — Rosa looks at the dog's collar and sees a phone number.",
      },
      {
        type: "multiple-choice",
    ...
    exercises: [
      {
        ...
        options: ["They lose their flashlight", "Their tent falls down twice", "They get lost on the trail", "They forget their sleeping bags"],
        correctIndex: 1,
        explanation:
          "\"la tienda se cae dos veces\" — the tent falls down twice.",
      },
      {
        type: "multiple-choice",
        question: "What do the students do when it starts raining the next morning?",
        options: ["They go home early", "They play cards and tell jokes inside the tent", "They keep hiking anyway", "They build a fire inside the tent"],
        correctIndex: 1,
        explanation:
          "\"juegan a las cartas y cuentan chistes dentro de la tienda\" — they play cards and tell jokes inside the tent.",
      },
      {
        type: "multiple-choice",
        question: "Who scores the winning goal in the soccer match?",
        options: ["Carla", "The teacher", "Marco", "The guide"],
        correctIndex: 2,
        explanation:
          "\"Marco anota el gol de la victoria\" — Marco scores the winning goal.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: ["Their teacher", "Their father", "Their friend", "Nobody, they figure it out alone"],
        correctIndex: 1,
        explanation:
          "\"su papá habla con ellos\" and suggests they try working together — their dad talks to them.",
      },
      {
        type: "multiple-choice",
        question: "What grade do they get on the project?",
        options: ["A failing grade", "An average grade", "The highest grade in the class", "They don't finish in time"],
        correctIndex: 2,
        explanation:
          "\"La profesora les da la nota más alta de la clase\" — the teacher gives them the highest grade in the class.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He calls the police", "He stops his truck to help", "He drives away", "He takes their picture"],
        correctIndex: 1,
        explanation:
          "\"un camión pasa por la carretera y el conductor para para ayudar\" — a truck passes and the driver stops to help.",
      },
      {
        type: "multiple-choice",
        question: "Why is it notable that Pedro fixes the car?",
        options: ["He is not actually a mechanic", "The shop is closed but he helps anyway", "He charges too much money", "He refuses at first"],
        correctIndex: 1,
        explanation:
          "\"El taller está cerrado los domingos... y decide ayudar de todas formas\" — the shop is closed on Sundays but he decides to help anyway.",
      },
      {
        type: "multiple-choice",
        question: "What does the family do while waiting for the repair?",
        options: ["They sleep in the truck", "They walk around town and buy ice cream", "They call another mechanic", "They go back to the car"],
        correctIndex: 1,
        explanation:
          "\"Descubren una plaza pequeña con una heladería y compran helados de chocolate\" — they discover a small plaza with an ice cream shop and buy chocolate ice cream.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["At school assemblies", "Only in her room", "At family parties", "In the school choir"],
        correctIndex: 1,
        explanation:
          "\"solo canta en su habitación, nunca delante de otras personas\" — she only sings in her room, never in front of other people.",
      },
      {
        type: "multiple-choice",
        question: "Who encourages Valentina to sign up for the talent show?",
        options: ["Her mom", "Her teacher", "Camila, her best friend", "The presenter"],
        correctIndex: 2,
        explanation:
          "\"Su mejor amiga, Camila, la anima a inscribirse en el show\" — her best friend Camila encourages her to sign up.",
      },
      {
        type: "multiple-choice",
        question: "What does Camila do during Valentina's performance that helps her?",
        options: ["She sings along loudly", "She sits in the front row smiling and giving a thumbs up", "She records a video", "She waits backstage"],
        correctIndex: 1,
        explanation:
          "Valentina sees Camila \"en la primera fila, sonriendo y levantando el pulgar\" — in the front row, smiling and giving a thumbs up.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["How much water plants need", "How light affects plant growth", "How music affects plants", "How soil type affects plants"],
        correctIndex: 1,
        explanation:
          "\"Deciden estudiar cómo crecen las plantas con diferentes tipos de luz\" — they decide to study how plants grow with different types of light.",
      },
      {
        type: "multiple-choice",
        question: "What happens to the plant kept without any light?",
        options: ["It grows the fastest", "It turns yellow", "It grows flowers", "Nothing changes"],
        correctIndex: 1,
        explanation:
          "\"La planta sin luz empieza a ponerse amarilla\" — the plant without light starts turning yellow.",
      },
      {
        type: "multiple-choice",
        question: "What do they receive at the end of the fair?",
        options: ["First prize", "Nothing at all", "A special mention for their clear presentation", "A trip to a science museum"],
        correctIndex: 2,
        explanation:
          "\"reciben una mención especial por su presentación clara\" — they receive a special mention for their clear presentation.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He goes to the bathroom", "He is absorbed reading about a dinosaur skeleton and doesn't notice the class leave", "He falls asleep on a bench", "He decides to leave early"],
        correctIndex: 1,
        explanation:
          "\"Lee cada palabra del cartel y no se da cuenta de que su clase ya sale de la sala\" — he reads every word of the sign and doesn't notice his class already leaving.",
      },
      {
        type: "multiple-choice",
        question: "Who helps Bruno while he is lost?",
        options: ["A security guard", "A museum guide named Marisol", "Another student", "His teacher immediately"],
        correctIndex: 1,
        explanation:
          "\"Una guía del museo, llamada Marisol, ve a Bruno solo\" — a museum guide named Marisol sees Bruno alone.",
      },
      {
        type: "multiple-choice",
        question: "How does Mr. Fernández react when he finds Bruno?",
        options: ["He is angry and ignores him", "He hugs him with relief but tells him not to separate from the group", "He doesn't notice anything wrong", "He sends Bruno home"],
        correctIndex: 1,
        explanation:
          "\"abraza a Bruno con alivio... pero también está feliz de encontrarlo\" — he hugs Bruno with relief and is happy to find him, while also warning him.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She doesn't like her cousin", "She is scared of deep water because she doesn't swim well", "She is afraid of the kayaks", "She dislikes the lake house"],
        correctIndex: 1,
        explanation:
          "\"tiene miedo del agua profunda porque no sabe nadar muy bien\" — she is afraid of deep water because she doesn't swim very well.",
      },
      {
        type: "multiple-choice",
        question: "What does grandpa give Sara to help her feel safer?",
        options: ["A kayak of her own", "A life jacket", "Swimming goggles", "A pool float"],
        correctIndex: 1,
        explanation:
          "\"el abuelo le ofrece a Sara un chaleco salvavidas especial\" — grandpa offers Sara a special life jacket.",
      },
      {
        type: "multiple-choice",
        question: "What does Sara do on Sunday before leaving?",
        options: ["She refuses to go near the water again", "She swims a bit farther on her own with the life jacket", "She only walks along the shore again", "She goes home without trying the water"],
        correctIndex: 1,
        explanation:
          "\"Sara nada un poco más lejos con su chaleco salvavidas, sin ayuda de nadie\" — Sara swims a bit farther with her life jacket, without anyone's help.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She runs out of chocolate", "Her oven breaks", "She forgets the recipe", "Her dad won't help her"],
        correctIndex: 1,
        explanation:
          "\"El horno de su casa se rompe y no puede terminar su pastel\" — her home oven breaks and she can't finish her cake.",
      },
      {
        type: "multiple-choice",
        question: "What does Leo do when he learns about Emma's problem?",
        options: ["He tells her to give up", "He invites her to cook at his house", "He buys her a new oven", "He enters the contest for her"],
        correctIndex: 1,
        explanation:
          "\"Vamos a mi casa a cocinar los dos,\" dice Leo — Leo says let's go to my house to cook together.",
      },
      {
        type: "multiple-choice",
        question: "Who wins first prize in the competition?",
        options: ["Emma's chocolate cake", "Leo's lemon cookies", "Neither of them", "Both tie for first"],
        correctIndex: 1,
        explanation:
          "\"el director anuncia que las galletas de Leo ganan el primer premio\" — the director announces that Leo's cookies win first prize.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["His teacher", "His neighbor, Mr. Ortiz", "Valeria", "His father"],
        correctIndex: 1,
        explanation:
          "Iker asks his neighbor to teach him: \"¿Me puede enseñar?\" and \"El señor Ortiz acepta felizmente.\"",
      },
      {
        type: "multiple-choice",
        question: "What happens in Iker's first tournament game?",
        options: ["He wins easily", "He loses to Valeria", "The game is canceled", "He ties with his opponent"],
        correctIndex: 1,
        explanation:
          "\"después de cuarenta minutos, pierde la partida\" — after forty minutes, he loses the game.",
      },
      {
        type: "multiple-choice",
        question: "How does Valeria react after beating Iker?",
        options: ["She brags about winning", "She kindly shows him his mistake", "She refuses to talk to him", "She tells him to quit chess"],
        correctIndex: 1,
        explanation:
          "\"Valeria le muestra el error con paciencia\" — Valeria patiently shows him the mistake, telling him he played well for being new.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Bea said something mean at school", "Bea didn't come over or reply to her invitation message", "Bea canceled plans out loud", "Bea moved to a new house"],
        correctIndex: 1,
        explanation:
          "\"Bea nunca llega ni responde el mensaje\" — Bea never arrives or responds to the message.",
      },
      {
        type: "multiple-choice",
        question: "What was the real reason Bea didn't respond?",
        options: ["She was busy with family", "Her phone had a technical problem, so the messages never arrived", "She was angry at Nora", "She forgot about the invitation"],
        correctIndex: 1,
        explanation:
          "\"descubre que los mensajes de Nora nunca llegaron por un error técnico\" — she discovers Nora's messages never arrived due to a technical error.",
      },
      {
        type: "multiple-choice",
        question: "What do the two friends decide to do differently going forward?",
        options: ["Never text again", "Call each other by phone instead of only texting", "Stop hanging out on Fridays", "Get new phones together"],
        correctIndex: 1,
        explanation:
          "\"las dos deciden llamarse por teléfono en lugar de solo enviar mensajes\" — the two decide to call each other by phone instead of only sending messages.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Their mom asked for one", "Their mom works a lot and never celebrates her own birthday", "It's a family tradition", "Their dad forgot her birthday last year"],
        correctIndex: 1,
        explanation:
          "\"Su mamá trabaja mucho y nunca tiene tiempo para celebrar su propio cumpleaños\" — their mom works a lot and never has time to celebrate her own birthday.",
      },
      {
        type: "multiple-choice",
      ...
      },
      {
        ...
        options: ["They send her shopping", "Dad takes her to a restaurant", "She goes to work", "She takes a nap"],
        correctIndex: 1,
        explanation:
          "\"el papá lleva a su esposa a comer a un restaurante especial\" — dad takes his wife to eat at a special restaurant.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The car breaks down", "It rains all day", "The hotel closes", "They lose their swimsuits"],
        correctIndex: 1,
        explanation:
          "\"empieza a llover mucho\" — it starts to rain a lot on the first day.",
      },
      {
        type: "multiple-choice",
        question: "What do they cook together in the hotel kitchen?",
        options: ["Tacos", "Homemade pizza", "A birthday cake", "Soup"],
        correctIndex: 1,
        explanation:
          "\"Los cuatro preparan pizza casera\" — the four of them prepare homemade pizza.",
      },
      {
        type: "multiple-choice",
        question: "How do the kids feel about the rainy day by the end?",
        options: ["They are still upset about it", "They think it was one of the best memories of the trip", "They want to leave the vacation early", "They forget about it quickly"],
        correctIndex: 1,
        explanation:
          "\"todos hablan sobre el día de lluvia como uno de los mejores recuerdos del viaje\" — everyone talks about the rainy day as one of the best memories of the trip.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Luna is very sick", "She has never taken an animal to the doctor before", "The vet clinic is far away", "Luna doesn't like her mom"],
        correctIndex: 1,
        explanation:
          "\"se pone nerviosa porque nunca ha llevado a un animal al doctor\" — she gets nervous because she has never taken an animal to the doctor.",
      },
      {
        type: "multiple-choice",
        question: "What does the vet do besides examine Luna?",
        options: ["Gives her a haircut", "Gives her two vaccines", "Takes her home for a night", "Puts her on a diet"],
        correctIndex: 1,
        explanation:
          "\"la doctora le pone dos vacunas pequeñas a Luna\" — the doctor gives Luna two small vaccines.",
      },
      {
        type: "multiple-choice",
        question: "How does Martina help Luna during the visit?",
        options: ["She leaves the room", "She talks to her softly and holds her carefully", "She gives her treats constantly", "She lets another kid hold her"],
        correctIndex: 1,
        explanation:
          "\"Martina la sostiene con cuidado... y le habla con voz dulce\" — Martina holds her carefully and speaks to her in a sweet voice.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["The park is getting a new playground", "The neighborhood park is full of trash", "The school asked them to", "They want to earn money"],
        correctIndex: 1,
        explanation:
          "\"El parque del barrio de Teo está lleno de basura desde hace meses\" — the neighborhood park has been full of trash for months.",
      },
      {
        type: "multiple-choice",
        question: "Who donates bags and gloves for the volunteers?",
        options: ["The school", "The supermarket lady", "The city government", "The bakery owner"],
        correctIndex: 1,
        explanation:
          "\"la señora del supermercado... acepta donar bolsas de basura y guantes\" — the supermarket lady agrees to donate trash bags and gloves.",
      },
      {
        type: "multiple-choice",
        question: "What do they discover while cleaning the park?",
        options: ["An old bicycle", "A hidden area with wooden benches", "A lost dog", "A small pond"],
        correctIndex: 1,
        explanation:
          "\"descubren un pequeño espacio con bancos de madera\" — they discover a small space with wooden benches, previously covered by plants and trash.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["A talking tree", "The lead role of a princess", "The narrator", "A background dancer"],
        correctIndex: 1,
        explanation:
          "\"Alicia consigue el papel principal: una princesa valiente\" — Alicia gets the main role: a brave princess.",
      },
      {
        type: "multiple-choice",
        question: "What happens during an important rehearsal?",
        options: ["She trips on the stage", "She forgets a long part of her dialogue", "She arrives late", "She loses her costume"],
        correctIndex: 1,
        explanation:
          "\"Alicia olvida completamente una parte larga de su diálogo\" — Alicia completely forgets a long part of her dialogue.",
      },
      {
        type: "multiple-choice",
        question: "Who helps Alicia practice her lines after rehearsals?",
        options: ["The teacher, Mr. Cabrera", "Her friend Diego", "Her parents", "Nobody, she practices alone"],
        correctIndex: 1,
        explanation:
          "\"los dos practican las líneas de Alicia en el patio de la escuela\" — Diego and Alicia practice her lines together in the school yard.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Cooking", "Knitting", "Gardening", "Painting"],
        correctIndex: 1,
        explanation:
          "\"Abuela, ¿me puedes enseñar a tejer?\" — Valeria asks her grandmother to teach her to knit.",
      },
      {
        type: "multiple-choice",
        question: "What problem does Valeria have when she first tries?",
        options: ["She has no yarn", "Her hands don't move correctly and the yarn gets tangled", "She loses the needles", "Her grandmother refuses to help"],
        correctIndex: 1,
        explanation:
          "\"Sus manos no se mueven de la manera correcta, y la lana se enreda varias veces\" — her hands don't move the right way and the yarn tangles several times.",
      },
      {
        type: "multiple-choice",
        question: "What does Valeria make by the end of the summer?",
        options: ["A sweater for herself", "A small blue scarf she gives to her mom", "A blanket for her grandmother", "A hat for her cousin"],
        correctIndex: 1,
        explanation:
          "\"una bufanda pequeña de color azul... Decide dársela a su mamá como regalo\" — a small blue scarf, which she decides to give to her mom as a gift.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To buy a video game", "To buy a new bicycle", "To pay for school supplies", "To go on a trip"],
        correctIndex: 1,
        explanation:
          "\"Óscar quiere comprar una bicicleta nueva, pero no tiene suficiente dinero ahorrado\" — Óscar wants to buy a new bicycle but hasn't saved enough money.",
      },
      {
        type: "multiple-choice",
        question: "What do they add on the second day to sell more?",
        options: ["Ice cream", "Homemade cookies", "Fruit juice", "Sandwiches"],
        correctIndex: 1,
        explanation:
          "\"agregan galletas caseras para vender junto con la limonada\" — they add homemade cookies to sell along with the lemonade.",
      },
      {
        type: "multiple-choice",
        question: "How long does it take Óscar to save enough money for the bike?",
        options: ["One weekend", "Three weekends", "A whole summer", "One year"],
        correctIndex: 1,
        explanation:
          "\"Después de tres fines de semana, Óscar finalmente tiene suficiente dinero\" — after three weekends, Óscar finally has enough money.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["You must always pay the full listed price", "You can negotiate the price of things", "Only adults can buy items", "The market only accepts exact change"],
        correctIndex: 1,
        explanation:
          "\"en el mercado, a veces se puede negociar el precio de las cosas\" — at the market, you can sometimes negotiate the price of things.",
      },
      {
        type: "multiple-choice",
        question: "What food does Camila try for the first time?",
        options: ["A cheese taco", "A hamburger", "Fried chicken", "Ice cream"],
        correctIndex: 0,
        explanation:
          "\"Camila prueba un taco de queso por primera vez y le encanta el sabor\" — Camila tries a cheese taco for the first time and loves the taste.",
      },
      {
        type: "multiple-choice",
        question: "Who does Camila meet at the market, and what do they have in common?",
        options: ["Ximena, who also likes drawing", "A boy who also likes soccer", "A tourist from her own country", "Her cousin, who she hadn't seen in years"],
        correctIndex: 0,
        explanation:
          "Camila meets Ximena and they \"descubren que a ambas les gusta dibujar\" — they discover they both like drawing.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Their 50th wedding anniversary", "Rosa's birthday", "Antonio's retirement", "Elena's birthday"],
        correctIndex: 0,
        explanation:
          "The story says they \"celebraban cincuenta años de casados\" (they were celebrating fifty years of marriage), meaning their anniversary.",
      },
      {
        type: "multiple-choice",
        question: "What did the grandparents think would happen when they arrived at the house?",
        options: ["A surprise party", "A quiet lunch with their daughter", "A trip to the market", "A doctor's appointment"],
        correctIndex: 1,
        explanation:
          "The text says \"Pensaban que iban a comer un almuerzo tranquilo con su hija\" (They thought they were going to have a quiet lunch with their daughter).",
      },
      {
        type: "multiple-choice",
        question: "What gift did Elena give her grandmother?",
        options: ["A photo album", "A new dress", "Flowers", "A cake"],
        correctIndex: 0,
        explanation:
          "\"Elena le dio a su abuela un álbum nuevo con fotos de toda la familia\" means Elena gave her grandmother a new photo album.",
      },
      {
        type: "multiple-choice",
        question: "What did the grandparents do after eating the cake?",
        options: ["They opened more presents", "They danced a slow song", "They went home early", "They played games with the kids"],
        correctIndex: 1,
        explanation:
          "\"los abuelos bailaron una canción lenta en el centro del jardín\" states the grandparents danced a slow song in the middle of the garden.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        correctIndex: 1,
        explanation:
          "The story states \"Diego tenía ocho años\" (Diego was eight years old).",
      },
      {
        type: "multiple-choice",
        question: "What did Diego do to help his tired aunt?",
        options: ["He cooked dinner for her", "He bought her flowers and a card", "He cleaned her house", "He babysat all night"],
        correctIndex: 1,
        explanation:
          "\"Fue a la tienda para comprarle flores y una tarjeta\" means he went to the store to buy her flowers and a card.",
      },
      {
        type: "multiple-choice",
        question: "What did Diego say while holding baby Mateo?",
        options: ["\"You are so small\"", "\"I will be your favorite cousin\"", "\"Please stop crying\"", "\"You look like your mom\""],
        correctIndex: 1,
        explanation:
          "Diego whispered \"Voy a ser tu primo favorito\" (I am going to be your favorite cousin).",
      },
      {
        type: "multiple-choice",
        question: "According to the story, what will Diego do in the future?",
        options: ["Move away", "Teach Mateo to ride a bike", "Become a teacher", "Travel to Argentina"],
        correctIndex: 1,
        explanation:
          "The final line says \"En el futuro, Diego le enseñará a andar en bicicleta\" (In the future, Diego will teach him to ride a bike).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Father's Day", "Mother's Day", "Christmas", "A birthday"],
        correctIndex: 1,
        explanation:
          "The story begins \"Era el Día de las Madres\" (It was Mother's Day).",
      },
      {
        type: "multiple-choice",
        question: "Why did their mom come downstairs quickly?",
        options: ["She smelled smoke", "She heard a plate break", "The doorbell rang", "She heard the kids arguing"],
        correctIndex: 1,
        explanation:
          "\"El ruido del plato despertó a su mamá\" means the noise of the plate woke up their mom.",
      },
      {
        type: "multiple-choice",
        question: "What happened to the eggs?",
        options: ["They were perfect", "They were a little burnt", "They were too salty", "They were cold"],
        correctIndex: 1,
        explanation:
          "\"Los huevos estaban un poco quemados\" states the eggs were a little burnt.",
      },
      {
        type: "multiple-choice",
        question: "What did the kids promise to do?",
        options: ["Never cook again", "Make breakfast again next year", "Buy their mom a gift", "Clean the kitchen every day"],
        correctIndex: 1,
        explanation:
          "\"Camila y Tomás prometieron hacer el desayuno otra vez el próximo año\" means they promised to make breakfast again next year.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Rain", "Ants", "A dog", "The heat"],
        correctIndex: 1,
        explanation:
          "\"cientos de hormigas caminaban por toda la comida\" tells us hundreds of ants were walking all over the food.",
      },
      {
        type: "multiple-choice",
        question: "Who helped the family after the food problem?",
        options: ["A park ranger", "A man selling food nearby", "Another relative", "A police officer"],
        correctIndex: 1,
        explanation:
          "A stranger said \"Yo vendo comida allí, cerca del lago. Puedo ayudarlos\" (I sell food there, near the lake. I can help you).",
      },
      {
        type: "multiple-choice",
        question: "Where did the family eat the second time?",
        options: ["At a restaurant", "In their car", "Under the tree, away from the ants", "At the man's food stand"],
        correctIndex: 2,
        explanation:
          "\"Los niños comieron sándwiches nuevos debajo del árbol, lejos de las hormigas\" means the kids ate new sandwiches under the tree, away from the ants.",
      },
      {
        type: "multiple-choice",
    ...
    exercises: [
      {
        ...
        options: ["Argentina", "Spain", "Mexico", "Chile"],
        correctIndex: 0,
        explanation:
          "The story opens with \"El tío José vivía en Argentina desde hacía quince años\" (Uncle José had lived in Argentina for fifteen years).",
      },
      {
        type: "multiple-choice",
        question: "How did the children know their uncle before his visit?",
        options: ["They had met him many times", "Only through video calls", "From photos their dad showed them", "They had never heard of him"],
        correctIndex: 1,
        explanation:
          "\"no conocían a su tío en persona; solo lo veían por videollamada\" means they didn't know their uncle in person, only through video calls.",
      },
      {
        type: "multiple-choice",
        question: "What did José say when he saw the kids at the airport?",
        options: ["\"You are taller than in the photos\"", "\"You look just like your mother\"", "\"I almost didn't recognize you\"", "\"You are much older than I thought\""],
        correctIndex: 0,
        explanation:
          "He said \"Ustedes son más altos que en las fotos\" (You are taller than in the photos).",
      },
      {
        type: "multiple-choice",
        question: "What did the grandmother cook for José?",
        options: ["Pizza", "His favorite food: empanadas and rice with chicken", "A birthday cake", "Fish and vegetables"],
        correctIndex: 1,
        explanation:
          "\"la abuela preparó la comida favorita de José: empanadas y arroz con pollo\" describes grandma making José's favorite food: empanadas and chicken with rice.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Bridesmaid", "Flower girl", "Singer", "Photographer"],
        correctIndex: 1,
        explanation:
          "\"Valeria me pidió ser la niña de las flores en la boda\" means Valeria asked her to be the flower girl at the wedding.",
      },
      {
        type: "multiple-choice",
        question: "What worried the narrator the night before the wedding?",
        options: ["Forgetting the vows", "Tripping in her dress in front of everyone", "Losing the flowers", "Being late"],
        correctIndex: 1,
        explanation:
          "\"Tenía miedo de tropezar con el vestido\" means she was afraid of tripping in her dress.",
      },
      {
        type: "multiple-choice",
        question: "What did the aunt tell the narrator to do while walking?",
        options: ["Run fast", "Walk slowly and smile", "Sing a song", "Hold her mom's hand"],
        correctIndex: 1,
        explanation:
          "Her aunt said \"Camina despacio y sonríe\" (Walk slowly and smile).",
      },
      {
        type: "multiple-choice",
        question: "What did Valeria tell the narrator after the ceremony?",
        options: ["\"You were the best flower girl\"", "\"You should be a bridesmaid next time\"", "\"You dropped too many petals\"", "\"I didn't see you walk in\""],
        correctIndex: 0,
        explanation:
          "Valeria said \"Fuiste la mejor niña de las flores\" (You were the best flower girl).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Pizza", "Cake and candy", "Ice cream", "Fruit"],
        correctIndex: 1,
        explanation:
          "\"Samuel comió tres pedazos de pastel de chocolate. También comió muchos dulces\" shows he ate three pieces of cake and lots of candy.",
      },
      {
        type: "multiple-choice",
      ...
      },
      {
        ...
        options: ["Only water", "Rice and banana", "More cake", "Spicy food"],
        correctIndex: 1,
        explanation:
          "The doctor recommended \"comer cosas suaves, como arroz y plátano\" (eating soft things, like rice and banana).",
      },
      {
        type: "multiple-choice",
        question: "What did Samuel do differently at the next party?",
        options: ["He didn't eat anything", "He ate only one piece of cake and drank water", "He left early", "He brought his own food"],
        correctIndex: 1,
        explanation:
          "\"Comió solo un pedazo de pastel y tomó agua en vez de refresco\" means he ate only one piece of cake and drank water instead of soda.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: ["It was broken", "It was sprained, not broken", "Nothing was wrong with it", "It needed surgery"],
        correctIndex: 1,
        explanation:
          "The doctor explained that \"el tobillo no estaba roto, pero sí estaba torcido\" (the ankle wasn't broken, but it was sprained).",
      },
      {
        type: "multiple-choice",
        ...
        correctIndex: 1,
        explanation:
          "The doctor told her \"Vas a necesitar muletas por dos semanas\" (You are going to need crutches for two weeks).",
      },
      {
        type: "multiple-choice",
        question: "What lesson did Lucía learn by the end of the story?",
        options: ["Skateboarding is too dangerous to continue", "Safety is more important than speed", "She should quit skateboarding forever", "She only needs a helmet"],
        correctIndex: 1,
        explanation:
          "The final line says she learned that \"la seguridad es más importante que la velocidad\" (safety is more important than speed).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He was on vacation", "He had the flu", "He was grounded", "The school was closed"],
        correctIndex: 1,
        explanation:
          "His mom said \"Tienes gripe... Hoy no vas a la escuela\" (You have the flu... today you're not going to school).",
      },
      {
        type: "multiple-choice",
        question: "What event did Marco miss?",
        options: ["A soccer game", "His cousin Bruno's birthday party", "A school trip", "A family dinner"],
        correctIndex: 1,
        explanation:
          "The story mentions \"la fiesta de cumpleaños de su primo Bruno\" (his cousin Bruno's birthday party) that Marco missed.",
      },
      {
        type: "multiple-choice",
        question: "What did his grandmother make for him?",
        options: ["A sandwich", "Hot chicken soup", "A cake", "Ice cream"],
        correctIndex: 1,
        explanation:
          "\"Le preparó una sopa caliente de pollo\" means she made him hot chicken soup.",
      },
      {
        type: "multiple-choice",
    ...
    exercises: [
      {
        ...
        options: ["Peanuts", "Shrimp", "Strawberries", "Eggs"],
        correctIndex: 1,
        explanation:
          "The story describes \"un plato nuevo con camarones\" (a new dish with shrimp) that caused her reaction.",
      },
      {
        type: "multiple-choice",
        question: "What symptoms did Paula have?",
        options: ["A stomachache only", "Red spots and trouble breathing", "A headache", "Just a fever"],
        correctIndex: 1,
        explanation:
          "The text says \"le salieron manchas rojas en el cuello y los brazos. Le costaba respirar bien\" (red spots appeared on her neck and arms; she had trouble breathing).",
      },
      {
        type: "multiple-choice",
        question: "What did the doctor tell Paula to avoid forever?",
        options: ["Sugar", "Shellfish, like shrimp", "Dairy", "Spicy food"],
        correctIndex: 1,
        explanation:
          "The doctor said \"Debes evitar los camarones y otros mariscos para siempre\" (You must avoid shrimp and other shellfish forever).",
      },
      {
        type: "multiple-choice",
        question: "What does the family do now at restaurants?",
        options: ["Order the same dish every time", "Ask the waiter if the food has shellfish", "Avoid restaurants entirely", "Bring their own food"],
        correctIndex: 1,
        explanation:
          "\"la familia siempre le pregunta al mesero en los restaurantes si la comida tiene mariscos\" means the family always asks the waiter if the food has shellfish.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To buy herself candy", "To buy her dad a birthday gift", "To go on a trip", "To buy a toy"],
        correctIndex: 1,
        explanation:
          "\"Quería comprarle un regalo especial a su papá\" means she wanted to buy her dad a special gift.",
      },
      {
        type: "multiple-choice",
        question: "What did Sofía do to earn extra money?",
        options: ["Sold her toys", "Helped organize the garage", "Asked her grandmother for money", "Found money on the street"],
        correctIndex: 1,
        explanation:
          "\"Su mamá le pagó por ayudar a organizar el garaje durante dos sábados\" means her mom paid her for helping organize the garage.",
      },
      {
        type: "multiple-choice",
        question: "What gift did Sofía buy?",
        options: ["A soccer ball", "A cap from his favorite team", "A book", "A watch"],
        correctIndex: 1,
        explanation:
          "She bought \"una gorra de su equipo de fútbol favorito\" (a cap from his favorite soccer team).",
      },
      {
        type: "multiple-choice",
        question: "About how long did it take Sofía to save the money?",
        options: ["One week", "One month", "Three months", "A year"],
        correctIndex: 2,
        explanation:
          "The story states \"ahorró el dinero durante tres meses\" (she saved the money for three months).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["They lost their jobs", "They wanted to spend less money on food", "They were moving", "The store raised prices"],
        correctIndex: 1,
        explanation:
          "The story opens with \"la familia de Bruno necesitaba gastar menos dinero en comida\" (Bruno's family needed to spend less money on food).",
      },
      {
        type: "multiple-choice",
        question: "What rule did mom set at the store?",
        options: ["Only buy what's on the list", "Buy only fruit", "Spend as much as needed", "Let Bruno choose everything"],
        correctIndex: 0,
        explanation:
          "His mom said \"Solo podemos comprar lo que está en la lista\" (We can only buy what's on the list).",
      },
      {
        type: "multiple-choice",
        question: "Why did they choose the cheaper apples?",
        options: ["They looked better", "They tasted almost the same and cost less", "They were on sale", "The expensive ones were sold out"],
        correctIndex: 1,
        explanation:
          "The text says they bought the cheaper apples because \"sabían casi igual de ricas\" (they tasted almost as good) as the pricier ones.",
      },
      {
        type: "multiple-choice",
        ...
        correctIndex: 0,
        explanation:
          "\"su mamá le dio a Bruno los ocho dólares que sobraron\" means his mom gave him the eight dollars that were left over.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She lost them", "Her old ones were too small", "They were the wrong color", "They got wet"],
        correctIndex: 1,
        explanation:
          "\"A Camila le quedaban pequeños los zapatos deportivos\" means her sneakers had become too small for her.",
      },
      {
        type: "multiple-choice",
        question: "What color did Camila originally want?",
        options: ["Blue", "Purple", "Pink with glitter", "Green"],
        correctIndex: 2,
        explanation:
          "\"Camila quería unos zapatos rosados con brillos\" means Camila wanted pink shoes with glitter.",
      },
      {
        type: "multiple-choice",
        question: "Why did Camila end up choosing the blue shoes?",
        options: ["They were the only color left", "They were more comfortable", "Her mom picked them", "They were free"],
        correctIndex: 1,
        explanation:
          "She tried the blue ones, \"que le quedaban un poco más cómodos\" (which fit a little more comfortably).",
      },
      {
        type: "multiple-choice",
        question: "What lesson did Camila learn?",
        options: ["Always buy the most expensive item", "We can't always choose exactly what we want, but can find something just as good", "Never go shopping on Saturdays", "Pink shoes are the best"],
        correctIndex: 1,
        explanation:
          "The final paragraph says she learned \"no siempre podemos elegir exactamente lo que queremos, pero podemos encontrar algo igual de bueno\" (we can't always choose exactly what we want, but we can find something just as good).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To clean the house for a party", "To earn money for a new bicycle", "Their parents told them to", "To help a neighbor"],
        correctIndex: 1,
        explanation:
          "\"Iván quería una bicicleta nueva, pero costaba mucho dinero\" leads Daniela to suggest \"organizar una venta de garaje\" to raise money.",
      },
      {
        type: "multiple-choice",
        question: "What happened when a man wanted to buy Iván's old bike?",
        options: ["Iván refused to sell it", "Iván lowered the price to $3", "Iván gave it away for free", "The man didn't buy it"],
        correctIndex: 1,
        explanation:
          "The man asked \"¿Puedes bajar el precio a tres dólares?\" and Iván \"decidió aceptar\" (decided to accept).",
      },
      {
        type: "multiple-choice",
        question: "How much did they earn in total?",
        options: ["$35", "$50", "$65", "$100"],
        correctIndex: 2,
        explanation:
          "\"Contaron el dinero juntos... sesenta y cinco dólares en total\" means they counted the money together: sixty-five dollars total.",
      },
      {
        type: "multiple-choice",
        question: "What did their dad promise?",
        options: ["To buy the whole bike himself", "To pay the other half if they saved the rest", "To return all the sold items", "To take them shopping"],
        correctIndex: 1,
        explanation:
          "\"Su papá prometió pagar la otra mitad si ellos ahorraban el resto\" means their dad promised to pay the other half if they saved the rest.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        correctIndex: 2,
        explanation:
          "\"Su mamá le dio quince dólares para gastar\" means his mom gave him fifteen dollars to spend.",
      },
      {
        type: "multiple-choice",
        question: "Why didn't Nico buy the remote control car?",
        options: ["Tomás didn't like cars", "It was too expensive", "The store didn't have it", "It was broken"],
        correctIndex: 1,
        explanation:
          "The car \"costaba veinticinco dólares, demasiado caro para él\" (cost twenty-five dollars, too expensive for him).",
      },
      {
        type: "multiple-choice",
        question: "What gift did Nico finally choose?",
        options: ["A soccer ball", "A comic book", "A video game", "A toy car"],
        correctIndex: 1,
        explanation:
          "He found \"un cómic nuevo de su superhéroe favorito por doce dólares\" (a new comic of his favorite superhero for twelve dollars).",
      },
      {
        type: "multiple-choice",
        question: "What lesson did Nico learn?",
        options: ["Always buy the most expensive gift", "A good gift doesn't need to be the most expensive one", "Never shop at bookstores", "Comics make bad gifts"],
        correctIndex: 1,
        explanation:
          "The story ends with Nico learning \"un buen regalo no necesita ser el más caro\" (a good gift doesn't need to be the most expensive one).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Excited to meet them right away", "Too shy to say hello", "Angry that they moved in", "Indifferent"],
        correctIndex: 1,
        explanation:
          "The story says \"era muy tímida para saludarlos\" (she was too shy to say hello to them).",
      },
      {
        type: "multiple-choice",
        question: "Why did Zoe's family move to the neighborhood?",
        options: ["For her dad's job", "To be closer to family", "For the weather", "For a bigger house"],
        correctIndex: 0,
        explanation:
          "\"su familia se mudó desde otra ciudad por el trabajo de su papá\" means her family moved because of her dad's job.",
      },
      {
        type: "multiple-choice",
        question: "What did Zoe teach Emilia?",
        options: ["A new sport", "A new card game", "How to cook", "A new language"],
        correctIndex: 1,
        explanation:
          "\"Zoe le enseñó a Emilia un juego nuevo con cartas\" means Zoe taught Emilia a new card game.",
      },
      {
        type: "multiple-choice",
        question: "What did Emilia learn from this experience?",
        options: ["New neighbors are usually unfriendly", "Being a little brave can lead to a great friendship", "It's better to stay alone", "Moving is always hard"],
        correctIndex: 1,
        explanation:
          "The final paragraph says Emilia learned that \"ser un poco valiente al principio puede traer una gran amistad\" (being a little brave at first can bring a great friendship).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Their mom told them to", "They saw her sitting alone on her porch", "She called them over", "They needed help with homework"],
        correctIndex: 1,
        explanation:
          "\"la vieron sentada sola en su porche, mirando la calle\" means they saw her sitting alone on her porch, watching the street.",
      },
      {
        type: "multiple-choice",
        question: "What was Mrs. Rosa's former job?",
        options: ["Doctor", "Elementary school teacher", "Chef", "Nurse"],
        correctIndex: 1,
        explanation:
          "\"antes era maestra de escuela primaria\" means she used to be an elementary school teacher.",
      },
      {
        type: "multiple-choice",
        question: "What game did Mrs. Rosa teach the kids?",
        options: ["Chess", "Dominoes", "Cards", "Checkers"],
        correctIndex: 1,
        explanation:
          "\"La señora Rosa les enseñó a jugar dominó\" means Mrs. Rosa taught them to play dominoes.",
      },
      {
        type: "multiple-choice",
        question: "What did the kids organize for her?",
        options: ["A garage sale", "A small surprise birthday party", "A trip", "A cooking class"],
        correctIndex: 1,
        explanation:
          "\"los niños le organizaron una pequeña fiesta sorpresa para su cumpleaños\" means the kids organized a small surprise party for her birthday.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He jumped through a window", "The garden door was left open", "Someone let him out on purpose", "He escaped during a walk"],
        correctIndex: 1,
        explanation:
          "\"dejó la puerta del jardín abierta, y Simón salió sin que nadie lo viera\" means he left the garden door open and Simón got out unnoticed.",
      },
      {
        type: "multiple-choice",
        question: "What did the kids make to help find the cat?",
        options: ["A trap", "Posters with his photo and phone number", "A video", "A map"],
        correctIndex: 1,
        explanation:
          "\"Hicieron carteles con una foto de Simón y el número de teléfono del señor Díaz\" means they made posters with Simón's photo and Mr. Díaz's phone number.",
      },
      {
        type: "multiple-choice",
        question: "Where did they find Simón?",
        options: ["In a neighbor's yard", "Stuck in a tree at the park", "Under a car", "At the store"],
        correctIndex: 1,
        explanation:
          "\"Marcos miró hacia arriba y vio a Simón atrapado en una rama alta del árbol\" means Marcos looked up and saw Simón stuck on a high branch of the tree.",
      },
      {
        type: "multiple-choice",
        question: "What did Mr. Díaz give the kids to thank them?",
        options: ["Money", "Homemade cookies", "A new toy", "A photo of Simón"],
        correctIndex: 1,
        explanation:
          "\"Les regaló galletas caseras que su esposa preparó\" means he gave them homemade cookies that his wife made.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["His birthday", "His retirement after 30 years as doorman", "His wedding", "He was moving away"],
        correctIndex: 1,
        explanation:
          "The story explains he \"trabajaba como portero\" for thirty years and \"decidió jubilarse ese verano\" (decided to retire that summer).",
      },
      {
        type: "multiple-choice",
        question: "Where was the party held?",
        options: ["In the lobby", "In a restaurant", "On the rooftop", "In the park"],
        correctIndex: 2,
        explanation:
          "\"hacer una fiesta en la azotea del edificio\" means to have a party on the building's rooftop.",
      },
      {
        type: "multiple-choice",
        question: "What did the kids make for Mr. Fernández?",
        options: ["A cake", "A giant thank-you sign", "A photo album", "A video"],
        correctIndex: 1,
        explanation:
          "\"hicieron un cartel gigante que decía 'Gracias, señor Fernández, por treinta años'\" means they made a giant sign that said \"Thank you, Mr. Fernández, for thirty years.\"",
      },
      {
        type: "multiple-choice",
        question: "What did Mr. Fernández promise at the end of the party?",
        options: ["To come back to work", "To visit the building sometimes", "To move to another building", "To retire early next year"],
        correctIndex: 1,
        explanation:
          "\"Prometió que iba a visitar el edificio de vez en cuando\" means he promised he was going to visit the building from time to time.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: ["Proud of his effort", "Relieved it was over", "Sad, thinking it was his fault", "Angry at his teammates"],
        correctIndex: 2,
        explanation:
          "The text says \"Mateo se sintió muy triste y pensó que era culpa suya\" (Mateo felt very sad and thought it was his fault).",
      },
      {
        type: "multiple-choice",
        question: "What did his friend Lucas tell him?",
        options: ["That winning and losing are things the team shares together", "That he should quit the team", "That the coach was very angry", "That he played badly the whole game"],
        correctIndex: 0,
        explanation:
          "Lucas tells him, \"Ganamos y perdemos juntos también\" (We win and we lose together too).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She didn't have a swimsuit", "She was afraid of deep water", "She was always sick during summer", "The pool near her house was closed"],
        correctIndex: 1,
        explanation:
          "The text says \"tenía miedo del agua profunda\" (she was afraid of deep water).",
      },
      {
        type: "multiple-choice",
        question: "What did Sofía practice first in her lessons?",
        options: ["Putting her face in the water and moving her arms", "Diving from a high board", "Swimming across the deep end", "Holding her breath for five minutes"],
        correctIndex: 0,
        explanation:
          "The story says \"Sofía solo practicaba cómo poner la cara en el agua y cómo mover los brazos\" (Sofía only practiced putting her face in the water and moving her arms).",
      },
      {
        type: "multiple-choice",
        question: "What happened after two weeks of lessons?",
        options: ["Sofía quit swimming lessons", "Sofía won a swimming competition", "Sofía swam across the pool alone for the first time", "The instructor changed to someone new"],
        correctIndex: 2,
        explanation:
          "The text says \"Nadó sola por primera vez\" (She swam alone for the first time).",
      },
      {
        type: "multiple-choice",
        question: "How did Sofía feel about swimming by the end of summer?",
        options: ["She still hated the water", "She felt indifferent about it", "She loved going to the pool every day", "She was still too scared to try again"],
        correctIndex: 2,
        explanation:
          "The story says \"le encantaba ir a la piscina todos los días\" (she loved going to the pool every day).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He won the race easily", "He dropped it because he got nervous", "He ran in the wrong direction", "He passed it to Rosa too early"],
        correctIndex: 1,
        explanation:
          "The text says \"se puso nervioso y dejó caer el bastón al suelo\" (he got nervous and dropped the baton on the ground).",
      },
      {
        type: "multiple-choice",
        question: "What did Rosa shout to Pablo after he dropped the baton?",
        options: ["To give up and stop running", "To wait for a brand new baton", "To pick it up and keep running", "To walk instead of running"],
        correctIndex: 2,
        explanation:
          "Rosa shouts \"¡Recógelo y sigue corriendo!\" (Pick it up and keep running!).",
      },
      {
        type: "multiple-choice",
        ...
        correctIndex: 2,
        explanation:
          "The text says \"Los Rápidos terminaron en tercer lugar\" (Los Rápidos finished in third place).",
      },
      {
        type: "multiple-choice",
        question: "How did Pablo's teammates react to his mistake?",
        options: ["They were angry and blamed him", "They stopped talking to him", "They asked the coach to remove him", "They supported him and said third place was a prize too"],
        correctIndex: 3,
        explanation:
          "Ana tells him, \"El tercer lugar es un premio también\" (Third place is a prize too).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He wanted to show his best game for one of only twelve spots", "He didn't really like basketball", "He was sick that day", "He forgot his basketball shoes"],
        correctIndex: 0,
        explanation:
          "The text says the coach \"solo podía escoger a doce jugadores\" and \"Bruno estaba muy nervioso porque quería mostrar su mejor juego\" (could only choose twelve players, and Bruno wanted to show his best game).",
      },
      {
        type: "multiple-choice",
        question: "What was Bruno's weakness during tryouts?",
        options: ["Dribbling the ball", "Shooting - he missed many shots", "Running fast", "Passing the ball"],
        correctIndex: 1,
        explanation:
          "The story says \"cuando tiraba a la canasta, fallaba muchos tiros\" (when he shot at the basket, he missed many shots).",
      },
      {
        type: "multiple-choice",
        question: "What did the coach offer Bruno instead of the main team?",
        options: ["A spot on the main team", "A coaching position", "A spot on the junior team", "Nothing at all"],
        correctIndex: 2,
        explanation:
          "The text says \"El entrenador le ofreció un lugar en el equipo júnior\" (The coach offered him a spot on the junior team).",
      },
      {
        type: "multiple-choice",
        question: "What did Bruno decide to do after not making the main team?",
        options: ["Quit basketball forever", "Ask the coach to change the list", "Join a completely different sport", "Practice shots every day to try again next year"],
        correctIndex: 3,
        explanation:
          "The story says \"Decidió practicar tiros todos los días después de la escuela\" (He decided to practice shots every day after school).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To visit grandparents who lived far away", "To move to a new house", "For a school trip", "To go to a soccer game"],
        correctIndex: 0,
        explanation:
          "The text says they planned \"un viaje a la casa de sus abuelos, que vivían en otra ciudad, muy lejos\" (a trip to their grandparents' house, who lived in another city, very far away).",
      },
      {
        type: "multiple-choice",
        question: "How did Camila feel when the plane started moving on the runway?",
        options: ["Excited and completely calm", "Scared - she closed her eyes and held her mom's hand", "Bored and sleepy", "Angry that the flight was delayed"],
        correctIndex: 1,
        explanation:
          "The story says \"ella cerró los ojos y tomó la mano de su mamá con fuerza\" (she closed her eyes and held her mom's hand tightly).",
      },
      {
        type: "multiple-choice",
        question: "What did Camila do during the flight?",
        options: ["She slept the whole time", "She cried the whole time", "She refused to eat anything", "She ate a sandwich, watched a movie, and talked about the clouds"],
        correctIndex: 3,
        explanation:
          "The text says \"Camila comió un sándwich, vio una película y habló con su hermano sobre las nubes\" (Camila ate a sandwich, watched a movie, and talked with her brother about the clouds).",
      },
      {
        type: "multiple-choice",
        question: "How did Camila feel about flying by the end of the trip?",
        options: ["She never wanted to fly again", "She was still very scared of flying", "She felt indifferent about flying", "She loved it and wanted to fly again soon"],
        correctIndex: 3,
        explanation:
          "Camila says, \"Quiero viajar en avión otra vez muy pronto\" (I want to travel by plane again very soon).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To go to a new school", "To visit his cousin Valentina in the city", "To move to a new town", "To go on a school field trip"],
        correctIndex: 1,
        explanation:
          "The story says \"Emilio iba a viajar solo en tren por primera vez para visitarla\" (Emilio was going to travel alone by train for the first time to visit her, his cousin Valentina).",
      },
      {
        type: "multiple-choice",
        question: "What mistake did Emilio make on the trip?",
        options: ["He missed the train completely", "He got off at the wrong station", "He forgot his backpack", "He fell asleep and missed his stop"],
        correctIndex: 1,
        explanation:
          "The text says \"vio que no era la parada correcta\" (he saw that it was not the correct stop).",
      },
      {
        type: "multiple-choice",
        question: "What did Emilio remember to do when he had a problem?",
        options: ["Call his mom on the phone", "Cry until someone noticed him", "Look for a train employee in uniform", "Walk to find the station alone"],
        correctIndex: 2,
        explanation:
          "He remembered his mom's words: \"busca a un empleado del tren con uniforme\" (look for a train employee in uniform).",
      },
      {
        type: "multiple-choice",
        question: "How did the story end?",
        options: ["Emilio never found his cousin", "Emilio's mom had to come get him", "Emilio missed the visit entirely", "Emilio arrived and found Valentina, then told her about the adventure"],
        correctIndex: 3,
        explanation:
          "The text says \"Emilio por fin llegó a la estación central. Vio a Valentina... Se abrazaron y Emilio le contó toda la aventura\" (Emilio finally arrived at the central station. He saw Valentina... They hugged and Emilio told her the whole adventure).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Two kilometers", "Almost eight kilometers", "Twenty kilometers", "One kilometer"],
        correctIndex: 1,
        explanation:
          "The text says \"El sendero era largo, casi ocho kilómetros hasta la cima\" (The trail was long, almost eight kilometers to the summit).",
      },
      {
        type: "multiple-choice",
      ...
      },
      {
        ...
        options: ["He let her rest on a rock and gave her water and fruit", "He carried her the rest of the way", "He told her to give up and go home", "He called someone to pick them up"],
        correctIndex: 0,
        explanation:
          "The story says \"Su papá se sentó con ella en una roca grande. Le dio agua y una fruta\" (Her dad sat with her on a big rock. He gave her water and fruit).",
      },
      {
        type: "multiple-choice",
        question: "How did Renata feel when they reached the top?",
        options: ["She regretted going on the hike", "She was too tired to notice the view", "She wanted to leave immediately", "She felt it was worth it and understood why her dad loved the mountain"],
        correctIndex: 3,
        explanation:
          "Renata says, \"Valió la pena caminar tanto... Ahora entiendo por qué te gusta tanto la montaña, papá\" (It was worth walking so much... Now I understand why you like the mountain so much, dad).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He shared it right away", "He gave it to Sam immediately", "He broke it by accident", "He kept it for himself and gave Sam the old one"],
        correctIndex: 3,
        explanation:
          "The text says \"Le dio a Sam el control viejo, que no funcionaba muy bien\" (He gave Sam the old controller, which didn't work very well).",
      },
      {
        type: "multiple-choice",
        question: "How did Sam feel about the old controller?",
        options: ["He loved using it", "He found it difficult to use and felt frustrated", "He didn't notice any problem with it", "He broke it on purpose"],
        correctIndex: 1,
        explanation:
          "Sam says, \"Este control es difícil de usar\" (This controller is hard to use).",
      },
      {
        type: "multiple-choice",
        question: "What did Leo decide to do after realizing the situation?",
        options: ["Stop playing altogether", "Ask Sam to leave his house", "Give Sam the new controller because it was fairer to share", "Buy another game console"],
        correctIndex: 2,
        explanation:
          "Leo says, \"Es más justo si compartimos\" (It's fairer if we share), and gives Sam the new controller.",
      },
      {
        type: "multiple-choice",
        question: "What did Leo learn from this experience?",
        options: ["Video games are only fun when played alone", "New controllers are always better than old ones", "Sam should always get the old controller", "Games are more fun when friends share and play fairly"],
        correctIndex: 3,
        explanation:
          "The text says \"los videojuegos son más divertidos cuando los amigos comparten y juegan de manera justa\" (video games are more fun when friends share and play fairly).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Fly and take photos", "Move objects and follow a line on the ground", "Talk and answer questions", "Cook simple food"],
        correctIndex: 1,
        explanation:
          "The text says \"El robot podía mover objetos y seguir una línea en el suelo\" (The robot could move objects and follow a line on the ground).",
      },
      {
        type: "multiple-choice",
        question: "What went wrong at the competition?",
        options: ["The robot didn't turn on at all", "The robot moved in circles and didn't follow the line correctly", "They forgot the robot at home", "Another team's robot broke theirs"],
        correctIndex: 1,
        explanation:
          "The story says \"El robot se movía en círculos y no seguía la línea correctamente\" (The robot moved in circles and didn't follow the line correctly).",
      },
      {
        type: "multiple-choice",
        question: "What was the problem, and who fixed it?",
        options: ["A dead battery, fixed by Kevin", "A loose cable near the sensor, fixed by Julia", "A broken wheel, fixed by Ana", "A software error, fixed by the teacher"],
        correctIndex: 1,
        explanation:
          "The text says \"Encontró un cable suelto cerca del sensor. Con mucho cuidado, conectó el cable de nuevo\" (She found a loose cable near the sensor. Carefully, she reconnected the cable) - Julia found and fixed it.",
      },
      {
        type: "multiple-choice",
        question: "What place did the team finish in the competition?",
        options: ["Third place", "First place", "Last place", "They were disqualified"],
        correctIndex: 0,
        explanation:
          "The text says \"el equipo de Julia ganó el tercer lugar de la competencia\" (Julia's team won third place in the competition).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He didn't like computers", "He typed very slowly because he always looked at the keyboard", "He was going to be absent that day", "He didn't understand the assignment"],
        correctIndex: 1,
        explanation:
          "The text says \"Óscar escribía muy lento porque siempre miraba el teclado\" (Óscar typed very slowly because he always looked at the keyboard).",
      },
      {
        type: "multiple-choice",
        question: "How did Óscar practice typing?",
        options: ["He copied words from a book by hand", "He took private typing lessons", "He asked his teacher for extra homework", "He used a computer game where words fell down the screen"],
        correctIndex: 3,
        explanation:
          "The text describes \"un juego de computadora para practicar mecanografía... las palabras caían desde arriba de la pantalla\" (a computer game to practice typing... words fell from the top of the screen).",
      },
      {
        type: "multiple-choice",
        question: "What changed after two weeks of practice?",
        options: ["Nothing really changed", "He no longer needed to look at the keyboard as much", "He gave up on typing practice", "He got a brand new computer"],
        correctIndex: 1,
        explanation:
          "The story says \"Óscar ya no necesitaba mirar el teclado tanto\" (Óscar no longer needed to look at the keyboard as much).",
      },
      {
        type: "multiple-choice",
        question: "How did Óscar do on the typing test?",
        options: ["He failed the test completely", "He refused to take the test", "He was the slowest in the class", "He finished early and typed almost as fast as the best students"],
        correctIndex: 3,
        explanation:
          "The text says he \"escribía casi tan rápido como los mejores estudiantes de la clase\" (typed almost as fast as the best students in the class).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["She was the best athlete in school", "She was shy but had a hidden talent for drawing", "She was the class president", "She didn't like school at all"],
        correctIndex: 1,
        explanation:
          "The text says \"le encantaba dibujar, y en su cuaderno tenía dibujos hermosos... Nadie en la escuela sabía sobre su talento\" (she loved drawing, and her notebook had beautiful drawings... Nobody at school knew about her talent).",
      },
      {
        type: "multiple-choice",
        question: "How was Paola's drawing talent discovered?",
        options: ["She showed it to the whole class herself", "Her mother sent it to the school", "She entered it in a contest", "Her art teacher saw her notebook by accident"],
        correctIndex: 3,
        explanation:
          "The text says \"Su maestra de arte, la señora Campos, vio uno de los cuadernos de Paola por accidente\" (Her art teacher, Mrs. Campos, saw one of Paola's notebooks by accident).",
      },
      {
        type: "multiple-choice",
        question: "What was chosen as the main idea for the mural?",
        options: ["A soccer field", "A photo of the school building", "A map of the city", "Paola's drawing of a big tree with colorful birds"],
        correctIndex: 3,
        explanation:
          "The text says \"Eligieron el dibujo de Paola como la idea principal del mural\" (They chose Paola's drawing as the main idea for the mural).",
      },
      {
        type: "multiple-choice",
        question: "How did Paola change by the end of the story?",
        options: ["She gained confidence and spoke much more in class", "She became less interested in art", "She left the mural project unfinished", "She remained just as shy as before"],
        correctIndex: 0,
        explanation:
          "The text says \"Paola habló mucho más en clase y se sintió orgullosa de su talento\" (Paola spoke much more in class and felt proud of her talent).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["Serving - her serves usually went out of bounds", "Blocking the ball", "Passing to teammates", "Running fast"],
        correctIndex: 0,
        explanation:
          "The text says \"le costaba mucho sacar bien la pelota. Sus saques casi siempre salían fuera de la cancha\" (it was very hard for her to serve well; her serves almost always went outside the court).",
      },
      {
        type: "multiple-choice",
        question: "What advice did the coach give Ximena?",
        options: ["To bend her knees more and watch the ball", "To always hit the ball as hard as possible", "To serve underhand only", "To let a teammate serve instead of her"],
        correctIndex: 0,
        explanation:
          "The coach explains, \"Necesitas doblar más las rodillas y mirar la pelota\" (You need to bend your knees more and watch the ball).",
      },
      {
        type: "multiple-choice",
        question: "What happened when Ximena served at the important moment?",
        options: ["The ball went out of bounds again", "She missed the ball completely", "The other team called a foul", "The ball landed in the opposing court and they couldn't return it"],
        correctIndex: 3,
        explanation:
          "The text says the ball \"cayó dentro de la cancha del equipo rival, que no pudo devolverla a tiempo\" (landed inside the rival team's court, which couldn't return it in time).",
      },
      {
        type: "multiple-choice",
        question: "How did the match end?",
        options: ["Las Panteras lost the match", "The match ended in a tie", "The match was cancelled", "Las Panteras won the whole match"],
        correctIndex: 3,
        explanation:
          "The text says \"Las Panteras ganaron el partido completo\" (Las Panteras won the entire match).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He didn't like his instructor", "He kept comparing his tennis to his friend Beto, who learned faster", "He didn't want to play tennis at all", "He lost his racket"],
        correctIndex: 1,
        explanation:
          "The text says \"Adrián se sentía frustrado porque siempre comparaba su juego con el de Beto\" (Adrián felt frustrated because he always compared his game to Beto's).",
      },
      {
        type: "multiple-choice",
        question: "What advice did the instructor give Adrián?",
        options: ["To quit tennis and try another sport", "To compare his progress with his own past progress, not with Beto's", "To only ever practice with Beto", "To switch to a different sport entirely"],
        correctIndex: 1,
        explanation:
          "The instructor tells him, \"No compares tu progreso con el de otra persona. Compáralo con tu propio progreso de la semana pasada\" (Don't compare your progress with someone else's. Compare it with your own progress from last week).",
      },
      {
        type: "multiple-choice",
        question: "How did Adrián practice after receiving this advice?",
        options: ["He stopped practicing entirely", "He hired a private coach", "He switched to a different instructor", "He practiced alone against the wall at home every day"],
        correctIndex: 3,
        explanation:
          "The text says \"Practicaba solo contra la pared de su casa todos los días\" (He practiced alone against the wall of his house every day).",
      },
      {
        type: "multiple-choice",
        question: "What happened at the friendly match at the end of summer?",
        options: ["Adrián lost but played much better than in his first class, and felt proud", "Adrián won easily", "The match was cancelled", "Beto refused to play him"],
        correctIndex: 0,
        explanation:
          "The text says \"Adrián perdió el partido, pero jugó mucho mejor que en la primera clase. Se sintió orgulloso de su propio progreso\" (Adrián lost the match, but played much better than in the first class. He felt proud of his own progress).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["He stayed seated the whole time", "He walked to a toy store to look at toy airplanes", "He fell asleep in his seat", "He went to find his mom"],
        correctIndex: 1,
        explanation:
          "The text says \"Toby vio una tienda de juguetes al otro lado del pasillo... caminó hacia allí para mirar los aviones de juguete\" (Toby saw a toy store across the aisle... he walked over to look at the toy airplanes).",
      },
      {
        type: "multiple-choice",
      ...
      },
      {
        ...
        options: ["At the food store", "Asleep on a bench", "In the bathroom", "Looking at airplanes through a big window"],
        correctIndex: 3,
        explanation:
          "The text says \"encontraron a Toby mirando los aviones por una ventana grande\" (they found Toby watching the planes through a big window).",
      },
      {
        type: "multiple-choice",
        question: "How did Toby feel during the whole situation?",
        options: ["Terrified and crying", "Angry at his sister", "Hungry and tired", "Happy watching the planes, not realizing there was a problem"],
        correctIndex: 3,
        explanation:
          "The text says \"Toby no sabía que había un problema. Estaba muy feliz mirando los aviones despegar y aterrizar\" (Toby didn't know there was a problem. He was very happy watching the planes take off and land).",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        options: ["To race his friends", "To make a video of his neighborhood for a school project", "To sell it to a classmate", "To take it apart and study it"],
        correctIndex: 1,
        explanation:
          "The text says he wanted to use it \"para un proyecto de la escuela: un video sobre su barrio desde el aire\" (for a school project: a video of his neighborhood from the air).",
      },
      {
        type: "multiple-choice",
        question: "What happened the first time Simón flew the drone?",
        options: ["It crashed into a tree and broke a propeller", "It worked perfectly", "It flew away and got lost forever", "It never turned on at all"],
        correctIndex: 0,
        explanation:
          "The text says \"el dron chocó contra un árbol grande y cayó al suelo. Una de las hélices se rompió\" (the drone crashed into a big tree and fell to the ground. One of the propellers broke).",
      },
      {
        type: "multiple-choice",
        question: "What advice did his uncle give him?",
        options: ["To give up on the drone completely", "To only fly the drone indoors", "To buy a completely new drone", "To read the manual and practice in an open space without trees"],
        correctIndex: 3,
        explanation:
          "His uncle tells him, \"Necesitas leer el manual y practicar en un espacio abierto y sin árboles\" (You need to read the manual and practice in an open space without trees).",
      },
      {
        type: "multiple-choice",
        question: "How did the school project turn out in the end?",
        options: ["Simón never finished the video", "The drone broke again and he couldn't finish", "His teacher didn't like the video at all", "Simón made a great video and got the highest grade in the class"],
        correctIndex: 3,
        explanation:
          "The text says \"Su maestra le dio la nota más alta de la clase por su trabajo creativo\" (His teacher gave him the highest grade in the class for his creative work).",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: ["She skied perfectly right away", "She refused to try at all", "She fell many times and felt embarrassed", "She hurt her leg badly"],
        correctIndex: 2,
        explanation:
          "The text says \"Lucía se cayó muchas veces... Lucía se sentía avergonzada\" (Lucía fell many times... Lucía felt embarrassed).",
      },
      {
        type: "multiple-choice",
        question: "What did Valeria tell Lucía to encourage her?",
        options: ["To quit skiing and go back to the hotel", "That everyone falls when learning, and the important thing is to get back up", "That she was skiing very badly", "That the instructor was angry with her"],
        correctIndex: 1,
        explanation:
          "Valeria tells her, \"Todos se caen cuando aprenden. Lo importante es levantarse otra vez\" (Everyone falls when they're learning. The important thing is to get back up).",
      },
      {
        type: "multiple-choice",
        question: "How did the ski trip end for Lucía?",
        options: ["She never improved at all", "She got hurt and went home early", "She decided never to ski again", "She skied down the whole mountain without falling and loved the sport"],
        correctIndex: 3,
        explanation:
          "The text says \"Lucía bajó toda la montaña, desde arriba hasta abajo, sin caerse\" and she says \"¡Esquiar es mi deporte favorito ahora!\" (Lucía skied down the whole mountain, from top to bottom, without falling, and says skiing is now her favorite sport).",
      },
    ],
  },
];
